module.exports = {
  ...
  excludePackages: [
    ...
    "jackspeak@3.4.0", // licensed under BlueOak-1.0.0 but not included in the production app
    "path-scurry@1.11.1", // licensed under BlueOak-1.0.0 but not included in the production app
