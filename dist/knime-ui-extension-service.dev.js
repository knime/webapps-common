...
/**
         ...
         */async updateSelection(mode,selection){const response=await this.knimeService.callService([NodeServices.CALL_NODE_SELECTION_SERVICE,mode,Array.isArray(selection)?JSON.stringify(selection):selection]);return"string"==typeof response?JSON.parse(response):response}
/**
