...
describe("CredentialsControl.vue", () => {
  ...
  beforeEach(() => {
    ...
    component = mountJsonFormsComponent(CredentialsControl, { props });
  ...
  it("renders", () => {
    expect(wrapper.getComponent(CredentialsControl).exists()).toBeTruthy();
  ...
  it("disables input when controlled by a flow variable", async () => {
    const { wrapper } = mountJsonFormsComponent(CredentialsControl, {
      props,
  ...
  it("hides username input field when configured to do so", () => {
    ...
    const { wrapper } = mountJsonFormsComponent(CredentialsControl, { props });
    const inputFieldWrappers = wrapper.findAllComponents(InputField);
