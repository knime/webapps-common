...
// Port last synced on 2025-02-04
...
/**
 * BaseAvatar component which displays an avatar image as well as a text.
 * The text can be either shown below or right next to it.
 *
...
type AvatarProps = {
  ...
  showTrusted?: boolean;
  /**
   * Display BaseAvatar as link if linkUrl is provided.
   */
  linkUrl?: string | null;
};
