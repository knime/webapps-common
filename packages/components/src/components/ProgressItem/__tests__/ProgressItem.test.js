...
describe("ProgressItem.vue", () => {
  ...
  it("handles cancel action", async () => {
    ...
    expect(wrapper.emitted()).toHaveProperty("cancel", [["testfile.txt"]]);
  });
  ...
  it("displays correct file size formats", () => {
    ...
    expect(wrapper.vm.fileSizeFormat).toBe("200 B");
    expect(wrapper.vm.progressedFileSizeFormat).toBe("100 B");
  });
});
