...
<template>
  <Label class="title" text="Date & Time Formats" large />

  <div class="switch-with-title">
    <Label class="control-title" text="Type">
      <ValueSwitch
  ...
  <div class="switch-with-title">
    <Label class="control-title" text="Standard">
      <ValueSwitch
  ...
  <div class="date-format-input">
    <Label class="control-title" text="Date formats">
      <div
