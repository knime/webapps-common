...
export type ItemIconRenderer = (item: FileExplorerItem) => FunctionalComponent<SVGAttributes>;
export declare namespace FileExplorerContextMenu {
    ...
    export type CreateDefaultMenuOption = (item: FileExplorerItem, customProps?: Partial<BaseMenuItem>) => MenuItem;
