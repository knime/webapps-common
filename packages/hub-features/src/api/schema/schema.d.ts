        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["PrepareDownloadResponseBody"] | components["schemas"]["LeafItemDownloadResponseBody"];
                    };
                };
                /**
                 * @description Response if
...
export interface components {
    schemas: {
        RepositoryItem: {
            ...
            id: string;
            /** @enum {string} */
            type: "WorkflowGroup" | "Workflow" | "WorkflowTemplate" | "Component" | "Data" | "Snapshot" | "Trash" | "Space";
            /**
        ...
        ComponentPage: {
            ...
            items?: (components["schemas"]["SearchComponent"] | components["schemas"]["DetailedComponent"])[];
            /**
        ...
        ComponentList: (components["schemas"]["SearchComponent"] | components["schemas"]["DetailedComponent"])[];
        /** @description a page of workflows */
        WorkflowPage: {
            /** @description the workflows */
            items?: (components["schemas"]["DetailedWorkflow"] | components["schemas"]["SearchComponent"])[];
            /**
             * @description pointer to the next page. Not returned with the last page.
             * @example *vpE_LTbAOn96ZOg9
             */
        ...
        Icon: {
             ...
             * @enum {string}
             */
            type?: "Learner" | "Manipulator" | "Predictor" | "Sink" | "Source" | "Visualizer";
            /**
        ...
        FullComponentMetaInfo: {
            ...
            nodes: (components["schemas"]["NativeNodeInstance"] | components["schemas"]["ComponentInstance"] | components["schemas"]["MetaNodeInstance"])[];
        ...
        MinimumNodeMetaInfo: {
             ...
             * @enum {string}
             */
            nodeType: "Source" | "Sink" | "Learner" | "Predictor" | "Manipulator" | "Visualizer" | "Meta" | "LoopStart" | "LoopEnd" | "ScopeStart" | "ScopeEnd" | "QuickForm" | "Other" | "Missing" | "Unknown" | "Subnode" | "VirtualIn" | "VirtualOut";
            /**
        ...
        HubCollectionSection: {
             ...
             * @enum {string}
             */
            iconType?: "Workflow" | "Component" | "Node" | "Extension" | "Space" | "Collection";
        ...
        HubCollectionSubSection: {
            ...
            items: (components["schemas"]["LinkHubCollectionItem"] | components["schemas"]["SpaceHubCollectionItem"] | components["schemas"]["ComponentHubCollectionItem"] | components["schemas"]["WorkflowHubCollectionItem"] | components["schemas"]["NodeHubCollectionItem"] | components["schemas"]["ExtensionHubCollectionItem"] | components["schemas"]["CollectionHubCollectionItem"])[];
        };
        ...
        UploadStatus: {
             ...
             * @enum {string}
             */
            status: "PREPARED" | "ANALYSIS_PENDING" | "COMPLETED" | "ABORTED" | "FAILED";
            /**
    ...
    getRepositoryItemMetaData: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RepositoryItemAsMason"] | components["schemas"]["Space"];
    ...
    createItemByPath: {
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["WorkflowGroup"] | components["schemas"]["Space"] | components["schemas"]["SimpleWorkflow"];
                };
            };
            /**
             * @description Response if,
    ...
    getComponentList: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ComponentPage"] | components["schemas"]["ComponentList"];
                };
            };
        };
    };
