...
export const sendEmbeddingContext = (
  ...
  // to be named the same to preserve backwards compatibility
  type EmbeddingContextMessage = Omit<EmbeddingContext, "wsConnectionUri"> & {
    url: string;
  };
  ...
  iframe.contentWindow?.postMessage(
    {
      ...
      payload: {
        ...
        jobId: context.jobId,
      } satisfies EmbeddingContextMessage,
    },
    targetOrigin,
  );
};
