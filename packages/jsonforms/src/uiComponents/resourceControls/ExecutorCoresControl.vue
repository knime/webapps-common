...
const infoText = computed(
  () =>
    `This execution context will use ${secondaryValue.value} vCore tokens. In total, ${totalUse.value} of ${textMax.value} vCore tokens available ${isSharedContext.value ? "from the license" : "for this team"} will be used.`,
);
</script>
