import{C as m}from"./CodeExample-w0UGtbB6.js";import{M as x}from"./MultiselectListBox-IFpQIfoC.js";import{_ as p,r,o as f,c as b,b as e,d as s,t as o,w as c,e as u,a as v}from"./index-PFLgTSm3.js";import"./StyledListItem-oTeHxosE.js";const g=`<script>
...
/>`,S={components:{MultiselectListBox:x,CodeExample:m},data(){return{codeExample:y,selected:[],disabledSelected:[],selected2:[],disabledSelected2:[],bottomValueSymbol:Symbol("bottom value")}},computed:{code(){return g}}},I=v('<div class="grid-container"><div class="grid-item-12"><p> A list box for selecting multiple items. It acts as a form element, so it emits an <code>input</code> event when something is (de-)selected, and it has a <code>value</code>. It has keyboard navigation with <code>Up</code>, <code>Down</code>, <code>Home</code>, <code>End</code>. It is possible to multi select via keyboard with <code>Shift+Up</code> and <code>Shift+Down</code>. Selective multi select is possible by <code>Ctrl+Click</code> or <code>Shift+Click</code>. Also multi select by dragging is supported. </p></div></div>',1),w={class:"grid-container"},V={class:"grid-item-6"},B={class:"grid-item-6"},k=e("br",null,null,-1),C={class:"grid-container"},z={class:"grid-item-6"},_={class:"grid-item-6"},N=e("div",{class:"grid-container"},[e("div",{class:"grid-item-12"},[e("p",null," The MulitselectListBox can display a bottom element (visually different but funcionally equivalent to an element lying below all other elements). The total size of the box does not depend on the bottom element (i.e. less elements are shown instead). ")])],-1),L={class:"grid-container"},K={class:"grid-item-6"},T={class:"grid-item-6"},D=e("br",null,null,-1),A={class:"grid-container"},O={class:"grid-item-6"},E={class:"grid-item-6"},P={class:"grid-container"},M={class:"grid-item-12"};function H(R,t,U,$,n,h){const l=r("MultiselectListBox",!0),d=r("CodeExample");return f(),b("div",null,[e("section",null,[I,e("div",w,[e("div",V,[s(l,{modelValue:n.selected,"onUpdate:modelValue":t[0]||(t[0]=i=>n.selected=i),size:4,"aria-label":"Select stuff here!","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},...Array.from({length:100},(i,a)=>({id:`baz${a}`,text:`Baz ${a}`}))]},null,8,["modelValue","possible-values"])]),e("div",B,"selected ids: "+o(n.selected),1)]),k,e("div",C,[e("div",z,[s(l,{modelValue:n.disabledSelected,"onUpdate:modelValue":t[1]||(t[1]=i=>n.disabledSelected=i),size:4,"aria-label":"Disabled...","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}],disabled:""},null,8,["modelValue"])]),e("div",_,"selected ids: "+o(n.disabledSelected),1)]),N,e("div",L,[e("div",K,[s(l,{modelValue:n.selected2,"onUpdate:modelValue":t[2]||(t[2]=i=>n.selected2=i),size:4,"aria-label":"Select stuff here!","with-bottom-value":"","bottom-value":{id:n.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}]},null,8,["modelValue","bottom-value"])]),e("div",T,"selected ids: "+o(n.selected2),1)]),D,e("div",A,[e("div",O,[s(l,{modelValue:n.disabledSelected2,"onUpdate:modelValue":t[3]||(t[3]=i=>n.disabledSelected2=i),size:4,"aria-label":"Disabled...","with-bottom-value":"","bottom-value":{id:n.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}],disabled:""},null,8,["modelValue","bottom-value"])]),e("div",E,"selected ids: "+o(n.disabledSelected2),1)])]),e("section",null,[e("div",P,[e("div",M,[s(d,{summary:"Show usage example"},{default:c(()=>[u(o(n.codeExample),1)]),_:1}),s(d,{summary:"Show MultiselectListBox.vue source code"},{default:c(()=>[u(o(h.code),1)]),_:1})])])])])}const Y=p(S,[["render",H]]);export{Y as default};
