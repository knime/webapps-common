import{C as v}from"./CodeExample-a53af527.js";import{g as _}from"./localTimezone-a03aa71c.js";import{_ as p,o as T,c as D,t as d,n as S,r as h,b as t,e as s,d as r,w as u}from"./index-eeaa987d.js";const g=(e,n=!1)=>{let a=new Date(e);if(isNaN(a))throw Error("Invalid Date format");let o={day:"numeric",month:"short",year:"numeric"};return n&&(o.timeZone=_()),a.toLocaleDateString("en-US",o)},L=(e,n=!1)=>{let a=new Date(e);if(isNaN(a))throw Error("Invalid Date format");let o={hour:"numeric",minute:"2-digit"};return n&&(o.timeZone=_()),a.toLocaleTimeString("en-US",o)},w=(e,n=!1)=>`${g(e,n)} ${L(e,n)}`,f=(e,n)=>n?w(e,!0):g(e,!0);const x={props:{date:{type:String,default:""},showTime:{type:Boolean,default:!0}},data(){return{localDateTime:w(this.date,this.showTime),hidden:!0}},watch:{date(e,n){e!==n&&(this.localDateTime=f(e,this.showTime))}},mounted(){this.localDateTime=f(this.date,this.showTime),this.hidden=!1}},y=["title","datetime"];function C(e,n,a,o,i,l){return T(),D("time",{title:a.date,datetime:a.date,class:S({hidden:i.hidden})},d(i.localDateTime),11,y)}const E=p(x,[["render",C],["__scopeId","data-v-2bfe73cb"]]),$=`<script>
import {
