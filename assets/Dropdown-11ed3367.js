import{C as I}from"./CodeExample-670083c4.js";import{D as B}from"./arrow-dropdown-caba977b.js";import{_ as V,r as f,ad as S,P as y,o as h,c as m,b as o,e as u,t as c,u as C,l as K,d as a,n as g,F as A,g as N,V as L,w as v,a as M}from"./index-70b63bdb.js";import{L as O}from"./LoadingIcon-d3bbf574.js";import"./svgWithTitle-0bc7187a.js";const k=function(){return document.ontouchstart!==null?"click":"touchstart"},x="__vue_click_away__",T=function(e,n,s){D(e);let p=s.context,t=n.value,i=!1;setTimeout(function(){i=!0},0),e[x]=function(r){if((!e||!e.contains(r.target))&&t&&i&&typeof t=="function")return t.call(p,r)},document.addEventListener(k(),e[x],!1)},D=function(e){document.removeEventListener(k(),e[x],!1),delete e[x]},z=function(e,n,s){n.value!==n.oldValue&&T(e,n,s)},P={mounted:T,updated:z,unmounted:D},U={directives:{ClickAway:P}};let Y=0;const w=40,_=38,H=36,$=35,F=27,E=13,Q=1e3,R={components:{DropdownIcon:B},mixins:[U],props:{id:{type:String,default(){return`Dropdown-${Y++}`}},modelValue:{type:String,default:null},name:{type:String,default:null},placeholder:{type:String,default:null},ariaLabel:{type:String,required:!0},isValid:{default:!0,type:Boolean},disabled:{default:!1,type:Boolean},possibleValues:{type:Array,default:()=>[],validator(e){return Array.isArray(e)?e.every(n=>n.hasOwnProperty("id")&&n.hasOwnProperty("text")):!1}}},emits:["update:modelValue"],data(){return{isExpanded:!1,searchQuery:""}},computed:{selectedIndex(){return this.possibleValues.map(e=>e.id).indexOf(this.modelValue)},showPlaceholder(){return!this.modelValue},displayTextMap(){let e={};for(let n of this.possibleValues)e[n.id]=n.text;return e},displayText(){return this.showPlaceholder?this.placeholder:this.displayTextMap.hasOwnProperty(this.modelValue)?this.displayTextMap[this.modelValue]:`(MISSING) ${this.modelValue}`},isMissing(){return this.modelValue&&!this.displayTextMap.hasOwnProperty(this.modelValue)},hasRightIcon(){var e,n;return(n=(e=this.$slots)["icon-right"])==null?void 0:n.call(e).length}},created(){this.typingTimeout=null},methods:{isCurrentValue(e){return this.modelValue===e},setSelected(e){consola.trace("ListBox setSelected on",e),this.$emit("update:modelValue",e)},onOptionClick(e){this.setSelected(e),this.isExpanded=!1,this.$refs.button.focus()},scrollTo(e){let n=this.$refs.ul;if(n.scrollHeight>n.clientHeight){let s=this.$refs.options[e],p=n.clientHeight+n.scrollTop,t=s.offsetTop+s.offsetHeight;t>p?n.scrollTop=t-n.clientHeight:s.offsetTop<n.scrollTop&&(n.scrollTop=s.offsetTop)}},onArrowDown(){let e=this.selectedIndex+1;e>=this.possibleValues.length||(this.setSelected(this.possibleValues[e].id),this.scrollTo(e))},onArrowUp(){let e=this.selectedIndex-1;e<0||(this.setSelected(this.possibleValues[e].id),this.scrollTo(e))},onEndKey(){let e=this.possibleValues.length-1;this.setSelected(this.possibleValues[e].id),this.$refs.ul.scrollTop=this.$refs.ul.scrollHeight},onHomeKey(){let e=0;this.setSelected(this.possibleValues[e].id),this.$refs.ul.scrollTop=0},toggleExpanded(){this.disabled||(this.isExpanded=!this.isExpanded,this.isExpanded&&this.$nextTick(()=>this.$refs.ul.focus()))},handleKeyDownList(e){if(e.keyCode===w){this.onArrowDown(),e.preventDefault();return}if(e.keyCode===_){this.onArrowUp(),e.preventDefault();return}if(e.keyCode===$){this.onEndKey(),e.preventDefault();return}if(e.keyCode===H){this.onHomeKey(),e.preventDefault();return}if(e.keyCode===F){this.isExpanded=!1,this.$refs.ul.blur(),e.preventDefault();return}if(e.keyCode===E){this.isExpanded=!1,this.$refs.button.focus(),e.preventDefault();return}this.searchItem(e)},handleKeyDownButton(e){if(e.keyCode===E){this.toggleExpanded(),e.preventDefault();return}if(e.keyCode===w){this.onArrowDown(),e.preventDefault();return}if(e.keyCode===_){this.onArrowUp(),e.preventDefault();return}this.searchItem(e)},searchItem(e){clearTimeout(this.typingTimeout),this.typingTimeout=setTimeout(()=>{this.searchQuery=""},Q),this.searchQuery+=e.key,consola.trace(`Searching for ${this.searchQuery}`);const n=this.possibleValues.find(s=>s.text.toLowerCase().startsWith(this.searchQuery.toLowerCase()));n&&this.setSelected(n.id)},hasSelection(){return this.selectedIndex>=0},getCurrentSelectedId(){try{return this.possibleValues[this.selectedIndex].id}catch{return""}},generateId(e,n){if(!n)return`${e}-${this.id}`;let s=String(n).replace(/[^\w]/gi,"");return`${e}-${this.id}-${s}`},clickAway(){this.isExpanded=!1}}},W=["id"],G=["id","aria-label","aria-labelledby","aria-expanded"],q={key:0,class:"loading-icon"},X=["aria-activedescendant"],j=["id","title","aria-selected","onClick"],J=["id","name","value"];function Z(e,n,s,p,t,i){const r=f("DropdownIcon"),b=S("click-away");return y((h(),m("div",{id:s.id,class:g(["dropdown",{collapsed:!t.isExpanded,invalid:!s.isValid,disabled:s.disabled}])},[o("div",{id:i.generateId("button"),ref:"button",role:"button",tabindex:"0","aria-haspopup":"listbox",class:g({placeholder:i.showPlaceholder,missing:i.isMissing}),"aria-label":s.ariaLabel,"aria-labelledby":i.generateId("button"),"aria-expanded":t.isExpanded,onClick:n[0]||(n[0]=(...l)=>i.toggleExpanded&&i.toggleExpanded(...l)),onKeydown:n[1]||(n[1]=(...l)=>i.handleKeyDownButton&&i.handleKeyDownButton(...l))},[u(c(i.displayText)+" ",1),i.hasRightIcon?(h(),m("div",q,[C(e.$slots,"icon-right")])):K("",!0),a(r,{class:"icon"})],42,G),y(o("ul",{ref:"ul",role:"listbox",tabindex:"-1","aria-activedescendant":t.isExpanded?i.generateId("option",i.getCurrentSelectedId()):!1,onKeydown:n[2]||(n[2]=(...l)=>i.handleKeyDownList&&i.handleKeyDownList(...l))},[(h(!0),m(A,null,N(s.possibleValues,l=>(h(),m("li",{id:i.generateId("option",l.id),key:`listbox-${l.id}`,ref_for:!0,ref:"options",role:"option",title:typeof l.title>"u"?l.text:l.title,class:g({focused:i.isCurrentValue(l.id),noselect:!0,empty:l.text.trim()===""}),"aria-selected":i.isCurrentValue(l.id),onClick:d=>i.onOptionClick(l.id)},c(l.text),11,j))),128))],40,X),[[L,t.isExpanded]]),o("input",{id:s.id,type:"hidden",name:s.name,value:s.modelValue},null,8,J)],10,W)),[[b,i.clickAway]])}const ee=V(R,[["render",Z],["__scopeId","data-v-cd092785"]]),ne=`<script>
...
/>`,oe={components:{Dropdown:ee,CodeExample:I,LoadingIcon:O},data(){return{codeExample:te,selected:"bar",placeholderModel:"",disabledSelected:"",withSlotsSelected:""}},computed:{code(){return ne}}},ie=M('<div class="grid-container"><div class="grid-item-12"><p> A list of choices the user must choose one of them, so it emits an <code>input</code> event when something is selected, and it has a <code>value</code>. Keyboard navigation works (<code>Enter</code><code>Up</code>/<code>Down</code> and <code>Home</code>/<code>End</code>, leave with <code>Esc</code>). </p></div></div>',1),se={class:"grid-container"},le={class:"grid-item-5"},de={class:"grid-item-5"},re={class:"grid-item-2"},ae=o("div",{class:"grid-container"},[o("div",{class:"grid-item-12"},[o("p",null,[u(" The "),o("code",null,"placeholder"),u(" will be shown when no or empty "),o("code",null,"value"),u(" is set. Also it provides an invalid ("),o("code",null,"isValid=false"),u(") state. ")])])],-1),ce={class:"grid-container"},ue={class:"grid-item-5"},pe={class:"grid-item-5"},he={class:"grid-item-2"},me=o("br",null,null,-1),fe={class:"grid-container"},xe={class:"grid-item-5"},be={class:"grid-item-2"},ge={class:"grid-container"},ve={class:"grid-item-5"},ye={class:"grid-item-2"},we={class:"grid-container"},_e={class:"grid-item-12"};function Ee(e,n,s,p,t,i){const r=f("Dropdown",!0),b=f("LoadingIcon"),l=f("CodeExample");return h(),m("div",null,[o("section",null,[ie,o("div",se,[o("div",le,[a(r,{modelValue:t.selected,"onUpdate:modelValue":n[0]||(n[0]=d=>t.selected=d),"aria-label":"A List","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"}]},null,8,["modelValue"])]),o("div",de,[a(r,{modelValue:t.selected,"onUpdate:modelValue":n[1]||(n[1]=d=>t.selected=d),"aria-label":"A limited list",size:"3","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"bar2",text:"Bar 2"},{id:"bar3",text:"Bar 3"},{id:"bar4",text:"Bar 4"},{id:"bar5",text:"Bar 5"},{id:"bar6",text:"Bar 6"},{id:"bar7",text:"Bar 8"},{id:"bar9",text:"Bar 9"},{id:"bar10",text:"Bar 10"},{id:"bar11",text:"Bar 11"},{id:"baz",text:"Baz"}]},null,8,["modelValue"])]),o("div",re,"selected id: "+c(t.selected),1)]),ae,o("div",ce,[o("div",ue,[a(r,{modelValue:t.placeholderModel,"onUpdate:modelValue":n[2]||(n[2]=d=>t.placeholderModel=d),placeholder:"Placeholder…","aria-label":"A List","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"}]},null,8,["modelValue"])]),o("div",pe,[a(r,{modelValue:t.placeholderModel,"onUpdate:modelValue":n[3]||(n[3]=d=>t.placeholderModel=d),placeholder:"Placeholder…","is-valid":!1,"aria-label":"A limited list",size:"3","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"bar2",text:"Bar 2"},{id:"bar3",text:"Bar 3"},{id:"bar4",text:"Bar 4"},{id:"bar5",text:"Bar 5"},{id:"bar6",text:"Bar 6"},{id:"bar7",text:"Bar 8"},{id:"bar9",text:"Bar 9"},{id:"bar10",text:"Bar 10"},{id:"bar11",text:"Bar 11"},{id:"baz",text:"Baz"}]},null,8,["modelValue"])]),o("div",he,"selected id: "+c(t.placeholderModel),1)]),me,o("div",fe,[o("div",xe,[a(r,{modelValue:t.disabledSelected,"onUpdate:modelValue":n[4]||(n[4]=d=>t.disabledSelected=d),placeholder:"Disabled...","aria-label":"A List","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"}],disabled:""},null,8,["modelValue"])]),o("div",be,"selected id: "+c(t.disabledSelected),1)]),o("div",ge,[o("div",ve,[a(r,{modelValue:t.withSlotsSelected,"onUpdate:modelValue":n[5]||(n[5]=d=>t.withSlotsSelected=d),placeholder:"With slots...","aria-label":"A List","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"}]},{"icon-right":v(()=>[a(b)]),_:1},8,["modelValue"])]),o("div",ye,"selected id: "+c(t.withSlotsSelected),1)])]),o("section",null,[o("div",we,[o("div",_e,[a(l,{summary:"Show usage example"},{default:v(()=>[u(c(t.codeExample),1)]),_:1}),a(l,{summary:"Show Dropdown.vue source code"},{default:v(()=>[u(c(i.code),1)]),_:1})])])])])}const Be=V(oe,[["render",Ee]]);export{Be as default};
