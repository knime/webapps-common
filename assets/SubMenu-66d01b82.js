import{_ as w,m as l,o as y,c as I,b as e,d as n,w as o,O as M,P as k,e as f,t as v,r as d,p as S,f as O}from"./index-1d96568f.js";import{C}from"./CodeExample-6943b8d5.js";import{S as g}from"./SubMenu-35b842b5.js";import{S as m,H as x}from"./star-cbd5e2dc.js";import{H as T,L as B}from"./heart-90160fc9.js";import{M as W}from"./menu-options-dc8d9e9e.js";import"./arrow-next-99507fc3.js";const A=`<script lang="ts">
...
`,h=[{href:"http://apple.com",text:"Apples",icon:l(x),hotkeyText:"Ctrl + 1"},{href:"https://en.wikipedia.org/wiki/Orange_(colour)",text:"Oranges",icon:l(m),hotkeyText:"Ctrl + 2"},{href:"about:blank",text:"Disabled Item",disabled:!0,icon:l(m),hotkeyText:"Ctrl + 3"},{to:"/testing-nuxt-link",text:"Ananas",icon:l(T)},{href:"https://www.urbandictionary.com/define.php?term=go%20bananas",text:"Bananas",icon:l(B)},{text:"Item without href/to",icon:l(x),children:[{text:"I am part of a submenu",icon:m},{text:"Woohooo",href:"https://example.com/woohoo"}]}],P={components:{SubMenu:g,CodeExample:C,MenuIcon:W},data(){return{SubMenu:g,subMenuItems:h,codeExampleStandalone:D,code:A,teleport:!0}},computed:{subMenuItemsWithSeparator(){return h.map((t,a)=>a===2||a===4?{...t,separator:!0}:t)},subMenuItemsWithoutIcons(){return h.map(({icon:t,hotkeyText:a,...c})=>c)}}},s=t=>(S("data-v-5326d074"),t=t(),O(),t),E={class:"grid-container"},H={class:"grid-item-12"},N=s(()=>e("h2",null,"SubMenu",-1)),F=s(()=>e("p",null," A button that opens a dropdown menu containing clickable items. The menu will be positioned based on the orientation prop but will readjust automatically depending on available space. Resize window and/or scroll to try it out ",-1)),R={class:"submenus"},z={class:"card"},K=s(()=>e("span",{class:"menu-name"},"Normal",-1)),V={class:"card"},L=s(()=>e("span",{class:"menu-name"},"Orientation left",-1)),j={class:"card"},U=s(()=>e("span",{class:"menu-name"},"Orientation top",-1)),q={class:"card"},G=s(()=>e("span",{class:"menu-name"},"Disabled submenu",-1)),J={class:"card"},Q=s(()=>e("span",{class:"menu-name"},"Normal (reduced width)",-1)),X={class:"scroll-container"},Y={class:"card translated"},Z=s(()=>e("span",{class:"menu-name"},"With teleport",-1));function $(t,a,c,ee,i,p){const r=d("MenuIcon"),u=d("SubMenu",!0),b=d("CodeExample");return y(),I("section",null,[e("div",E,[e("div",H,[N,F,e("div",R,[e("div",z,[K,n(u,{items:p.subMenuItemsWithSeparator,"button-title":"Open my submenu"},{default:o(()=>[n(r,{class:"open-icon"})]),_:1},8,["items"])]),e("div",V,[L,n(u,{items:p.subMenuItemsWithSeparator,orientation:"left","button-title":"Open my submenu with icons"},{default:o(()=>[n(r,{class:"open-icon"})]),_:1},8,["items"])]),e("div",j,[U,n(u,{items:p.subMenuItemsWithSeparator,orientation:"top","button-title":"Open my submenu with icons"},{default:o(()=>[n(r,{class:"open-icon"})]),_:1},8,["items"])]),e("div",q,[G,n(u,{items:i.subMenuItems,disabled:"","button-title":"Open my submenu with icons"},{default:o(()=>[n(r,{class:"open-icon"})]),_:1},8,["items"])]),e("div",J,[Q,n(u,{items:p.subMenuItemsWithoutIcons,"max-menu-width":100,"button-title":"Open my submenu"},{default:o(()=>[n(r,{class:"open-icon"})]),_:1},8,["items"])]),e("div",X,[e("div",Y,[M(e("input",{"onUpdate:modelValue":a[0]||(a[0]=_=>i.teleport=_),type:"checkbox"},null,512),[[k,i.teleport]]),Z,n(u,{"teleport-to-body":i.teleport,items:p.subMenuItemsWithSeparator,"button-title":"Open my submenu"},{default:o(()=>[n(r,{class:"open-icon"})]),_:1},8,["teleport-to-body","items"])])])]),n(b,{summary:"Show usage example"},{default:o(()=>[f(v(i.codeExampleStandalone),1)]),_:1}),n(b,{summary:"Show SubMenu.vue source code"},{default:o(()=>[f(v(i.code),1)]),_:1})])])])}const ue=w(P,[["render",$],["__scopeId","data-v-5326d074"]]);export{ue as default};
