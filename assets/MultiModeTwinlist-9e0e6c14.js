import{C as P}from"./CodeExample-a53af527.js";import{L as x}from"./Label-bfbeb9b5.js";import{aq as M,_ as T,r as d,o as u,c as w,j as y,w as h,d as r,l as f,v as _,n as k,b as l,e as b,t as m}from"./index-eeaa987d.js";import{C as L}from"./Checkboxes-5d66abaf.js";import{V as C}from"./ValueSwitch-166cb38c.js";import{T as U,f as I}from"./Twinlist-add28b84.js";import{F as B}from"./filter-a12f74d5.js";import"./Checkbox-9341d5f5.js";import"./BaseRadioButtons-e46e400c.js";import"./MultiselectListBox-c7b1e259.js";import"./StyledListItem-02c7939f.js";import"./arrow-next-2b650c28.js";const F={manual:"Manual",wildcard:"Wildcard",regex:"Regex",type:"Type"},z={components:{Label:x,FilterIcon:B,SearchInput:M,Checkboxes:L,ValueSwitch:C,Twinlist:U},props:{initialMode:{type:String,required:!1,default:"manual"},initialManuallySelected:{type:Array,default:()=>[]},initialIncludeUnknownValues:{type:Boolean,default:!1},initialPattern:{type:String,default:""},initialCaseSensitivePattern:{default:!1,type:Boolean},initialInversePattern:{default:!1,type:Boolean},withTypes:{type:Boolean,default:!0},initialSelectedTypes:{type:Array,default:()=>[]},showMode:{default:!1,type:Boolean},showUnknownValues:{default:!1,type:Boolean},showSearch:{default:!0,type:Boolean},disabled:{default:!1,type:Boolean},withModeLabel:{default:!1,type:Boolean},modeLabel:{type:String,required:!1,default:"Selection mode"},withPatternLabel:{default:!1,type:Boolean},patternLabel:{type:String,required:!1,default:"Pattern"},withTypesLabel:{default:!1,type:Boolean},typesLabel:{type:String,required:!1,default:"Selected types"},possibleValues:{type:Array,default:()=>[]},additionalPossibleTypes:{type:Array,default:()=>[]}},emits:["input","includeUnknownValuesInput","patternInput","typesInput","modeInput","caseSensitivePatternInput","inversePatternInput"],data(){return{chosenValues:this.initialManuallySelected,chosenPattern:this.initialPattern,chosenTypes:this.initialSelectedTypes,invalidPossibleValueIds:new Set,mode:this.initialMode,caseSensitivePattern:this.initialCaseSensitivePattern,inversePattern:this.initialInversePattern,includeUnknownValues:this.initialIncludeUnknownValues,isFirstInput:!0}},computed:{possibleValueIds(){return this.possibleValues.map(({id:e})=>e)},possibleTypes(){const e=this.possibleValues.map(({type:t})=>t).filter(Boolean),n=e.map(t=>t.id);return[...this.additionalPossibleTypes.filter(t=>t&&!n.includes(t.id)),...e].filter(t=>t&&t.id!=="").filter((t,i,p)=>i===p.findIndex(o=>o.id===t.id&&o.text===t.text))},matchingValueIds(){return this.possibleValues.filter(e=>this.itemMatches(e)).map(e=>e.id)},selectedValues(){return this.mode==="manual"?this.chosenValues:this.matchingValueIds},deselectedValues(){const e=new Set(this.selectedValues??[]);return this.possibleValueIds.filter(n=>!e.has(n))},selectionDisabled(){return this.disabled||this.mode!=="manual"},normalizedSearchTerm(){return this.mode==="manual"?null:I[this.mode].normalize(this.mode==="type"?this.chosenTypes:this.chosenPattern,this.caseSensitivePattern)},possibleModes(){let e=Object.entries(F).map(([n,s])=>({id:n,text:s}));return this.withTypes||(e=e.filter(n=>n.id!=="type")),e},possibleModeIds(){return this.possibleModes.map(e=>e.id)},unknownValuesVisible(){return this.showUnknownValues&&this.mode==="manual"}},watch:{selectedValues:{immediate:!0,handler(e,n){if(e!==null&&(!n||e.length!==n.length||n.some((s,c)=>s!==e[c]))){const s=this.mode==="manual",c=this.isFirstInput,t={selected:this.selectedValues,isManual:s,isFirstInput:c};s&&(t.deselected=this.deselectedValues),this.$emit("input",t),this.isFirstInput=!1}}},includeUnknownValues(e){this.$emit("includeUnknownValuesInput",e)},initialManuallySelected(e,n){(e===null||n===null)&&(this.chosenValues=e)}},methods:{onManualInput(e){this.mode==="manual"&&(this.chosenValues=e)},onPatternInput(e){this.chosenPattern=e,this.$emit("patternInput",e)},onTypeInput(e){this.chosenTypes=e,this.$emit("typesInput",e,this.possibleTypes)},onModeChange(e){this.possibleModeIds.indexOf(e)!==-1&&(this.mode=e,this.$emit("modeInput",e))},onToggleCaseSensitivePattern(e){this.caseSensitivePattern=e,this.$emit("caseSensitivePatternInput",e)},onToggleInvsersePattern(e){this.inversePattern=e,this.$emit("inversePatternInput",e)},onUnkownColumnsInput(e){this.includeUnknownValues=e},validate(){return this.$refs.twinlist.validate()},hasSelection(){var e;return Boolean((e=this.selectedValues)==null?void 0:e.length)},itemMatches(e){var s;return I[this.mode].test(this.mode==="type"?(s=e.type)==null?void 0:s.id:e.text,this.normalizedSearchTerm,this.caseSensitivePattern,this.inversePattern)}}};function A(e,n,s,c,t,i){const p=d("ValueSwitch"),o=d("Label"),a=d("FilterIcon"),V=d("SearchInput"),S=d("Checkboxes"),g=d("Twinlist");return u(),w("div",{class:k(["multi-mode-twinlist",{disabled:s.disabled}])},[s.showMode?(u(),y(o,{key:0,active:s.withModeLabel,text:s.modeLabel,class:"label"},{default:h(({labelForId:v})=>[r(p,{id:v,ref:"mode","model-value":t.mode,disabled:s.disabled,"possible-values":i.possibleModes,"onUpdate:modelValue":i.onModeChange},null,8,["id","model-value","disabled","possible-values","onUpdate:modelValue"])]),_:1},8,["active","text"])):f("",!0),t.mode==="regex"||t.mode==="wildcard"?(u(),y(o,{key:1,active:s.withPatternLabel,text:s.patternLabel,class:"label"},{default:h(({labelForId:v})=>[r(V,{id:v,ref:"search","model-value":t.chosenPattern,label:s.patternLabel,"initial-case-sensitive-search":s.initialCaseSensitivePattern,"initial-inverse-search":s.initialInversePattern,placeholder:"Pattern","show-case-sensitive-search-button":"","show-inverse-search-button":"",disabled:s.disabled,"onUpdate:modelValue":i.onPatternInput,onToggleCaseSensitiveSearch:i.onToggleCaseSensitivePattern,onToggleInverseSearch:i.onToggleInvsersePattern},{icon:h(()=>[r(a)]),_:2},1032,["id","model-value","label","initial-case-sensitive-search","initial-inverse-search","disabled","onUpdate:modelValue","onToggleCaseSensitiveSearch","onToggleInverseSearch"])]),_:1},8,["active","text"])):f("",!0),t.mode==="type"&&i.possibleTypes.length>0?(u(),y(o,{key:2,active:s.withTypesLabel,text:s.typesLabel,class:"label"},{default:h(()=>[r(S,{"model-value":t.chosenTypes,"possible-values":i.possibleTypes,disabled:s.disabled,"onUpdate:modelValue":i.onTypeInput},null,8,["model-value","possible-values","disabled","onUpdate:modelValue"])]),_:1},8,["active","text"])):f("",!0),r(g,_(e.$attrs,{ref:"twinlist",disabled:i.selectionDisabled,"show-search":t.mode==="manual"&&s.showSearch,"model-value":i.selectedValues,"possible-values":s.possibleValues,"show-unknown-values":i.unknownValuesVisible,"initial-include-unknown-values":t.includeUnknownValues,"onUpdate:modelValue":i.onManualInput,onIncludeUnknownValuesInput:i.onUnkownColumnsInput}),null,16,["disabled","show-search","model-value","possible-values","show-unknown-values","initial-include-unknown-values","onUpdate:modelValue","onIncludeUnknownValuesInput"])],2)}const O=T(z,[["render",A],["__scopeId","data-v-dab8e796"]]),q=`<script lang="ts">
