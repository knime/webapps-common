import{C as k}from"./CodeExample-ytjrgJ7P.js";import{a_ as L,i as y,R as u,Y as V,_ as C,r as f,o as v,c as S,b as a,k as F,w as B,d as m,l as g,t as x,v as E,ah as M,n as T,g as N,e as _}from"./index-7x0lt_p4.js";import{u as U}from"./useSearch-BrfIqYL7.js";import{C as A}from"./Checkboxes-CLOpaOqL.js";import{L as H}from"./Label-egX1qGwP.js";import{c as O}from"./createMissingItem-PGCdVBns.js";import{u as P}from"./useLabelInfo-BSzjojAI.js";import"./Checkbox-ATGuw3h3.js";import"./v4-C6aID195.js";const z=5,R=28,D={name:"SearchableCheckboxes",components:{Label:H,SearchInput:L,Checkboxes:A},props:{possibleValues:{type:Array,default:()=>{},validator(t){return Array.isArray(t)?t.every(e=>e.hasOwnProperty("id")&&e.hasOwnProperty("text")):!1}},modelValue:{type:Array,default:()=>[]},disabled:{type:Boolean,default:!1},withSearchLabel:{default:!1,type:Boolean},id:{type:String,default:null},initialCaseSensitiveSearch:{default:!1,type:Boolean},showSearch:{type:Boolean,default:!1},size:{type:Number,default:5,validator(t){return t>=0}},searchLabel:{type:String,required:!1,default:""},searchPlaceholder:{type:String,required:!1,default:"Search"},alignment:{type:String,default:"horizontal",validator(t){return["horizontal","vertical"].includes(t)}},emptyStateLabel:{type:String,default:"No entries in this list"},initialSearchTerm:{type:String,required:!1,default:""},showEmptyState:{default:!0,type:Boolean},isValid:{default:!0,type:Boolean},emptyStateComponent:{default:null,type:Object},compact:{type:Boolean,default:!1}},emits:["update:modelValue"],setup(t){const e=y(t.initialSearchTerm),s=y(t.initialCaseSensitiveSearch),r=u(()=>Object.assign({},...t.possibleValues.map((l,n)=>({[l.id]:{item:l,index:n}})))),o=u(()=>t.possibleValues.map(l=>{var n;return(n=r.value[l.id])==null?void 0:n.item})),i=u(()=>{var l;return t.modelValue?(l=t.modelValue)==null?void 0:l.filter(n=>!r.value[n]):[]}),c=u(()=>{var l;return(l=i.value)==null?void 0:l.map(n=>O(n))}),h=u(()=>t.modelValue===null?[]:[...c.value,...o.value]),d=U(e,s,h,V(t,"showSearch")),b=u(()=>d.value.length===0?[]:d.value.filter(l=>h.value.includes(l))),p=u(()=>t.showSearch&&e.value!==""),I=u(()=>b.value.filter(n=>n.text.toLowerCase().includes(e.value.toLowerCase()))),w=u(()=>{var l,n;return t.showSearch?p.value?P(I,o.value.length,V(t.modelValue??[])):`[ ${(n=t.modelValue)==null?void 0:n.length} selected ]`:`[ ${(l=t.modelValue)==null?void 0:l.length} selected ]`});return{searchTerm:e,visibleValues:h,concatenatedItems:b,caseSensitiveSearch:s,numLabelInfos:w,matchingInvalidValueIds:c,allItems:d}},computed:{withIsEmptyState(){return this.concatenatedItems.length===0},listSize(){if(this.possibleValues.length>=z){const t=this.size===0?this.possibleValues.length:this.size;return t>z?t:z}return this.size},cssStyleSize(){const t=`${this.listSize*R+2}px`;return this.listSize>0?{height:t}:{}},returnContainerRef(){return this.$refs.div},alignmentCheck(){return this.alignment==="vertical"?this.cssStyleSize:{height:"auto"}}},methods:{onSearchInput(t){this.searchTerm=t},onChange(t){this.$emit("update:modelValue",t)},hasSelection(){var t;return(((t=this.modelValue)==null?void 0:t.length)??0)>0},handleMouseIn(){!this.disabled&&this.size>=z&&(this.returnContainerRef.style.overflow="auto")},handleMouseLeave(){this.returnContainerRef.style.overflow="hidden"},validate(){const t=!this.concatenatedItems.some(e=>e.invalid);return{isValid:t,errorMessage:t?null:"One or more of the selected items is invalid."}}}},q={class:"checkboxes-wrapper"},Z={class:"header"},j={class:"title"},X={key:0,class:"info"},Y={key:0,class:"empty-state"};function G(t,e,s,r,o,i){const c=f("SearchInput"),h=f("Label"),d=f("Checkboxes");return v(),S("div",null,[a("div",q,[s.showSearch?(v(),F(h,{key:0,active:s.withSearchLabel,text:s.searchLabel,class:"search-wrapper"},{default:B(({labelForId:b})=>[m(c,{id:b,ref:"search",placeholder:s.searchPlaceholder,"model-value":r.searchTerm,label:s.searchLabel,"initial-case-sensitive-search":s.initialCaseSensitiveSearch,"show-case-sensitive-search-button":"",disabled:s.disabled,compact:s.compact,"onUpdate:modelValue":i.onSearchInput,onToggleCaseSensitiveSearch:e[0]||(e[0]=p=>r.caseSensitiveSearch=p)},null,8,["id","placeholder","model-value","label","initial-case-sensitive-search","disabled","compact","onUpdate:modelValue"])]),_:1},8,["active","text"])):g("",!0),a("div",Z,[a("div",j,[r.numLabelInfos?(v(),S("div",X,x(r.numLabelInfos),1)):g("",!0)])])]),a("div",{ref:"div",class:T(["container",{disabled:s.disabled,"empty-box":i.withIsEmptyState}]),style:N([i.alignmentCheck,i.cssStyleSize]),onMouseenter:e[1]||(e[1]=(...b)=>i.handleMouseIn&&i.handleMouseIn(...b)),onMouseleave:e[2]||(e[2]=(...b)=>i.handleMouseLeave&&i.handleMouseLeave(...b))},[E(m(d,{ref:"form","empty-state-label":s.emptyStateLabel,"empty-state-component":s.emptyStateComponent,"model-value":s.modelValue,alignment:s.alignment,"possible-values":r.concatenatedItems,"is-valid":s.isValid,disabled:s.disabled,"onUpdate:modelValue":i.onChange},null,8,["empty-state-label","empty-state-component","model-value","alignment","possible-values","is-valid","disabled","onUpdate:modelValue"]),[[M,!i.withIsEmptyState]]),!r.concatenatedItems.length&&i.withIsEmptyState?(v(),S("div",Y,[a("span",null,x(s.emptyStateLabel),1)])):g("",!0)],38)])}const J=C(D,[["render",G],["__scopeId","data-v-a352b922"]]),K="",Q=`<SearchableCheckboxes
  v-model="selected"
  :possible-values="[{
    id: 'foo',
    text: 'Foo'
