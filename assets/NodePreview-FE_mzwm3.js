import{C as M}from"./CodeExample-IwVof1Ph.js";import{P as E}from"./PortIcon-BmBf_-UM.js";import{S as T,b as N,c as D,d as H,e as P,Y as F,f as G,g as R,h as $,i as U,L as B,j as V,k as Y,l as L,A as z,H as O}from"./knimeColors-ZxOyY6H5.js";import{_,o as a,c as i,b as t,l as y,r as m,d as u,F as S,g as v,j as A,aC as b,aD as C,w as k,e as g,t as w,p as Q,f as q}from"./index-WIHAw100.js";const I=T,K=N,W=D,j=H,J=P,Z=P,X=P,oo=F,eo=G,to=R,no=$,ro=U,ao=N,so=B,io=B,co=V,lo=Y,po=L,uo=L,mo=z,go=z,fo=Object.freeze(Object.defineProperty({__proto__:null,Component:I,Configuration:K,Container:W,Learner:j,Loop:J,LoopEnd:Z,LoopStart:X,Manipulator:oo,Metanode:eo,MetanodeSecondary:to,Other:no,Predictor:ro,QuickForm:ao,ScopeEnd:so,ScopeStart:io,Sink:co,Source:lo,VirtualIn:po,VirtualOut:uo,Visualizer:mo,Widget:go},Symbol.toStringTag,{value:"Module"})),yo=32,x={default:"M0,29.2L0,2.8C0,1.3,1.3,0,2.8,0l26.3,0C30.7,0,32,1.3,32,2.8v26.3c0,1.6-1.3,2.8-2.8,2.8H2.8C1.3,32,0,30.7,0,29.2z",LoopEnd:"M32,2.8v26.3c0,1.6-1.3,2.8-2.8,2.8H4L0,16.1L4,0l25.2,0C30.7,0,32,1.3,32,2.8z",LoopStart:"M0,29.2L0,2.8C0,1.3,1.3,0,2.8,0L32,0l-4,15.9L32,32H2.8C1.3,32,0,30.7,0,29.2z",ScopeEnd:"M32,2.8v26.3c0,1.6-1.3,2.8-2.8,2.8H4L0,16.1L4,0l25.2,0C30.7,0,32,1.3,32,2.8z",ScopeStart:"M0,29.2L0,2.8C0,1.3,1.3,0,2.8,0L32,0l-4,15.9L32,32H2.8C1.3,32,0,30.7,0,29.2z",VirtualIn:"M32,2.8v26.3c0,1.6-1.3,2.8-2.8,2.8H6.5L0,25.9l5.2-10L0.7,7.2L6.5,0l22.7,0C30.7,0,32,1.3,32,2.8z",VirtualOut:"M0,29.2L0,2.8C0,1.3,1.3,0,2.8,0L32,0l-5.8,7.2l4.5,8.7l-5.2,10L32,32H2.8C1.3,32,0,30.7,0,29.2z"},ho=.75,Po={props:{type:{type:String,default:null},isComponent:{type:Boolean,default:!1},icon:{type:String,default:null,validator:o=>o.startsWith("data:image/")}},computed:{backgroundPath(){return x[this.type]||x.default},backgroundColor(){return fo[this.type]||O},componentColor(){return I},componentBackgroundTransformation(){let o=yo/2;return`translate(${o}, ${o}) scale(${ho}) translate(-${o}, -${o})`}}},_o=["d","fill"],So=["d","fill","transform"],vo=["xlink:href"];function Ao(o,s,e,f,r,n){return a(),i("g",null,[t("path",{class:"bg",d:n.backgroundPath,fill:e.isComponent?n.componentColor:n.backgroundColor},null,8,_o),e.isComponent&&e.type?(a(),i("path",{key:0,class:"bg",d:n.backgroundPath,fill:n.backgroundColor,transform:n.componentBackgroundTransformation},null,8,So)):y("",!0),e.icon?(a(),i("image",{key:1,"xlink:href":e.icon,x:"8",y:"8",width:"16",height:"16","pointer-events":"none"},null,8,vo)):y("",!0)])}const bo=_(Po,[["render",Ao]]),Co={components:{PortIcon:E,NodeTorsoNormal:bo},props:{type:{type:String,default:null},isComponent:{type:Boolean,default:!1},inPorts:{type:Array,default:()=>[]},outPorts:{type:Array,default:()=>[]},hasDynPorts:{type:Boolean,default:!1},icon:{type:String,default:null,validator:o=>o.startsWith("data:image/")}},data(){return{viewBox:"-19 -19 70 70"}},methods:{yPortShift(o,s){let r=1;s===2?r=12:s===3&&(r=1.5);let l=(32-(s*9+(s-1)*r))/2;return(r+9)*o+l+9/2}}},ko=["viewBox"],wo={key:0,stroke:"none"},xo=t("circle",{r:"1.2",cx:"4",cy:"27"},null,-1),No=t("circle",{r:"1.2",cx:"9",cy:"27"},null,-1),Bo=t("circle",{r:"1.2",cx:"14",cy:"27"},null,-1),Lo=[xo,No,Bo];function zo(o,s,e,f,r,n){const l=m("NodeTorsoNormal"),d=m("PortIcon");return a(),i("svg",{viewBox:r.viewBox},[u(l,{type:e.type,icon:e.icon,"is-component":e.isComponent},null,8,["type","icon","is-component"]),(a(!0),i(S,null,v(e.inPorts,(c,p)=>(a(),A(d,{key:`in-${p}`,color:c.color,filled:!c.optional,type:c.type,transform:`translate(-4.5, ${n.yPortShift(p,e.inPorts.length)})`},null,8,["color","filled","type","transform"]))),128)),(a(!0),i(S,null,v(e.outPorts,(c,p)=>(a(),A(d,{key:`out-${p}`,color:c.color,filled:!c.optional,type:c.type,transform:`translate(36.5, ${n.yPortShift(p,e.outPorts.length)})`},null,8,["color","filled","type","transform"]))),128)),e.hasDynPorts?(a(),i("g",wo,Lo)):y("",!0)],8,ko)}const Io=_(Co,[["render",zo]]),Mo=`<script>
