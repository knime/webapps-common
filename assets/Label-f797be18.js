import{C as h}from"./CodeExample-7b34a21f.js";import{_ as f,I as m,r,o as g,c as _,b as e,d as t,w as a,e as l,t as c,p as x,f as I}from"./index-9da2c03d.js";import{L as v}from"./Label-7db391f8.js";const y=`<script>
let labelForId = 0;
/**
...
>
  <InputField
    ...
    placeholder="I'm a placeholder"
  />
</Label>`,L={components:{InputField:m,Label:v,CodeExample:h},data(){return{codeExample:F}},computed:{code(){return y}}},p=o=>(x("data-v-8237dfe1"),o=o(),I(),o),w=p(()=>e("div",{class:"grid-container"},[e("div",{class:"grid-item-12"},[e("p",null,[l(" Labels for form fields. Beside their default size, they come with a larger one as well which can be enabled by setting the "),e("code",null,"large"),l(" prop or "),e("a",{href:"https://vuejs.org/v2/guide/components-edge-cases.html#Dependency-Injection"},"providing"),l("  "),e("code",null,"largeLabels: true"),l(". ")])])],-1)),S={class:"grid-container"},B={class:"grid-item-6"},C={class:"grid-item-6"},$=p(()=>e("div",{class:"grid-container"},[e("div",{class:"grid-item-12"},[e("p",null," The components the label is for can also be rendered without the label itself. This allows disabling label use more conveniently in more compact layouts. ")])],-1)),E={class:"grid-container"},T={class:"grid-item-6"},k={class:"grid-container"},z={class:"grid-item-12"};function D(o,N,j,H,u,b){const d=r("InputField"),i=r("Label",!0),s=r("CodeExample");return g(),_("div",null,[e("section",null,[w,e("div",S,[e("div",B,[t(i,{text:"Label for a field"},{default:a(({labelForId:n})=>[t(d,{id:n,type:"text",placeholder:"I'm a placeholder"},null,8,["id"])]),_:1})]),e("div",C,[t(i,{text:"Large label for a field",large:""},{default:a(({labelForId:n})=>[t(d,{id:n,type:"text",placeholder:"I'm a placeholder"},null,8,["id"])]),_:1})])]),$,e("div",E,[e("div",T,[t(i,{active:!1,text:"Hidden label for a field"},{default:a(({labelForId:n})=>[t(d,{id:n,type:"text",placeholder:"I'm a placeholder"},null,8,["id"])]),_:1})])])]),e("section",null,[e("div",k,[e("div",z,[t(s,{summary:"Show usage example"},{default:a(()=>[l(c(u.codeExample),1)]),_:1}),t(s,{summary:"Show Label.vue source code"},{default:a(()=>[l(c(b.code),1)]),_:1})])])])])}const M=f(L,[["render",D],["__scopeId","data-v-8237dfe1"]]);export{M as default};
