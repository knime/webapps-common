import{C as _}from"./CodeExample-ff021a53.js";import{_ as p,o as m,c as f,b as e,u as b,n as w,d as i,w as c,e as l,t as g,r as h}from"./index-02e57c95.js";const x={props:{id:{type:String,default:null},name:{type:String,default:null},modelValue:{type:Boolean,default:!1},labelSize:{type:String,default:"regular"}},emits:["update:modelValue"],methods:{onChange(r){let{checked:n}=r.target;consola.trace("ToggleSwitch value changed to",n),this.$emit("update:modelValue",n)},isChecked(){return this.$refs.input.checked}}},k=["id","name","checked"];function y(r,n,o,v,t,d){return m(),f("label",{class:w(["toggle",o.labelSize])},[e("input",{id:o.id,ref:"input",name:o.name,type:"checkbox",checked:o.modelValue,onChange:n[0]||(n[0]=(...a)=>d.onChange&&d.onChange(...a))},null,40,k),e("span",null,[b(r.$slots,"default",{},void 0,!0)])],2)}const S=p(x,[["render",y],["__scopeId","data-v-e0d78fe7"]]),V=`<script>
export default {
  props: {
    id: {
      type: String,
