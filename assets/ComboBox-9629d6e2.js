import{C as S}from"./CodeExample-a9ae182d.js";import{q as C,s as B,O as F,a9 as y,_ as V,r as f,o as I,j as E,w as v,b as t,x as m,y as u,n as _,c as w,F as M,g as k,t as r,d as l,P as x,h as A,ae as z,W as T,e as b}from"./index-de59e6d8.js";import{M as D}from"./Multiselect-ac837039.js";import"./Checkbox-9bf3482e.js";import"./arrow-dropdown-423c6b7c.js";const g="draft-id-combobox-preview-item",R=C({components:{Multiselect:D,FunctionButton:B,CloseIcon:F},props:{possibleValues:{type:Array,default:()=>[],validator(e){return Array.isArray(e)?e.every(s=>s.hasOwnProperty("id")&&s.hasOwnProperty("text")):!1}},initialSelectedIds:{type:Array,default:()=>[]},sizeVisibleOptions:{type:Number,default:5,validator(e){return e>=0}},closeDropdownOnSelection:{type:Boolean,default:!1},isValid:{type:Boolean,default:!0},allowNewValues:{type:Boolean,default:!1}},emits:{"update:selectedIds":e=>!0,change:e=>!0},data(){return{selectedIds:this.initialSelectedIds,searchValue:"",inputOrOptionsFocussed:!1,focusElement:null,refocusElement:null,allPossibleItems:this.possibleValues}},computed:{isSearchEmpty(){return!this.searchValue.trim()},searchResults(){const e=this.allPossibleItems.some(({text:d})=>d.toLowerCase()===this.searchValue.toLowerCase()),s=this.allPossibleItems.filter(({text:d})=>d.toLowerCase().includes(this.searchValue.toLowerCase()));return this.allowNewValues&&!e&&!this.isSearchEmpty?[{id:g,text:`${this.searchValue} (new item)`},...s]:s},hasSelection(){return this.selectedValues.length>0},inputWidth(){return this.inputOrOptionsFocussed&&this.searchResults.length>0?{}:{width:"0%"}},selectedValues(){return this.selectedIds.length===0?[]:this.selectedIds.map(e=>this.allPossibleItems.find(d=>d.id===e)||{id:e,text:e})},maxSizeVisibleOptions(){return this.searchResults.length<this.sizeVisibleOptions?this.searchResults.length:this.sizeVisibleOptions}},watch:{initialSelectedIds(e){this.changeSelectedIds(e)}},mounted(){this.focusElement=this.$refs.searchInput,this.refocusElement=this.$refs.listBox},methods:{changeSelectedIds(e){this.selectedIds=e,this.$emit("update:selectedIds",this.selectedIds),this.$emit("change",this.selectedValues)},focusInput(){this.$refs.searchInput.focus()},onDown(){this.$refs.combobox.onDown()},onEnter(){var e;this.isSearchEmpty||(this.updateSelectedIds([...this.selectedIds,(e=this.searchResults[0])==null?void 0:e.id]),this.searchValue="")},onBackspace(){this.searchValue||this.changeSelectedIds(this.selectedIds.slice(0,-1))},onFocusOutside(){this.inputOrOptionsFocussed=!1,this.searchValue=""},onInput(){this.$refs.combobox.updateFocusOptions()},onInputFocus(){this.inputOrOptionsFocussed||this.$refs.combobox.toggle(),this.inputOrOptionsFocussed=!0,this.$refs.combobox.updateFocusOptions()},updateSelectedIds(e){const s=a=>{this.changeSelectedIds(y.uniq(a).filter(Boolean))};if(!e.includes(g)){s(e);return}const p={id:y.kebabCase(this.searchValue),text:this.searchValue.trim()};this.allPossibleItems.some(a=>a.id===p.id)||(this.allPossibleItems.push(p),s(e.map(a=>a===g?p.id:a)))},removeTag(e){this.updateSelectedIds(this.selectedIds.filter(s=>s!==e)),this.closeOptions()},removeAllTags(){this.updateSelectedIds([]),this.closeOptions()},closeOptionsAndStop(e){this.$refs.combobox.closeOptionsAndStop(e)},closeOptions(){this.$refs.combobox.closeOptions()}}});const P=["title"],$={class:"text"},L={class:"icon-right"};function N(e,s,d,p,n,a){const c=f("CloseIcon"),h=f("FunctionButton"),o=f("Multiselect");return I(),E(o,{ref:"combobox","model-value":e.selectedIds,"possible-values":e.searchResults,"use-custom-list-box":"","size-visible-options":e.maxSizeVisibleOptions,"parent-focus-element":e.focusElement,"parent-refocus-element-on-close":e.refocusElement,"close-dropdown-on-selection":e.closeDropdownOnSelection,"is-valid":e.isValid,onFocusOutside:e.onFocusOutside,"onUpdate:modelValue":e.updateSelectedIds},{listBox:v(()=>[t("div",{ref:"listBox",class:"summary-input-icon-wrapper",tabindex:"0",onKeydown:s[8]||(s[8]=m(u((...i)=>e.focusInput&&e.focusInput(...i),["prevent","self"]),["enter"]))},[t("div",{class:_(["summary-input-wrapper",{"with-icon-right":e.hasSelection}]),onClick:s[7]||(s[7]=u((...i)=>e.focusInput&&e.focusInput(...i),["stop"]))},[(I(!0),w(M,null,k(e.selectedValues,(i,O)=>(I(),w("div",{key:`item.id${O}`,class:"tag",title:i.text},[t("span",$,r(i.text),1),l(h,{class:"remove-tag-button",onClick:u(be=>e.removeTag(i.id),["stop"])},{default:v(()=>[l(c,{class:"remove-tag-button-icon"})]),_:2},1032,["onClick"])],8,P))),128)),x(t("input",{ref:"searchInput","onUpdate:modelValue":s[0]||(s[0]=i=>e.searchValue=i),class:"search-input",type:"text",style:A(e.inputWidth),onFocus:s[1]||(s[1]=(...i)=>e.onInputFocus&&e.onInputFocus(...i)),onInput:s[2]||(s[2]=(...i)=>e.onInput&&e.onInput(...i)),onKeydown:[s[3]||(s[3]=m(u((...i)=>e.onEnter&&e.onEnter(...i),["prevent"]),["enter"])),s[4]||(s[4]=m((...i)=>e.onBackspace&&e.onBackspace(...i),["backspace"])),s[5]||(s[5]=m(u((...i)=>e.onDown&&e.onDown(...i),["stop","prevent"]),["down"])),s[6]||(s[6]=m((...i)=>e.closeOptionsAndStop&&e.closeOptionsAndStop(...i),["esc"]))]},null,36),[[z,e.searchValue]])],2),x(t("div",L,[l(h,{ref:"removeAllTags",class:"remove-all-tags-button",onClick:u(e.removeAllTags,["stop"])},{default:v(()=>[l(c)]),_:1},8,["onClick"])],512),[[T,e.hasSelection]])],544)]),_:1},8,["model-value","possible-values","size-visible-options","parent-focus-element","parent-refocus-element-on-close","close-dropdown-on-selection","is-valid","onFocusOutside","onUpdate:modelValue"])}const U=V(R,[["render",N],["__scopeId","data-v-4eb8098a"]]),W=`<script lang="ts">
...
/>`,q={components:{ComboBox:U,CodeExample:S},data(){return{codeExample:j,selected:[[],[],[]],selectedValues:[],values:[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"lorem",text:"Lorem"},{id:"ipsum",text:"Ipsum"},{id:"dolor",text:"dolor"}]}},computed:{code(){return W}}},K=t("div",{class:"grid-container"},[t("div",{class:"grid-item-12"},[t("p",null,[b(" A combobox component. It emits an "),t("code",null,"update"),b(" event when an option is (de-)selected and has a list of selected "),t("code",null,"values"),b(". ")])])],-1),H={class:"grid-container"},G=t("div",{class:"grid-item-3"},"default",-1),J={class:"grid-item-6"},Q={class:"grid-item-3"},X=t("br",null,null,-1),Y={class:"grid-container"},Z=t("div",{class:"grid-item-3"},"max visible options: 3",-1),ee={class:"grid-item-6"},se={class:"grid-item-3"},te=t("br",null,null,-1),ne={class:"grid-container"},ie=t("div",{class:"grid-item-3"},"allow new values",-1),oe={class:"grid-item-6"},le={class:"grid-item-3"},ae=t("br",null,null,-1),de={class:"grid-container"},re=t("div",{class:"grid-item-3"},"close dropdown on selection",-1),ce={class:"grid-item-6"},ue={class:"grid-item-3"},pe={class:"grid-container"},he={class:"grid-item-12"},me={class:"grid-container"},fe={class:"grid-item-12"};function ve(e,s,d,p,n,a){const c=f("ComboBox",!0),h=f("CodeExample");return I(),w("div",null,[t("section",null,[K,t("div",H,[G,t("div",J,[l(c,{"possible-values":n.values,"initial-selected-ids":n.selected[0],"onUpdate:selectedIds":s[0]||(s[0]=o=>n.selected[0]=o),onChange:s[1]||(s[1]=o=>n.selectedValues=o)},null,8,["possible-values","initial-selected-ids"])]),t("div",Q,"selected-ids: "+r(n.selected[0]),1)]),X,t("div",Y,[Z,t("div",ee,[l(c,{"possible-values":n.values,"initial-selected-ids":n.selected[1],"size-visible-options":3,"onUpdate:selectedIds":s[2]||(s[2]=o=>n.selected[1]=o),onChange:s[3]||(s[3]=o=>n.selectedValues=o)},null,8,["possible-values","initial-selected-ids"])]),t("div",se,"selected-ids: "+r(n.selected[1]),1)]),te,t("div",ne,[ie,t("div",oe,[l(c,{"possible-values":n.values,"initial-selected-ids":n.selected[0],"allow-new-values":"","onUpdate:selectedIds":s[4]||(s[4]=o=>n.selected[0]=o),onChange:s[5]||(s[5]=o=>n.selectedValues=o)},null,8,["possible-values","initial-selected-ids"])]),t("div",le,"selected-ids: "+r(n.selected[0]),1)]),ae,t("div",de,[re,t("div",ce,[l(c,{"possible-values":n.values,"initial-selected-ids":n.selected[2],"close-dropdown-on-selection":"","onUpdate:selectedIds":s[6]||(s[6]=o=>n.selected[2]=o),onChange:s[7]||(s[7]=o=>n.selectedValues=o)},null,8,["possible-values","initial-selected-ids"])]),t("div",ue,"selected-ids: "+r(n.selected[2]),1)]),t("div",pe,[t("div",he,"Selected Values: "+r(n.selectedValues),1)])]),t("section",null,[t("div",me,[t("div",fe,[l(h,{summary:"Show usage example"},{default:v(()=>[b(r(n.codeExample),1)]),_:1}),l(h,{summary:"Show ComboBox.vue source code"},{default:v(()=>[b(r(a.code),1)]),_:1})])])])])}const Ve=V(q,[["render",ve]]);export{Ve as default};
