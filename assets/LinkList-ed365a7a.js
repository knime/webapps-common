import{C as x}from"./CodeExample-61071ab3.js";import{o as e,c as o,b as r,q as v,_ as k,r as a,F as w,g as y,d as s,e as c,t as p,l as u,w as m}from"./index-87d0366a.js";const L={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},b=r("path",{d:"M17.3 3.3 30 16 17.3 28.7M30 16H2"},null,-1),$=[b];function I(t,d){return e(),o("svg",L,$)}const E={render:I},A=v({components:{ArrowIcon:E},props:{links:{type:Array,default:()=>[]}}});const C={key:0,class:"link-list"},N=["href"];function M(t,d,_,h,f,i){const l=a("ArrowIcon");return t.links&&t.links.length?(e(),o("ul",C,[(e(!0),o(w,null,y(t.links,(n,g)=>(e(),o("li",{key:g},[n.url?(e(),o("a",{key:0,href:n.url,rel:"ugc noopener"},[s(l),c(" "+p(n.text||n.url),1)],8,N)):u("",!0)]))),128))])):u("",!0)}const z=k(A,[["render",M],["__scopeId","data-v-4786efed"]]),B=`<script lang="ts">
