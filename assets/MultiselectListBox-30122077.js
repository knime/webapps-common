import{C as h}from"./CodeExample-83ed4e50.js";import{M as m}from"./MultiselectListBox-e6c6f4a9.js";import{_ as x,o as f,c as b,b as e,d as s,t as o,w as a,e as r,a as p,r as c}from"./index-ae19d8f6.js";import"./StyledListItem-6dbe17ef.js";const v=`<script>
...
/>`,y={components:{MultiselectListBox:m,CodeExample:h},data(){return{codeExample:g,selected:[],disabledSelected:[],selected2:[],disabledSelected2:[],bottomValueSymbol:Symbol("bottom value")}},computed:{code(){return v}}},S=p('<div class="grid-container"><div class="grid-item-12"><h2>MultiselectListBox</h2><p> A list box for selecting multiple items. It acts as a form element, so it emits an <code>input</code> event when something is (de-)selected, and it has a <code>value</code>. It has keyboard navigation with <code>Up</code>, <code>Down</code>, <code>Home</code>, <code>End</code>. It is possible to multi select via keyboard with <code>Shift+Up</code> and <code>Shift+Down</code>. Selective multi select is possible by <code>Ctrl+Click</code> or <code>Shift+Click</code>. Also multi select by dragging is supported. </p></div></div>',1),I={class:"grid-container"},w={class:"grid-item-6"},V={class:"grid-item-6"},B=e("br",null,null,-1),k={class:"grid-container"},z={class:"grid-item-6"},C={class:"grid-item-6"},_=e("div",{class:"grid-container"},[e("div",{class:"grid-item-12"},[e("p",null," The MulitselectListBox can display a bottom element (visually different but funcionally equivalent to an element lying below all other elements). The total size of the box does not depend on the bottom element (i.e. less elements are shown instead). ")])],-1),N={class:"grid-container"},K={class:"grid-item-6"},L={class:"grid-item-6"},D=e("br",null,null,-1),T={class:"grid-container"},A={class:"grid-item-6"},O={class:"grid-item-6"},E={class:"grid-container"},M={class:"grid-item-12"};function R(H,n,$,U,t,u){const l=c("MultiselectListBox",!0),d=c("CodeExample");return f(),b("div",null,[e("section",null,[S,e("div",I,[e("div",w,[s(l,{modelValue:t.selected,"onUpdate:modelValue":n[0]||(n[0]=i=>t.selected=i),size:4,"aria-label":"Select stuff here!","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}]},null,8,["modelValue"])]),e("div",V," selected ids: "+o(t.selected),1)]),B,e("div",k,[e("div",z,[s(l,{modelValue:t.disabledSelected,"onUpdate:modelValue":n[1]||(n[1]=i=>t.disabledSelected=i),size:4,"aria-label":"Disabled...","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}],disabled:""},null,8,["modelValue"])]),e("div",C," selected ids: "+o(t.disabledSelected),1)]),_,e("div",N,[e("div",K,[s(l,{modelValue:t.selected2,"onUpdate:modelValue":n[2]||(n[2]=i=>t.selected2=i),size:4,"aria-label":"Select stuff here!","with-bottom-value":"","bottom-value":{id:t.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}]},null,8,["modelValue","bottom-value"])]),e("div",L," selected ids: "+o(t.selected2),1)]),D,e("div",T,[e("div",A,[s(l,{modelValue:t.disabledSelected2,"onUpdate:modelValue":n[3]||(n[3]=i=>t.disabledSelected2=i),size:4,"aria-label":"Disabled...","with-bottom-value":"","bottom-value":{id:t.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}],disabled:""},null,8,["modelValue","bottom-value"])]),e("div",O," selected ids: "+o(t.disabledSelected2),1)])]),e("section",null,[e("div",E,[e("div",M,[s(d,{summary:"Show usage example"},{default:a(()=>[r(o(t.codeExample),1)]),_:1}),s(d,{summary:"Show MultiselectListBox.vue source code"},{default:a(()=>[r(o(u.code),1)]),_:1})])])])])}const W=x(y,[["render",R]]);export{W as default};
