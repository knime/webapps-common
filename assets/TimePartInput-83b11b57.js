import{C as c}from"./CodeExample-fa9f6db7.js";import{T as v}from"./TimePartInput-055aa946.js";import{L as f}from"./Label-cc027baa.js";import{_ as g,r as p,o as b,c as w,b as n,d as t,w as o,t as l,e as a,p as V,f as x}from"./index-824ead33.js";import"./arrow-dropdown-51e9fe76.js";const y=`<script>
...
`;const _=`<Label text="Hours">
  <TimePartInput
    ...
    @bounds="hoursBound"
  />
</Label>`,I={components:{TimePartInput:v,CodeExample:c,Label:f},data(){return{codeExample:_,hours:18,minutes:53,seconds:22,milliseconds:320}},computed:{code(){return y}},methods:{hoursBound(){this.hours=0},minutesBound(){this.minutes=0},secondsBound(){this.seconds=0},millisecondsBound(){this.milliseconds=0}}},k=m=>(V("data-v-3f7a2928"),m=m(),x(),m),N=k(()=>n("div",{class:"grid-container"},[n("div",{class:"grid-item-12"},[n("p",null,[a(" A number input field similar to the NumberInput component but for time units like hours, minutes, seconds and milliseconds. It acts as a form element, so it emits "),n("code",null,"input"),a(" events and it has a "),n("code",null,"value"),a(". It also has "),n("code",null,"min"),a(" & "),n("code",null,"max"),a(" property to set bounds and a "),n("code",null,"bounds"),a(" event to determine what should happen if a bound is reached. ")])])],-1)),E={class:"grid-container"},T={class:"grid-item-6 inputs"},B={class:"grid-item-4"},S={class:"grid-container"},A={class:"grid-item-12"};function D(m,i,L,C,e,r){const u=p("TimePartInput",!0),d=p("Label"),h=p("CodeExample");return b(),w("div",null,[n("section",null,[N,n("div",E,[n("div",T,[t(d,{text:"Hours",large:""},{default:o(()=>[t(u,{modelValue:e.hours,"onUpdate:modelValue":i[0]||(i[0]=s=>e.hours=s),type:"integer",min:0,max:23,"min-digits":2,onBounds:r.hoursBound},null,8,["modelValue","onBounds"])]),_:1}),t(d,{text:"Minutes",large:""},{default:o(()=>[t(u,{modelValue:e.minutes,"onUpdate:modelValue":i[1]||(i[1]=s=>e.minutes=s),type:"integer",min:0,max:59,"min-digits":2,onBounds:r.minutesBound},null,8,["modelValue","onBounds"])]),_:1}),t(d,{text:"Seconds",large:""},{default:o(()=>[t(u,{modelValue:e.seconds,"onUpdate:modelValue":i[2]||(i[2]=s=>e.seconds=s),type:"integer",min:0,max:59,"min-digits":2,onBounds:r.secondsBound},null,8,["modelValue","onBounds"])]),_:1}),t(d,{text:"Milliseconds",large:""},{default:o(()=>[t(u,{modelValue:e.milliseconds,"onUpdate:modelValue":i[3]||(i[3]=s=>e.milliseconds=s),type:"integer",min:0,max:999,"min-digits":3,onBounds:r.millisecondsBound},null,8,["modelValue","onBounds"])]),_:1}),t(d,{text:"Disabled"},{default:o(()=>[t(u,{modelValue:e.milliseconds,"onUpdate:modelValue":i[4]||(i[4]=s=>e.milliseconds=s),disabled:"",type:"integer","min-digits":3},null,8,["modelValue"])]),_:1})]),n("div",B," Time: "+l(e.hours)+"h : "+l(e.minutes)+"m : "+l(e.seconds)+"s : "+l(e.milliseconds)+"ms ",1)])]),n("section",null,[n("div",S,[n("div",A,[t(h,{summary:"Show usage example"},{default:o(()=>[a(l(e.codeExample),1)]),_:1}),t(h,{summary:"Show TimeInputPart.vue source code"},{default:o(()=>[a(l(r.code),1)]),_:1})])])])])}const R=g(I,[["render",D],["__scopeId","data-v-3f7a2928"]]);export{R as default};
