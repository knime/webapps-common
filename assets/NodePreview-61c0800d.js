...
`;const h="data:image/png;base64,",Eo=`<NodePreview
  ...
  icon="${h}"
/>`,To={components:{NodePreview:Io,CodeExample:M},data(){return{codeExample:Eo,nodePreview:{hasDynPorts:!0,isComponent:!1,type:"Learner",inPorts:[{type:"table"}],outPorts:[{type:"other",color:"#1eb9dc"},{type:"table",optional:!0}],icon:h},componentPreview:{hasDynPorts:!1,isComponent:!0,type:"Sink",inPorts:[{type:"table"}],outPorts:[{type:"other",color:"#1eb9dc"},{type:"table"},{type:"table",optional:!0}],icon:h}}},computed:{sourceCode(){return Mo}}},Do=o=>(Q("data-v-09fcf78b"),o=o(),q(),o),Ho=Do(()=>t("div",{class:"grid-container"},[t("div",{class:"grid-item-12"},[t("p",null,[g(" A component that draws a Node (left, with dynamic ports) or a Component (right)."),t("br"),g(" This Component only draws regular nodes/components, no Metanodes, no Unknown nor Missing Nodes. ")])])],-1)),Fo={class:"grid-container"},Go={class:"grid-item-12 demo-items"},Ro={class:"grid-container"},$o={class:"grid-item-12"};function Uo(o,s,e,f,r,n){const l=m("NodePreview",!0),d=m("CodeExample");return a(),i("div",null,[t("section",null,[Ho,t("div",Fo,[t("div",Go,[t("div",null,[u(l,b(w(r.nodePreview)),null,16)]),t("div",null,[u(l,b(w(r.componentPreview)),null,16)])])])]),t("section",null,[t("div",Ro,[t("div",$o,[u(d,{summary:"Show usage example"},{default:k(()=>[g(C(r.codeExample),1)]),_:1}),u(d,{summary:"Show NodePreview.vue source code"},{default:k(()=>[g(C(n.sourceCode),1)]),_:1})])])])])}const qo=P(To,[["render",Uo],["__scopeId","data-v-09fcf78b"]]);export{qo as default};
