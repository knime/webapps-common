import{C as y}from"./CodeExample-e8f79cfa.js";import{_}from"./MenuItems.vue_vue_type_style_index_0_lang-e2c5e95c.js";import{S as u,H as b}from"./star-97e9e22b.js";import{o as x,c as g,b as e,m as i,_ as C,r as f,d as m,t as l,w,e as c,p as M,f as S}from"./index-82fc700f.js";import{L as h,H as E}from"./heart-9e884f26.js";import"./Checkbox-3617bb61.js";import"./arrow-next-76e9bea9.js";const T={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},A=e("path",{d:"M23.3 22.7c3.6-.4 6.4-3.5 6.4-7.2 0-4-3.3-7.3-7.3-7.3h-.5c-1.1-3.2-4.1-5.5-7.7-5.5C9.7 2.8 6 6.4 6 10.9c0 .4 0 .8.1 1.2-2.2.7-3.7 2.8-3.7 5.2 0 3 2.4 5.5 5.5 5.5h.9m7.2-6v12.4m4-4-4 4-4-4"},null,-1),H=[A];function W(n,o){return x(),g("svg",T,H)}const N={render:W},B=`<script setup lang="ts">
/**
...
`,s=[{href:"http://apple.com",text:"Apples",icon:i(b),hotkeyText:"Ctrl + 1"},{href:"https://en.wikipedia.org/wiki/Orange_(colour)",text:"Oranges",icon:i(u),hotkeyText:"Ctrl + 2"},{href:"about:blank",text:"Disabled Item",disabled:!0,icon:i(u),hotkeyText:"Ctrl + 3"},{to:"/testing-nuxt-link",text:"Ananas",icon:i(E)},{href:"https://www.urbandictionary.com/define.php?term=go%20bananas",text:"Bananas",icon:i(h)},{text:"Item without href/to",icon:i(b)},{href:"https://www.knime.com/images/knime-logo.svg",text:"Item with download attribute",download:!0,icon:i(N)},{text:"Item with checkbox",checkbox:{checked:!0,setBoolean:n=>window.alert(`You clicked on a checkbox item calling its callback method with the value: ${n}`)}}],D={components:{MenuItems:_,CodeExample:y},data(){return{menuItemsData:s,codeExampleStandalone:K,code:B,hoveredItem:null}},computed:{menuItemsWithoutIcons(){return s.map(({icon:n,hotkeyText:o,...a})=>a)},menuItemsWithSeparator(){return s.map((n,o)=>o===2||o===4?{...n,separator:!0}:n)},menuItemsWithChildren(){const n={text:"Sub menu",icon:i(h),children:[{text:"I am part of a submenu",href:"https://example.com/woohoo",icon:i(u)},{text:"Another Level",icon:i(h),children:[{text:"Something…",href:"https://example.com/another-thing"},{text:"We need more submenus",href:"https://example.com/woohoo"}]}]},[o,a,p]=s,I={...a,separator:!0,description:"… some long text that explains the action of this item ina way the user can better understand what happens if he click it."};return[{...o,separator:!0},I,p,n]},menuItemsWithSelectedEntries(){return s.map((n,o)=>o===1||o===3?{...n,selected:!0}:n)},menuItemsWithSections(){return[{text:"Round-shaped",sectionHeadline:!0,separator:!0},s[0],s[1],{text:"Different-shaped",sectionHeadline:!0,separator:!0},s[3],s[4]]}},methods:{onItemClick(n,o,a){window.alert(`You clicked on menu ${a} on an item with a value of: ${JSON.stringify(o)}`)},onItemActive(n){this.hoveredItem=n}}};const r=n=>(M("data-v-a62fce51"),n=n(),S(),n),O={class:"grid-container"},L={class:"grid-item-12"},R=r(()=>e("p",null," A component that displays a group of items. Supports keyboard navigation. ",-1)),F={class:"menu-items"},P={class:"menu-item-wrapper"},V=r(()=>e("div",{class:"menu-name"},"Normal",-1)),$={class:"card"},j={class:"menu-item-wrapper"},z=r(()=>e("div",{class:"menu-name"},[c(" With icons, "),e("br"),c("hotkeys and separators ")],-1)),G={class:"card"},Y={class:"menu-item-wrapper"},J=r(()=>e("div",{class:"menu-name"},"With selected entries",-1)),U={class:"card"},q={class:"menu-item-wrapper"},Q=r(()=>e("div",{class:"menu-name"},"With sections",-1)),X={class:"card"},Z={class:"menu-item-wrapper"},ee=r(()=>e("div",{class:"menu-name"},[c(" With keyboard navigation"),e("br"),c(" and scrollable content ")],-1)),ne={class:"card"},te={class:"menu-item-wrapper"},oe=r(()=>e("div",{class:"menu-name"}," With submenu (children) and a long description ",-1)),ie={class:"card"},se={class:"hover-preview"},ae={class:"hover-title"},me={class:"hover-content"};function re(n,o,a,p,I,t){const d=f("MenuItems",!0),v=f("CodeExample");return x(),g("section",null,[e("div",O,[e("div",L,[R,e("div",F,[e("div",P,[V,e("div",$,[m(d,{id:"NORMAL",items:t.menuItemsWithoutIcons,"menu-aria-label":"Menu items without icons",onItemClick:t.onItemClick,onItemHovered:t.onItemActive},null,8,["items","onItemClick","onItemHovered"])])]),e("div",j,[z,e("div",G,[m(d,{id:"WITH_SEPARATORS",items:t.menuItemsWithSeparator,"menu-aria-label":"Menu items with separators",onItemClick:t.onItemClick,onItemHovered:t.onItemActive},null,8,["items","onItemClick","onItemHovered"])])]),e("div",Y,[J,e("div",U,[m(d,{id:"WITH_SELECTED_ENTRIES",items:t.menuItemsWithSelectedEntries,"menu-aria-label":"Menu items with selected entries",onItemClick:t.onItemClick,onItemHovered:t.onItemActive},null,8,["items","onItemClick","onItemHovered"])])]),e("div",q,[Q,e("div",X,[m(d,{id:"WITH_SECTIONS",items:t.menuItemsWithSections,"menu-aria-label":"Menu items with sections",onItemClick:t.onItemClick,onItemHovered:t.onItemActive},null,8,["items","onItemClick","onItemHovered"])])]),e("div",Z,[ee,e("button",{onKeydown:o[0]||(o[0]=k=>n.$refs.menuItemsWithNavigation.onKeydown(k))}," Focus me to start navigating ",32),e("div",ne,[m(d,{ref:"menuItemsWithNavigation",items:n.menuItemsData,class:"menu-items-with-navigation","menu-aria-label":"Menu items with sections",onItemClick:t.onItemClick,onItemHovered:t.onItemActive},null,8,["items","onItemClick","onItemHovered"])])]),e("div",te,[oe,e("div",ie,[m(d,{id:"WITH_CHILDREN",items:t.menuItemsWithChildren,"menu-aria-label":"Menu items with children",onItemClick:t.onItemClick,onItemHovered:t.onItemActive},null,8,["items","onItemClick","onItemHovered"])])])]),e("div",se,[e("div",ae,l(n.hoveredItem?"Hovered value is:":"Hover over an item"),1),e("pre",me,l(n.hoveredItem),1)]),m(v,{summary:"Show usage example"},{default:w(()=>[c(l(n.codeExampleStandalone),1)]),_:1}),m(v,{summary:"Show MenuItems.vue source code"},{default:w(()=>[c(l(n.code),1)]),_:1})])])])}const ve=C(D,[["render",re],["__scopeId","data-v-a62fce51"]]);export{ve as default};
