...
/>`,Cn={components:{ComboBox:yn,CodeExample:G},data(){return{codeExample:Sn,selected:[[],[],[]],selectedValues:[],values:[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"lorem",text:"Lorem"},{id:"ipsum",text:"Ipsum"},{id:"dolor",text:"dolor"}]}},computed:{code(){return On}}},En=i("div",{class:"grid-container"},[i("div",{class:"grid-item-12"},[i("p",null,[I(" A combobox component. It emits an "),i("code",null,"update"),I(" event when an option is (de-)selected and has a list of selected "),i("code",null,"values"),I(". ")])])],-1),Vn={class:"grid-container"},An=i("div",{class:"grid-item-3"},"default",-1),_n={class:"grid-item-6"},Rn={class:"grid-item-3"},Mn=i("br",null,null,-1),Bn={class:"grid-container"},Fn=i("div",{class:"grid-item-3"},"max visible options: 3",-1),kn={class:"grid-item-6"},zn={class:"grid-item-3"},Dn=i("br",null,null,-1),Tn={class:"grid-container"},Ln=i("div",{class:"grid-item-3"},"allow new values",-1),$n={class:"grid-item-6"},Nn={class:"grid-item-3"},Un=i("br",null,null,-1),Pn={class:"grid-container"},Wn=i("div",{class:"grid-item-3"},"close dropdown on selection",-1),jn={class:"grid-item-6"},qn={class:"grid-item-3"},Hn={class:"grid-container"},Zn={class:"grid-item-12"},Gn={class:"grid-container"},Kn={class:"grid-item-12"};function Yn(e,n,t,u,s,r){const d=g("ComboBox",!0),a=g("CodeExample");return w(),C("div",null,[i("section",null,[En,i("div",Vn,[An,i("div",_n,[c(d,{"possible-values":s.values,"initial-selected-ids":s.selected[0],"onUpdate:selectedIds":n[0]||(n[0]=o=>s.selected[0]=o),onChange:n[1]||(n[1]=o=>s.selectedValues=o)},null,8,["possible-values","initial-selected-ids"])]),i("div",Rn,"selected-ids: "+h(s.selected[0]),1)]),Mn,i("div",Bn,[Fn,i("div",kn,[c(d,{"possible-values":s.values,"initial-selected-ids":s.selected[1],"size-visible-options":3,"onUpdate:selectedIds":n[2]||(n[2]=o=>s.selected[1]=o),onChange:n[3]||(n[3]=o=>s.selectedValues=o)},null,8,["possible-values","initial-selected-ids"])]),i("div",zn,"selected-ids: "+h(s.selected[1]),1)]),Dn,i("div",Tn,[Ln,i("div",$n,[c(d,{"possible-values":s.values,"initial-selected-ids":s.selected[0],"allow-new-values":"","onUpdate:selectedIds":n[4]||(n[4]=o=>s.selected[0]=o),onChange:n[5]||(n[5]=o=>s.selectedValues=o)},null,8,["possible-values","initial-selected-ids"])]),i("div",Nn,"selected-ids: "+h(s.selected[0]),1)]),Un,i("div",Pn,[Wn,i("div",jn,[c(d,{"possible-values":s.values,"initial-selected-ids":s.selected[2],"close-dropdown-on-selection":"","onUpdate:selectedIds":n[6]||(n[6]=o=>s.selected[2]=o),onChange:n[7]||(n[7]=o=>s.selectedValues=o)},null,8,["possible-values","initial-selected-ids"])]),i("div",qn,"selected-ids: "+h(s.selected[2]),1)]),i("div",Hn,[i("div",Zn,"Selected Values: "+h(s.selectedValues),1)])]),i("section",null,[i("div",Gn,[i("div",Kn,[c(a,{summary:"Show usage example"},{default:v(()=>[I(h(s.codeExample),1)]),_:1}),c(a,{summary:"Show ComboBox.vue source code"},{default:v(()=>[I(h(r.code),1)]),_:1})])])])])}const ss=F(Cn,[["render",Yn]]);export{ss as default};
