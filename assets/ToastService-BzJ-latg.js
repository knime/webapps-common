import{C as l}from"./CodeExample-Bkh11Y65.js";import{B as n}from"./Button-KKGCtY_J.js";import{u as x,aw as j,o as I,c as A,b as o,t as p,a1 as t,d as s,w as a,e as i,a as u,ax as $,p as q,f as E,_ as R}from"./index-73IBHKmt.js";const m=d=>(q("data-v-9efb0a87"),d=d(),E(),d),V=u('<section data-v-9efb0a87><div class="grid-container" data-v-9efb0a87><div class="grid-item-12" data-v-9efb0a87><p data-v-9efb0a87> This framework provides a simple and versatile API that enables the use of toast-style notifications. It&#39;s Vuex/Pinia-agnostic, Nuxt 3-ready, and supports both Composition API and Options API approaches. Multiple toast services can be used in the same project. A toast service is a combination of a reactive array of toast objects and methods for mutating the array. </p><p data-v-9efb0a87> You are able to import all of the public-facing components of the framework, including types, from <code data-v-9efb0a87>webapps-common/ui/services/toast</code>. </p><p data-v-9efb0a87> To use the toast service in your project, follow these steps (see the example section below for detailed coverage of various use-cases): </p><ol data-v-9efb0a87><li data-v-9efb0a87> Import and instantiate the <code data-v-9efb0a87>ToastServiceProvider</code> class in the <code data-v-9efb0a87>setup</code> section of the root component of your project (e.g. <code data-v-9efb0a87>App.vue</code>). The class instance will create a new toast service. </li><li data-v-9efb0a87> In the same <code data-v-9efb0a87>setup</code> section, provide the toast service to the downstream components of the application by calling the <code data-v-9efb0a87>toastServiceProvider.useToastService()</code> method. </li><li data-v-9efb0a87> Either in the root component, or in a downstream component, import the <code data-v-9efb0a87>ToastStack</code> component and place it in the <code data-v-9efb0a87>template</code> section. Currently, the stack is bound to the bottom left corner of its parent and the position is not adjustable. </li><li data-v-9efb0a87> Whenever a component needs to e.g. display a toast notification, import the <code data-v-9efb0a87>useToasts</code> composable, which returns the toast service object containing the <code data-v-9efb0a87>show</code> function. Make sure to call the composable in the <code data-v-9efb0a87>setup</code> section of the component. </li><li data-v-9efb0a87> Use the retrieved service properties, e.g. <code data-v-9efb0a87>show</code>, anywhere in the component to modify the toast stack. </li></ol></div></div></section>',1),B={class:"grid-container"},N={class:"grid-item-12"},O=m(()=>o("h4",null,"Interactive demo",-1)),U=m(()=>o("p",null," This application has a toast service integrated. You can see it in action by spawning toast notifications using the buttons below. ",-1)),D=m(()=>o("h5",null,"Basic examples",-1)),F={class:"grid-container"},M={class:"wrapper"},W=m(()=>o("h5",null,"Additional features",-1)),Y={class:"grid-container"},H={class:"wrapper"},X=m(()=>o("h5",null,"Stack control",-1)),z={class:"grid-container"},G={class:"wrapper"},J=u('<section data-v-9efb0a87><div class="grid-container" data-v-9efb0a87><div class="grid-item-12" data-v-9efb0a87><h4 data-v-9efb0a87>Usage guidelines</h4><p data-v-9efb0a87> To make the UX consistent, please try to adhere to the following usage guidelines: </p><ul data-v-9efb0a87><li data-v-9efb0a87> Omit periods from <code data-v-9efb0a87>headlines</code>, e.g. &quot;Action performed.&quot; -&gt; &quot;Action performed&quot;. </li><li data-v-9efb0a87>Ensure <code data-v-9efb0a87>messages</code> end with a period.</li><li data-v-9efb0a87> Use the <code data-v-9efb0a87>type</code> of the toast to convey success/error information, instead of explicitly stating it in the <code data-v-9efb0a87>headline</code>, e.g. &quot;Successfully created space&quot; -&gt; &quot;Space created&quot;. </li><li data-v-9efb0a87> Refrain from using &quot;was&quot; when referring to completed actions, e.g. &quot;Space was created&quot; -&gt; &quot;Space created&quot;. </li><li data-v-9efb0a87> Toasts with important information should be persistent, i.e. <code data-v-9efb0a87>autoRemove</code> set to <code data-v-9efb0a87>false</code>. </li></ul></div></div></section>',1),K={class:"grid-container"},L={class:"grid-item-12"},Q=m(()=>o("h4",null,"Usage examples",-1)),Z="",tt="",et=`
