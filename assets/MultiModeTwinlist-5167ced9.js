import{C as x}from"./CodeExample-d968c2fe.js";import{L as P}from"./Label-02df4ebc.js";import{_ as I,a2 as M,r as d,o as u,c as w,j as y,w as h,d as r,l as v,v as _,n as k,b as l,e as b,t as m}from"./index-81632345.js";import{C as L}from"./Checkboxes-a378498c.js";import{V as C}from"./ValueSwitch-bd0d564b.js";import{T as U,f as T}from"./Twinlist-999977a1.js";import{F as B}from"./filter-1380be2a.js";import"./Checkbox-b8a6c331.js";import"./BaseRadioButtons-fd348035.js";import"./MultiselectListBox-5357798c.js";import"./StyledListItem-7a7efec2.js";import"./arrow-next-b576a578.js";const F={manual:"Manual",wildcard:"Wildcard",regex:"Regex",type:"Type"},A={components:{Label:P,FilterIcon:B,SearchInput:M,Checkboxes:L,ValueSwitch:C,Twinlist:U},props:{initialMode:{type:String,required:!1,default:"manual"},initialManuallySelected:{type:Array,default:()=>[]},initialIncludeUnknownValues:{type:Boolean,default:!1},initialPattern:{type:String,default:""},initialCaseSensitivePattern:{default:!1,type:Boolean},initialInversePattern:{default:!1,type:Boolean},withTypes:{type:Boolean,default:!0},initialSelectedTypes:{type:Array,default:()=>[]},showMode:{default:!1,type:Boolean},showUnknownValues:{default:!1,type:Boolean},showSearch:{default:!0,type:Boolean},disabled:{default:!1,type:Boolean},withModeLabel:{default:!1,type:Boolean},modeLabel:{type:String,required:!1,default:"Selection mode"},withPatternLabel:{default:!1,type:Boolean},patternLabel:{type:String,required:!1,default:"Pattern"},withTypesLabel:{default:!1,type:Boolean},typesLabel:{type:String,required:!1,default:"Selected types"},possibleValues:{type:Array,default:()=>[],validator(e){return Array.isArray(e)?e.every(n=>n.hasOwnProperty("id")&&n.hasOwnProperty("text")):!1}},additionalPossibleTypes:{type:Array,default:()=>[],validator(e){return Array.isArray(e)?e.every(n=>n.hasOwnProperty("id")&&n.hasOwnProperty("text")):!1}}},emits:["input","includeUnknownValuesInput","patternInput","typesInput","modeInput","caseSensitivePatternInput","inversePatternInput"],data(){return{chosenValues:this.initialManuallySelected,chosenPattern:this.initialPattern,chosenTypes:this.initialSelectedTypes,invalidPossibleValueIds:new Set,mode:this.initialMode,caseSensitivePattern:this.initialCaseSensitivePattern,inversePattern:this.initialInversePattern,includeUnknownValues:this.initialIncludeUnknownValues}},computed:{possibleValueMap(){return Object.assign({},...this.possibleValues.map(e=>({[e.id]:e})))},possibleValueIds(){return this.possibleValues.map(({id:e})=>e)},possibleTypes(){const e=this.possibleValues.map(t=>t.type).filter(t=>t),n=e.map(t=>t.id);return[...this.additionalPossibleTypes.filter(t=>t&&!n.includes(t.id)),...e].filter(t=>t&&t.id!=="").filter((t,s,c)=>s===c.findIndex(o=>o.id===t.id&&o.text===t.text))},matchingValueIds(){return this.possibleValues.filter(e=>this.itemMatches(e)).map(e=>e.id)},selectedValues(){return this.mode==="manual"?this.chosenValues:this.matchingValueIds},deselectedValues(){return this.possibleValueIds.filter(e=>!this.selectedValues.includes(e))},selectionDisabled(){return this.disabled||this.mode!=="manual"},normalizedSearchTerm(){return this.mode==="manual"?null:T[this.mode].normalize(this.mode==="type"?this.chosenTypes:this.chosenPattern,this.caseSensitivePattern)},possibleModes(){let e=Object.entries(F).map(([n,i])=>({id:n,text:i}));return this.withTypes||(e=e.filter(n=>n.id!=="type")),e},possibleModeIds(){return this.possibleModes.map(e=>e.id)},unknownValuesVisible(){return this.showUnknownValues&&this.mode==="manual"}},watch:{selectedValues:{immediate:!0,handler(e,n){if(!n||e.length!==n.length||n.some((i,p)=>i!==e[p])){const i=this.mode==="manual",p={selected:this.selectedValues,isManual:i};i&&(p.deselected=this.deselectedValues),this.$emit("input",p)}}},includeUnknownValues(e){this.$emit("includeUnknownValuesInput",e)}},methods:{onManualInput(e){this.mode==="manual"&&(this.chosenValues=e)},onPatternInput(e){this.chosenPattern=e,this.$emit("patternInput",e)},onTypeInput(e){this.chosenTypes=e,this.$emit("typesInput",e,this.possibleTypes)},onModeChange(e){this.possibleModeIds.indexOf(e)!==-1&&(this.mode=e,this.$emit("modeInput",e))},onToggleCaseSensitivePattern(e){this.caseSensitivePattern=e,this.$emit("caseSensitivePatternInput",e)},onToggleInvsersePattern(e){this.inversePattern=e,this.$emit("inversePatternInput",e)},onUnkownColumnsInput(e){this.includeUnknownValues=e},validate(){return this.$refs.twinlist.validate()},hasSelection(){return this.selectedValues.length>0},itemMatches(e){const n=T[this.mode],i=e.type?e.type.id:void 0;return n.test(this.mode==="type"?i:e.text,this.normalizedSearchTerm,this.caseSensitivePattern,this.inversePattern)}}};function O(e,n,i,p,t,s){const c=d("ValueSwitch"),o=d("Label"),a=d("FilterIcon"),V=d("SearchInput"),S=d("Checkboxes"),g=d("Twinlist");return u(),w("div",{class:k(["multi-mode-twinlist",{disabled:i.disabled}])},[i.showMode?(u(),y(o,{key:0,active:i.withModeLabel,text:i.modeLabel,class:"label",compact:""},{default:h(({labelForId:f})=>[r(c,{id:f,ref:"mode","model-value":t.mode,disabled:i.disabled,"possible-values":s.possibleModes,"onUpdate:modelValue":s.onModeChange},null,8,["id","model-value","disabled","possible-values","onUpdate:modelValue"])]),_:1},8,["active","text"])):v("",!0),t.mode==="regex"||t.mode==="wildcard"?(u(),y(o,{key:1,active:i.withPatternLabel,text:i.patternLabel,class:"label",compact:""},{default:h(({labelForId:f})=>[r(V,{id:f,ref:"search","model-value":t.chosenPattern,label:i.patternLabel,"initial-case-sensitive-search":i.initialCaseSensitivePattern,"initial-inverse-search":i.initialInversePattern,placeholder:"Pattern","show-case-sensitive-search-button":"","show-inverse-search-button":"",disabled:i.disabled,"onUpdate:modelValue":s.onPatternInput,onToggleCaseSensitiveSearch:s.onToggleCaseSensitivePattern,onToggleInverseSearch:s.onToggleInvsersePattern},{icon:h(()=>[r(a)]),_:2},1032,["id","model-value","label","initial-case-sensitive-search","initial-inverse-search","disabled","onUpdate:modelValue","onToggleCaseSensitiveSearch","onToggleInverseSearch"])]),_:1},8,["active","text"])):v("",!0),t.mode==="type"&&s.possibleTypes.length>0?(u(),y(o,{key:2,active:i.withTypesLabel,text:i.typesLabel,class:"label",compact:""},{default:h(()=>[r(S,{"model-value":t.chosenTypes,"possible-values":s.possibleTypes,disabled:i.disabled,"onUpdate:modelValue":s.onTypeInput},null,8,["model-value","possible-values","disabled","onUpdate:modelValue"])]),_:1},8,["active","text"])):v("",!0),r(g,_(e.$attrs,{ref:"twinlist",disabled:s.selectionDisabled,"show-search":t.mode==="manual"&&i.showSearch,"model-value":s.selectedValues,"possible-values":i.possibleValues,"show-unknown-values":s.unknownValuesVisible,"initial-include-unknown-values":t.includeUnknownValues,"onUpdate:modelValue":s.onManualInput,onIncludeUnknownValuesInput:s.onUnkownColumnsInput}),null,16,["disabled","show-search","model-value","possible-values","show-unknown-values","initial-include-unknown-values","onUpdate:modelValue","onIncludeUnknownValuesInput"])],2)}const z=I(A,[["render",O],["__scopeId","data-v-9c89fe55"]]),j=`<script>
