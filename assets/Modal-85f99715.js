...
`,Ft={components:{Modal:wt,PlayIcon:Ae,Button:De,CodeExample:Ie},data(){return{codeExample:Ct,code:kt,baseModalCode:Tt,modalActive:!1,modalStyleType:"info"}}},St={class:"grid-container"},Et={class:"grid-item-12"},xt=Oe('<h2 data-v-113e15d4>Modal</h2><p data-v-113e15d4> Offers multiple optional slots for content to show inside a <a href="https://en.wikipedia.org/wiki/Modal_window" data-v-113e15d4>modal dialog</a>. Multiple styles are supported by the <code data-v-113e15d4>styleType</code> prop. See source code for possible values. The modal emits a <code data-v-113e15d4>cancel</code> event which is triggered by clicking the overlay, the ESC key or the close button. Also on tab, the focus is trapped inside the modal. </p><p data-v-113e15d4> For the rare cases where more design freedom is needed, please use the <code data-v-113e15d4>BaseModal</code> component which comes without a header and styled slots. But please be aware of <a href="https://www.w3.org/TR/wai-aria-practices-1.1/examples/dialog-modal/dialog.html" data-v-113e15d4>W3C best practices for modal dialogs</a>. </p>',3),Nt={class:"grid-container"},_t={class:"grid-item-12"};function Bt(a,e,t,n,i,s){const o=S("Button"),c=S("PlayIcon"),d=S("Modal",!0),f=S("CodeExample");return N(),L("div",null,[k("section",null,[k("div",St,[k("div",Et,[xt,T(o,{primary:"",onClick:e[0]||(e[0]=b=>i.modalActive=!0)},{default:g(()=>[x(" Trigger modal ")]),_:1}),T(d,{active:i.modalActive,title:"Modal title",class:"modal","style-type":i.modalStyleType,onCancel:e[2]||(e[2]=b=>i.modalActive=!1)},{icon:g(()=>[T(c)]),notice:g(()=>[x("This is the notice slot.")]),confirmation:g(()=>[x("And this is content in the confirmation slot.")]),controls:g(()=>[T(o,{primary:"",onClick:e[1]||(e[1]=b=>i.modalActive=!1)},{default:g(()=>[x(" Accept and close ")]),_:1})]),_:1},8,["active","style-type"])])])]),k("section",null,[k("div",Nt,[k("div",_t,[T(f,{summary:"Show usage example"},{default:g(()=>[x(R(i.codeExample),1)]),_:1}),T(f,{summary:"Show Modal.vue source code"},{default:g(()=>[x(R(i.code),1)]),_:1}),T(f,{summary:"Show BaseModal.vue source code"},{default:g(()=>[x(R(i.baseModalCode),1)]),_:1})])])])])}const Mt=Y(Ft,[["render",Bt],["__scopeId","data-v-113e15d4"]]);export{Mt as default};
