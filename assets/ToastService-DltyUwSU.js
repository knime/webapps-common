...
${e.stacktrace}
`),s}),x=()=>{y(I.value).catch(n=>{consola.error("Failed to copy to clipboard",{error:n})})},j=()=>{b.value=!0,w("showMore")};return(n,s)=>(d(),l("div",Y,[a("div",K,m(e.title),1),b.value?f("",!0):(d(),l("button",{key:0,class:"show-more",onClick:j}," Show details ")),b.value?(d(),l("div",X,[e.details?.length?(d(),l("div",G,[s[0]||(s[0]=a("strong",null,"Details: ",-1)),e.details.length==1?(d(),l(C,{key:0},[i(m(e.details[0]),1)],64)):(d(),l("ul",J,[(d(!0),l(C,null,N(n.details,(S,k)=>(d(),l("li",{key:k},m(S),1))),128))]))])):f("",!0),n.status!==void 0?(d(),l("div",Q,[s[1]||(s[1]=a("strong",null,"Status: ",-1)),i(m(n.status),1)])):f("",!0),n.date?(d(),l("div",Z,[s[2]||(s[2]=a("strong",null,"Date: ",-1)),i(m(T.value),1)])):f("",!0),n.requestId?(d(),l("div",tt,[s[3]||(s[3]=a("strong",null,"Request id: ",-1)),i(m(n.requestId),1)])):f("",!0),n.errorId?(d(),l("div",et,[s[4]||(s[4]=a("strong",null,"Error id: ",-1)),i(m(n.errorId),1)])):f("",!0),n.stacktrace?(d(),l("div",ot,s[5]||(s[5]=[a("strong",null,"Stacktrace: ",-1),i("Part of clipboard text ",-1)]))):f("",!0),n.canCopyToClipboard?(d(),l("div",st,[r(o(v),{onClick:x},{default:c(()=>[o($)?(d(),l(C,{key:0},[r(o(U),{class:"copy-icon"}),s[6]||(s[6]=i("Error was copied ",-1))],64)):(d(),l(C,{key:1},[r(o(W),{class:"copy-icon"}),s[7]||(s[7]=i("Copy error to clipboard ",-1))],64))]),_:1})])):f("",!0)])):f("",!0)]))}}),it=D(at,[["__scopeId","data-v-0158aea8"]]);class R extends Error{data;constructor(u){super(u.title),this.data=u}}const rt=({headline:p,rfcError:u,canCopyToClipboard:e=!0})=>{const{data:w}=u,y=O(it,{headline:p,...w,canCopyToClipboard:e});return{type:"error",headline:p,component:y,autoRemove:!1}},nt=p=>{if(!p.response)return p;const u=p.response.headers.get("date")?new Date(p.response.headers.get("date")):void 0,e={title:p.data.title,details:p.data.details,status:p.statusCode,date:u,requestId:p.response.headers.get("x-request-id")??void 0,errorId:p.response.headers.get("x-error-id")??void 0};return new R(e)},A={toToast:rt,tryParse:nt,RFCError:R},ct={class:"grid-container"},lt={class:"grid-item-12"},dt={class:"grid-container"},pt={class:"wrapper"},mt={class:"grid-container"},ut={class:"wrapper"},vt={class:"grid-container"},ht={class:"wrapper"},ft={class:"grid-container"},gt={class:"grid-item-12"},wt="",yt="",bt=`
