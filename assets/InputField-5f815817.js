import{C as y}from"./CodeExample-765fa6a6.js";import{o as v,c as f,b as n,_ as I,I as _,s as w,Z as k,O as b,r as d,d as e,w as a,t as p,e as u,p as V,f as F}from"./index-79858142.js";const C={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},S=n("path",{d:"M2.5 7h27v18h-27zm22.96 3.224L16 17.771 2.5 7"},null,-1),$=[S];function B(l,t){return v(),f("svg",C,$)}const R={render:B},z=`<script>
export default {
  props: {
    modelValue: {
      default: "",
...
</InputField>`,L={components:{InputField:_,FunctionButton:w,CircleCheckIcon:k,CloseIcon:b,MailIcon:R,CodeExample:y},data(){return{codeExample:M,inputValue:"demo text",inputValue2:"",inputValue3:""}},computed:{code(){return z}},methods:{alert(l){window.alert(l),this.$refs.buttonDemo.focus()}}},E=l=>(V("data-v-9f6143aa"),l=l(),F(),l),T=E(()=>n("div",{class:"grid-container"},[n("div",{class:"grid-item-12"},[n("p",null,[u(" Single line string input with optional icon and validity styling. It acts as a form element, so it emits "),n("code",null,"input"),u(" events and it has a "),n("code",null,"value"),u(". ")])])],-1)),D={class:"grid-container"},O={class:"grid-item-6 inputs"},U={class:"grid-item-6"},q={class:"grid-container"},N={class:"grid-item-12"};function j(l,t,X,Z,o,r){const i=d("InputField",!0),g=d("MailIcon"),c=d("CircleCheckIcon"),h=d("FunctionButton"),x=d("CloseIcon"),m=d("CodeExample");return v(),f("div",null,[n("section",null,[T,n("div",D,[n("div",O,[e(i,{modelValue:o.inputValue,"onUpdate:modelValue":t[0]||(t[0]=s=>o.inputValue=s),type:"text",title:"Insert text"},null,8,["modelValue"]),e(i,{modelValue:o.inputValue2,"onUpdate:modelValue":t[1]||(t[1]=s=>o.inputValue2=s),type:"text",placeholder:"I'm a placeholder"},null,8,["modelValue"]),e(i,{modelValue:o.inputValue3,"onUpdate:modelValue":t[2]||(t[2]=s=>o.inputValue3=s),type:"text",placeholder:"Required field",required:""},null,8,["modelValue"]),e(i,{"model-value":"disabled: no edit here",type:"text",disabled:""}),e(i,{"model-value":"invalid","is-valid":!1,type:"text"}),e(i,{"model-value":"demo with left icon",type:"text"},{icon:a(()=>[e(g)]),_:1}),e(i,{"model-value":"demo with right icon",type:"text"},{iconRight:a(()=>[e(c)]),_:1}),e(i,{ref:"buttonDemo","model-value":"demo with right aligned buttons",type:"text"},{iconRight:a(()=>[e(h,{onClick:t[3]||(t[3]=s=>r.alert("demo"))},{default:a(()=>[e(c)]),_:1}),e(h,{onClick:t[4]||(t[4]=s=>r.alert("demo 2"))},{default:a(()=>[e(x)]),_:1})]),_:1},512)]),n("div",U,"input value: "+p(o.inputValue),1)])]),n("section",null,[n("div",q,[n("div",N,[e(m,{summary:"Show usage example"},{default:a(()=>[u(p(o.codeExample),1)]),_:1}),e(m,{summary:"Show InputField.vue source code"},{default:a(()=>[u(p(r.code),1)]),_:1})])])])])}const H=I(L,[["render",j],["__scopeId","data-v-9f6143aa"]]);export{H as default};
