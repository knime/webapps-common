import{C as g}from"./CodeExample-b0cc209e.js";import{_ as k}from"./MenuItems.vue_vue_type_style_index_0_lang-39d6a689.js";import{H as I,S as u}from"./star-365fbbce.js";import{o as f,c as w,b as e,m as i,_,r as v,d as a,t as l,w as b,e as c,p as y,f as C}from"./index-6d4d99ba.js";import{H as M,L as h}from"./heart-c723ccc0.js";import"./lodash-ac7c693c.js";import"./arrow-next-a2a7e422.js";const S={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},E=e("path",{d:"M23.3 22.7c3.6-.4 6.4-3.5 6.4-7.2 0-4-3.3-7.3-7.3-7.3h-.5c-1.1-3.2-4.1-5.5-7.7-5.5C9.7 2.8 6 6.4 6 10.9c0 .4 0 .8.1 1.2-2.2.7-3.7 2.8-3.7 5.2 0 3 2.4 5.5 5.5 5.5h.9m7.2-6v12.4m4-4-4 4-4-4"},null,-1),T=[E];function A(n,o){return f(),w("svg",S,T)}const H={render:A},W=`<script setup lang="ts">
/**
