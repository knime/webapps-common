import{C as b}from"./CodeExample-DkRoN_fP.js";import{i as B,G as f,T as y,_ as c,r,o as d,l as h,w as n,d as t,B as k,s as v,c as C,b as s,e as l,t as i}from"./index-CttzsSw2.js";import{P as x}from"./plus-small-Bftt0O7X.js";const $=B({name:"PlusButton",components:{Button:f,Tooltip:y,PlusIcon:x},inheritAttrs:!1,props:{title:{type:String,default:null}}});function g(a,p,m,_,u,P){const o=r("PlusIcon"),e=r("Button");return d(),h(v(a.title?"Tooltip":"div"),{text:a.title},{default:n(()=>[t(e,k({class:"plus-button"},a.$attrs),{default:n(()=>[t(o)]),_:1},16)]),_:1},8,["text"])}const w=c($,[["render",g],["__scopeId","data-v-23fb968f"]]),E="",S="",I=`
