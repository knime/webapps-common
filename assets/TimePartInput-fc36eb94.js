import{C as c}from"./CodeExample-7f44cb71.js";import{T as v}from"./TimePartInput-85c3f158.js";import{L as g}from"./Label-2963a6f2.js";import{_ as f,o as b,c as w,b as e,d as t,w as o,t as r,e as s,r as h,p as V,f as x}from"./index-fc2ac7a6.js";import"./arrow-dropdown-433a2191.js";const y=`<script>
...
`;const _=`<Label text="Hours">
  <TimePartInput
    ...
    @bounds="hoursBound"
  />
</Label>`,I={components:{TimePartInput:v,CodeExample:c,Label:g},data(){return{codeExample:_,hours:18,minutes:53,seconds:22,milliseconds:320}},computed:{code(){return y}},methods:{hoursBound(){this.hours=0},minutesBound(){this.minutes=0},secondsBound(){this.seconds=0},millisecondsBound(){this.milliseconds=0}}},k=u=>(V("data-v-16865097"),u=u(),x(),u),N=k(()=>e("div",{class:"grid-container"},[e("div",{class:"grid-item-12"},[e("p",null,[s(" A number input field similar to the NumberInput component but for time units like hours, minutes, seconds and milliseconds. It acts as a form element, so it emits "),e("code",null,"input"),s(" events and it has a "),e("code",null,"value"),s(". It also has "),e("code",null,"min"),s(" & "),e("code",null,"max"),s(" property to set bounds and a "),e("code",null,"bounds"),s(" event to determine what should happen if a bound is reached. ")])])],-1)),E={class:"grid-container"},T={class:"grid-item-6 inputs"},B={class:"grid-item-4"},S={class:"grid-container"},A={class:"grid-item-12"};function D(u,i,L,C,n,l){const d=h("TimePartInput",!0),m=h("Label"),p=h("CodeExample");return b(),w("div",null,[e("section",null,[N,e("div",E,[e("div",T,[t(m,{text:"Hours"},{default:o(()=>[t(d,{modelValue:n.hours,"onUpdate:modelValue":i[0]||(i[0]=a=>n.hours=a),type:"integer",min:0,max:23,"min-digits":2,onBounds:l.hoursBound},null,8,["modelValue","onBounds"])]),_:1}),t(m,{text:"Minutes"},{default:o(()=>[t(d,{modelValue:n.minutes,"onUpdate:modelValue":i[1]||(i[1]=a=>n.minutes=a),type:"integer",min:0,max:59,"min-digits":2,onBounds:l.minutesBound},null,8,["modelValue","onBounds"])]),_:1}),t(m,{text:"Seconds"},{default:o(()=>[t(d,{modelValue:n.seconds,"onUpdate:modelValue":i[2]||(i[2]=a=>n.seconds=a),type:"integer",min:0,max:59,"min-digits":2,onBounds:l.secondsBound},null,8,["modelValue","onBounds"])]),_:1}),t(m,{text:"Milliseconds"},{default:o(()=>[t(d,{modelValue:n.milliseconds,"onUpdate:modelValue":i[3]||(i[3]=a=>n.milliseconds=a),type:"integer",min:0,max:999,"min-digits":3,onBounds:l.millisecondsBound},null,8,["modelValue","onBounds"])]),_:1})]),e("div",B," Time: "+r(n.hours)+"h : "+r(n.minutes)+"m : "+r(n.seconds)+"s : "+r(n.milliseconds)+"ms ",1)])]),e("section",null,[e("div",S,[e("div",A,[t(p,{summary:"Show usage example"},{default:o(()=>[s(r(n.codeExample),1)]),_:1}),t(p,{summary:"Show TimeInputPart.vue source code"},{default:o(()=>[s(r(l.code),1)]),_:1})])])])])}const R=f(I,[["render",D],["__scopeId","data-v-16865097"]]);export{R as default};
