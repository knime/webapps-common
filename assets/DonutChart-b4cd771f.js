...
`;const F=`<DonutChart
  ...
  :inner-radius="70"
  :radius="100"
/>`,T={components:{DonutChart:z,CodeExample:g},data(){return{codeExample:F}},computed:{code(){return O}}},E=n=>(b("data-v-80d9400a"),n=n(),k(),n),I=E(()=>t("section",null,[t("div",{class:"grid-container"},[t("div",{class:"grid-item-12"},[t("h2",null,"DonutChart"),t("p",null," Displays a donut chart. It can display the current and max value as well as display an additional label. Also supports a secondary value to be displayed. ")])])],-1)),R={class:"grid-container"},q={class:"grid-item-12 demo"},A={class:"grid-container"},P={class:"grid-item-12 demo"},j={class:"grid-container"},G={class:"grid-item-12"};function H(n,d,a,p,o,e){const i=x("DonutChart",!0),h=x("CodeExample");return s(),l("div",null,[I,t("section",null,[t("div",R,[t("div",q,[r(i,{value:1,"max-value":6,"inner-radius":70,radius:100}),r(i,{value:2,"max-value":6,"inner-radius":70,radius:100,"display-values":""}),r(i,{value:3,"max-value":5,"display-values":"","additional-label":"some metric","inner-radius":70,radius:100}),r(i,{value:8,"max-value":1/0,"display-values":"","additional-label":"some metric","inner-radius":70,radius:100,"accept-values-larger-than-max":""})])])]),t("section",null,[t("div",A,[t("div",P,[r(i,{value:1,"max-value":6,radius:22.5,"inner-radius":11},null,8,["radius"]),r(i,{value:2,"secondary-value":2.5,"max-value":6,radius:22.5,"inner-radius":11},null,8,["secondary-value","radius"]),r(i,{value:3,"max-value":5,"additional-label":"some metric",radius:22.5,"inner-radius":11},null,8,["radius"]),r(i,{value:8,"max-value":1/0,"additional-label":"some metric",radius:22.5,"inner-radius":11,"accept-values-larger-than-max":""},null,8,["radius"])])])]),t("section",null,[t("div",j,[t("div",G,[r(h,{summary:"Show usage example"},{default:f(()=>[v(u(o.codeExample),1)]),_:1}),r(h,{summary:"Show DonutChart.vue source code"},{default:f(()=>[v(u(e.code),1)]),_:1})])])])])}const Q=y(T,[["render",H],["__scopeId","data-v-80d9400a"]]);export{Q as default};
