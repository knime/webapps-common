import{C as P}from"./CodeExample-KJh5r7fE.js";import{L as x}from"./Label-7ztyxM-B.js";import{at as M,_ as V,r as d,o as u,c as w,j as y,w as h,d as r,l as f,v as k,n as _,b as l,e as b,t as m}from"./index-Cek3e4BM.js";import{C}from"./Checkboxes-Z7V9zso0.js";import{V as L}from"./ValueSwitch-8VYk73zg.js";import{T as U,f as T}from"./Twinlist-010SUcJv.js";import{F as B}from"./filter-bBFF4eo2.js";import"./Checkbox-o102LwaN.js";import"./BaseRadioButtons-SZyEXYGa.js";import"./MultiselectListBox-2tuDrnft.js";import"./StyledListItem-lxhiCr9k.js";import"./arrow-next-lSQ1UeDN.js";import"./createMissingItem-gAI5zZ9a.js";const F={manual:"Manual",wildcard:"Wildcard",regex:"Regex",type:"Type"},z={components:{Label:x,FilterIcon:B,SearchInput:M,Checkboxes:C,ValueSwitch:L,Twinlist:U},props:{initialMode:{type:String,required:!1,default:"manual"},initialManuallySelected:{type:Array,default:()=>[]},initialIncludeUnknownValues:{type:Boolean,default:!1},initialPattern:{type:String,default:""},initialCaseSensitivePattern:{default:!1,type:Boolean},initialInversePattern:{default:!1,type:Boolean},withTypes:{type:Boolean,default:!0},initialSelectedTypes:{type:Array,default:()=>[]},showMode:{default:!1,type:Boolean},showUnknownValues:{default:!1,type:Boolean},showSearch:{default:!0,type:Boolean},disabled:{default:!1,type:Boolean},withModeLabel:{default:!1,type:Boolean},modeLabel:{type:String,required:!1,default:"Selection mode"},withPatternLabel:{default:!1,type:Boolean},patternLabel:{type:String,required:!1,default:"Pattern"},withTypesLabel:{default:!1,type:Boolean},typesLabel:{type:String,required:!1,default:"Selected types"},possibleValues:{type:Array,default:()=>[]},additionalPossibleTypes:{type:Array,default:()=>[]}},emits:["input","includeUnknownValuesInput","patternInput","typesInput","modeInput","caseSensitivePatternInput","inversePatternInput"],data(){return{chosenValues:this.initialManuallySelected,chosenPattern:this.initialPattern,chosenTypes:this.initialSelectedTypes,invalidPossibleValueIds:new Set,mode:this.initialMode,caseSensitivePattern:this.initialCaseSensitivePattern,inversePattern:this.initialInversePattern,includeUnknownValues:this.initialIncludeUnknownValues}},computed:{possibleValueIds(){return this.possibleValues.map(({id:e})=>e)},possibleTypes(){const e=this.possibleValues.map(({type:t})=>t).filter(Boolean),n=e.map(t=>t.id);return[...this.additionalPossibleTypes.filter(t=>t&&!n.includes(t.id)),...e].filter(t=>t&&t.id!=="").filter((t,i,c)=>i===c.findIndex(o=>o.id===t.id&&o.text===t.text))},matchingValueIds(){return this.possibleValues.filter(e=>this.itemMatches(e)).map(e=>e.id)},selectedValues(){return this.mode==="manual"?this.chosenValues:this.matchingValueIds},deselectedValues(){const e=new Set(this.selectedValues??[]);return this.possibleValueIds.filter(n=>!e.has(n))},selectionDisabled(){return this.disabled||this.mode!=="manual"},normalizedSearchTerm(){return this.mode==="manual"?null:T[this.mode].normalize(this.mode==="type"?this.chosenTypes:this.chosenPattern,this.caseSensitivePattern)},possibleModes(){let e=Object.entries(F).map(([n,s])=>({id:n,text:s}));return this.withTypes||(e=e.filter(n=>n.id!=="type")),e},possibleModeIds(){return this.possibleModes.map(e=>e.id)},unknownValuesVisible(){return this.showUnknownValues&&this.mode==="manual"}},watch:{selectedValues:{immediate:!0,handler(e,n){if(e!==null&&(!n||e.length!==n.length||n.some((s,p)=>s!==e[p]))){const s=this.mode==="manual",p={selected:this.selectedValues,isManual:s};s&&(p.deselected=this.deselectedValues),this.$emit("input",p)}}},includeUnknownValues(e){this.$emit("includeUnknownValuesInput",e)},initialManuallySelected(e,n){(e===null||n===null)&&(this.chosenValues=e)}},methods:{onManualInput(e){this.mode==="manual"&&(this.chosenValues=e)},onPatternInput(e){this.chosenPattern=e,this.$emit("patternInput",e)},onTypeInput(e){this.chosenTypes=e,this.$emit("typesInput",e,this.possibleTypes)},onModeChange(e){this.possibleModeIds.indexOf(e)!==-1&&(this.mode=e,this.$emit("modeInput",e))},onToggleCaseSensitivePattern(e){this.caseSensitivePattern=e,this.$emit("caseSensitivePatternInput",e)},onToggleInvsersePattern(e){this.inversePattern=e,this.$emit("inversePatternInput",e)},onUnkownColumnsInput(e){this.includeUnknownValues=e},validate(){return this.$refs.twinlist.validate()},hasSelection(){var e;return!!((e=this.selectedValues)!=null&&e.length)},itemMatches(e){var s;return T[this.mode].test(this.mode==="type"?(s=e.type)==null?void 0:s.id:e.text,this.normalizedSearchTerm,this.caseSensitivePattern,this.inversePattern)}}};function A(e,n,s,p,t,i){const c=d("ValueSwitch"),o=d("Label"),a=d("FilterIcon"),I=d("SearchInput"),S=d("Checkboxes"),g=d("Twinlist");return u(),w("div",{class:_(["multi-mode-twinlist",{disabled:s.disabled}])},[s.showMode?(u(),y(o,{key:0,active:s.withModeLabel,text:s.modeLabel,class:"label"},{default:h(({labelForId:v})=>[r(c,{id:v,ref:"mode","model-value":t.mode,disabled:s.disabled,"possible-values":i.possibleModes,"onUpdate:modelValue":i.onModeChange},null,8,["id","model-value","disabled","possible-values","onUpdate:modelValue"])]),_:1},8,["active","text"])):f("",!0),t.mode==="regex"||t.mode==="wildcard"?(u(),y(o,{key:1,active:s.withPatternLabel,text:s.patternLabel,class:"label"},{default:h(({labelForId:v})=>[r(I,{id:v,ref:"search","model-value":t.chosenPattern,label:s.patternLabel,"initial-case-sensitive-search":s.initialCaseSensitivePattern,"initial-inverse-search":s.initialInversePattern,placeholder:"Pattern","show-case-sensitive-search-button":"","show-inverse-search-button":"",disabled:s.disabled,tooltips:{inverseSearch:"Move matching to other side"},"onUpdate:modelValue":i.onPatternInput,onToggleCaseSensitiveSearch:i.onToggleCaseSensitivePattern,onToggleInverseSearch:i.onToggleInvsersePattern},{icon:h(()=>[r(a)]),_:2},1032,["id","model-value","label","initial-case-sensitive-search","initial-inverse-search","disabled","onUpdate:modelValue","onToggleCaseSensitiveSearch","onToggleInverseSearch"])]),_:1},8,["active","text"])):f("",!0),t.mode==="type"&&i.possibleTypes.length>0?(u(),y(o,{key:2,active:s.withTypesLabel,text:s.typesLabel,class:"label"},{default:h(()=>[r(S,{"model-value":t.chosenTypes,"possible-values":i.possibleTypes,disabled:s.disabled,"onUpdate:modelValue":i.onTypeInput},null,8,["model-value","possible-values","disabled","onUpdate:modelValue"])]),_:1},8,["active","text"])):f("",!0),r(g,k(e.$attrs,{ref:"twinlist",disabled:i.selectionDisabled,"show-search":t.mode==="manual"&&s.showSearch,"model-value":i.selectedValues,"possible-values":s.possibleValues,"show-unknown-values":i.unknownValuesVisible,"initial-include-unknown-values":t.includeUnknownValues,"onUpdate:modelValue":i.onManualInput,onIncludeUnknownValuesInput:i.onUnkownColumnsInput}),null,16,["disabled","show-search","model-value","possible-values","show-unknown-values","initial-include-unknown-values","onUpdate:modelValue","onIncludeUnknownValuesInput"])],2)}const O=V(z,[["render",A],["__scopeId","data-v-8f9eb28f"]]),q=`<script lang="ts">
