import{C as x}from"./CodeExample-7d352019.js";import{o as e,c as o,b as s,q as v,_ as k,r as a,F as w,g as y,d as r,e as c,t as d,l as u,w as m}from"./index-fff5b51e.js";const L={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},b=s("path",{d:"M17.3 3.3 30 16 17.3 28.7M30 16H2"},null,-1),$=[b];function I(t,p){return e(),o("svg",L,$)}const E={render:I},A=v({components:{ArrowIcon:E},props:{links:{type:Array,default:()=>[]}}});const C={key:0,class:"link-list"},N=["href"];function M(t,p,_,h,g,i){const l=a("ArrowIcon");return t.links&&t.links.length?(e(),o("ul",C,[(e(!0),o(w,null,y(t.links,(n,f)=>(e(),o("li",{key:f},[n.url?(e(),o("a",{key:0,href:n.url,rel:"ugc noopener"},[r(l),c(" "+d(n.text||n.url),1)],8,N)):u("",!0)]))),128))])):u("",!0)}const z=k(A,[["render",M],["__scopeId","data-v-5d44b221"]]),B=`<script lang="ts">
