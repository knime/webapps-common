import{C as b}from"./CodeExample-ibKGFEFz.js";import{h as B,T as f,C as y,_ as i,r,k as h,o as d,w as n,d as t,y as k,p as C,c as v,b as s,e as l,t as c}from"./index-B0fv7C7B.js";import{P as x}from"./plus-small-DqDZMXAA.js";const $=B({name:"PlusButton",components:{Button:y,Tooltip:f,PlusIcon:x},inheritAttrs:!1,props:{title:{type:String,default:null}}});function g(a,p,m,_,u,P){const o=r("PlusIcon"),e=r("Button");return d(),h(C(a.title?"Tooltip":"div"),{text:a.title},{default:n(()=>[t(e,k({class:"plus-button"},a.$attrs),{default:n(()=>[t(o)]),_:1},16)]),_:1},8,["text"])}const w=i($,[["render",g],["__scopeId","data-v-23fb968f"]]),E="",S="",I=`
