import{C as w}from"./CodeExample-ff021a53.js";import{F as f}from"./folder-e170e694.js";import{A as C}from"./arrow-next-aba8fd59.js";import{_ as y,i as I,r as h,o as n,c as l,b as o,F as N,g as S,j as a,w as k,k as b,l as s,e as d,t as u,n as g,m as B,d as m}from"./index-02e57c95.js";const E={components:{ArrowNext:C},props:{items:{type:Array,default:()=>[]},greyStyle:{type:Boolean,default:!1}},emits:["click-item"],computed:{linkComponent(){return I()}}},A=["role","title","onClick"];function F(t,v,r,_,i,p){const c=h("ArrowNext");return r.items&&r.items.length?(n(),l("nav",{key:0,class:g(["breadcrumb",{"grey-style":r.greyStyle}])},[o("ul",null,[(n(!0),l(N,null,S(r.items,(e,x)=>(n(),l("li",{key:x},[e.href?(n(),a(b(p.linkComponent),{key:0,to:e.href},{default:k(()=>[e.icon?(n(),a(b(e.icon),{key:0,class:"breadcrumb-icon"})):s("",!0),d(" "+u(e.text),1)]),_:2},1032,["to"])):(n(),l("span",{key:1,class:g({clickable:e.clickable}),role:e.clickable?"button":null,title:e.title,onClick:z=>e.clickable&&t.$emit("click-item",e)},[e.icon?(n(),a(b(e.icon),{key:0,class:"breadcrumb-icon"})):s("",!0),d(" "+u(e.text),1)],10,A)),x!==r.items.length-1?(n(),a(c,{key:2,class:"arrow"})):s("",!0)]))),128))])],2)):s("",!0)}const D=y(E,[["render",F],["__scopeId","data-v-df529354"]]),L=`<script>
