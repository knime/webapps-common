import{C as I}from"./CodeExample-6011a264.js";import{o as a,c as _,b as n,_ as m,r as c,j as v,d as s,w as p,e as r,t as l,p as x,f as L}from"./index-df2c2ab8.js";import{s as w}from"./svgWithTitle-4c1a2d91.js";const y={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},$=n("path",{d:"m11.9 22.3 2.7 4.4-4.5 2.8m4.5-2.8C9 26 4.7 21.7 4.7 16c0-5.1 3.4-9.4 8.1-10.8M20 9.7l-2.6-4.4 4.5-2.8m-4.5 2.8c5.6.7 9.9 5 9.9 10.7 0 5.1-3.4 9.4-8.1 10.8"},null,-1),k=[$];function R(o,i){return a(),_("svg",y,k)}const C={render:R};const E={components:{ReloadIcon:w(C,"Loading…")}};function S(o,i,u,f,e,h){const t=c("ReloadIcon");return a(),v(t)}const B=m(E,[["render",S],["__scopeId","data-v-a882068f"]]),T=`<script>
