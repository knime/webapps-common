import{C as b}from"./CodeExample-DdMcj6_f.js";import{h as B,C as f,T as y,_ as i,r,o as d,k as h,w as n,d as t,y as k,p as C,c as v,b as s,e as l,t as c}from"./index-jKV-u3te.js";import{P as x}from"./plus-small-DfsyUxIN.js";const $=B({name:"PlusButton",components:{Button:f,Tooltip:y,PlusIcon:x},inheritAttrs:!1,props:{title:{type:String,default:null}}});function g(a,p,m,_,u,P){const o=r("PlusIcon"),e=r("Button");return d(),h(C(a.title?"Tooltip":"div"),{text:a.title},{default:n(()=>[t(e,k({class:"plus-button"},a.$attrs),{default:n(()=>[t(o)]),_:1},16)]),_:1},8,["text"])}const w=i($,[["render",g],["__scopeId","data-v-23fb968f"]]),E="",S="",I=`
