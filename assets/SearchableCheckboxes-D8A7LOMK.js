import{C as k}from"./CodeExample-BA5rNYjT.js";import{b0 as L,i as y,R as c,Y as V,_ as C,r as v,c as z,o as x,b as a,k as F,l as g,w as B,d as u,t as b,s as E,aj as M,n as T,g as N,e as _}from"./index-BzdytT3y.js";import{u as U}from"./useSearch-BrL5aaQx.js";import{C as A}from"./Checkboxes-CJQu64hg.js";import{L as H}from"./Label-CdBYpYuj.js";import{c as O}from"./createMissingItem-PGCdVBns.js";import{u as P}from"./useLabelInfo-DYSGbLiT.js";import"./Checkbox-U6TOI_3a.js";import"./v4-BKrj-4V8.js";const f=5,R=28,D={name:"SearchableCheckboxes",components:{Label:H,SearchInput:L,Checkboxes:A},props:{possibleValues:{type:Array,default:()=>{},validator(t){return Array.isArray(t)?t.every(e=>e.hasOwnProperty("id")&&e.hasOwnProperty("text")):!1}},modelValue:{type:Array,default:()=>[]},disabled:{type:Boolean,default:!1},withSearchLabel:{default:!1,type:Boolean},id:{type:String,default:null},initialCaseSensitiveSearch:{default:!1,type:Boolean},showSearch:{type:Boolean,default:!1},size:{type:Number,default:5,validator(t){return t>=0}},searchLabel:{type:String,required:!1,default:""},searchPlaceholder:{type:String,required:!1,default:"Search"},alignment:{type:String,default:"horizontal",validator(t){return["horizontal","vertical"].includes(t)}},emptyStateLabel:{type:String,default:"No entries in this list"},initialSearchTerm:{type:String,required:!1,default:""},showEmptyState:{default:!0,type:Boolean},isValid:{default:!0,type:Boolean},emptyStateComponent:{default:null,type:Object},compact:{type:Boolean,default:!1}},emits:["update:modelValue"],setup(t){const e=y(t.initialSearchTerm),s=y(t.initialCaseSensitiveSearch),d=c(()=>Object.assign({},...t.possibleValues.map((n,p)=>({[n.id]:{item:n,index:p}})))),i=c(()=>t.possibleValues.map(n=>d.value[n.id]?.item)),l=c(()=>t.modelValue?t.modelValue?.filter(n=>!d.value[n]):[]),r=c(()=>l.value?.map(n=>O(n))),m=c(()=>t.modelValue===null?[]:[...r.value,...i.value]),o=U(e,s,m,V(t,"showSearch")),h=c(()=>o.value.length===0?[]:o.value.filter(n=>m.value.includes(n))),S=c(()=>t.showSearch&&e.value!==""),I=c(()=>h.value.filter(p=>p.text.toLowerCase().includes(e.value.toLowerCase()))),w=c(()=>t.showSearch?S.value?P(I,i.value.length,V(t.modelValue??[])):`[ ${t.modelValue?.length} selected ]`:`[ ${t.modelValue?.length} selected ]`);return{searchTerm:e,visibleValues:m,concatenatedItems:h,caseSensitiveSearch:s,numLabelInfos:w,matchingInvalidValueIds:r,allItems:o}},computed:{withIsEmptyState(){return this.concatenatedItems.length===0},listSize(){if(this.possibleValues.length>=f){const t=this.size===0?this.possibleValues.length:this.size;return t>f?t:f}return this.size},cssStyleSize(){const t=`${this.listSize*R+2}px`;return this.listSize>0?{height:t}:{}},returnContainerRef(){return this.$refs.div},alignmentCheck(){return this.alignment==="vertical"?this.cssStyleSize:{height:"auto"}}},methods:{onSearchInput(t){this.searchTerm=t},onChange(t){this.$emit("update:modelValue",t)},hasSelection(){return(this.modelValue?.length??0)>0},handleMouseIn(){!this.disabled&&this.size>=f&&(this.returnContainerRef.style.overflow="auto")},handleMouseLeave(){this.returnContainerRef.style.overflow="hidden"},validate(){const t=!this.concatenatedItems.some(e=>e.invalid);return{isValid:t,errorMessage:t?null:"One or more of the selected items is invalid."}}}},q={class:"checkboxes-wrapper"},j={class:"header"},Z={class:"title"},X={key:0,class:"info"},Y={key:0,class:"empty-state"};function G(t,e,s,d,i,l){const r=v("SearchInput"),m=v("Label"),o=v("Checkboxes");return x(),z("div",null,[a("div",q,[s.showSearch?(x(),F(m,{key:0,active:s.withSearchLabel,text:s.searchLabel,class:"search-wrapper"},{default:B(({labelForId:h})=>[u(r,{id:h,ref:"search",placeholder:s.searchPlaceholder,"model-value":d.searchTerm,label:s.searchLabel,"initial-case-sensitive-search":s.initialCaseSensitiveSearch,"show-case-sensitive-search-button":"",disabled:s.disabled,compact:s.compact,"onUpdate:modelValue":l.onSearchInput,onToggleCaseSensitiveSearch:e[0]||(e[0]=S=>d.caseSensitiveSearch=S)},null,8,["id","placeholder","model-value","label","initial-case-sensitive-search","disabled","compact","onUpdate:modelValue"])]),_:1},8,["active","text"])):g("",!0),a("div",j,[a("div",Z,[d.numLabelInfos?(x(),z("div",X,b(d.numLabelInfos),1)):g("",!0)])])]),a("div",{ref:"div",class:N(["container",{disabled:s.disabled,"empty-box":l.withIsEmptyState}]),style:T([l.alignmentCheck,l.cssStyleSize]),onMouseenter:e[1]||(e[1]=(...h)=>l.handleMouseIn&&l.handleMouseIn(...h)),onMouseleave:e[2]||(e[2]=(...h)=>l.handleMouseLeave&&l.handleMouseLeave(...h))},[E(u(o,{ref:"form","empty-state-label":s.emptyStateLabel,"empty-state-component":s.emptyStateComponent,"model-value":s.modelValue,alignment:s.alignment,"possible-values":d.concatenatedItems,"is-valid":s.isValid,disabled:s.disabled,"onUpdate:modelValue":l.onChange},null,8,["empty-state-label","empty-state-component","model-value","alignment","possible-values","is-valid","disabled","onUpdate:modelValue"]),[[M,!l.withIsEmptyState]]),!d.concatenatedItems.length&&l.withIsEmptyState?(x(),z("div",Y,[a("span",null,b(s.emptyStateLabel),1)])):g("",!0)],38)])}const J=C(D,[["render",G],["__scopeId","data-v-a352b922"]]),K="",Q=`<SearchableCheckboxes
  v-model="selected"
  :possible-values="[{
    id: 'foo',
    text: 'Foo'
