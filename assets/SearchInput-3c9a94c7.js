import{C as h}from"./CodeExample-af46618b.js";import{_ as m,X as v,o as S,c as f,b as e,d as o,e as l,t as c,w as d,r as p,p as g,f as I}from"./index-be5f8b0e.js";const V=`<script>
...
<SearchInput
  ...
  @focus="onFocus"
/>
`,b={components:{SearchInput:v,CodeExample:h},data(){return{codeExample:_,inputValue:"",inputValue2:"",inputValue3:"Demo"}},computed:{code(){return V}},methods:{alert(a){window.alert(a)}}},B=a=>(g("data-v-ace9b8a7"),a=a(),I(),a),w=B(()=>e("div",{class:"grid-container"},[e("div",{class:"grid-item-12"},[e("h2",null,"SearchInput"),e("p",null,[l(" Single line string search input with search icon and clear button. It acts as a form element, so it emits "),e("code",null,"input"),l(" events and it has a "),e("code",null,"value"),l(". ")])])],-1)),y={class:"grid-container"},C={class:"grid-item-6 inputs"},x={class:"grid-item-6"},F={class:"grid-container"},k={class:"grid-item-12"};function E(a,n,L,U,t,r){const i=p("SearchInput",!0),u=p("CodeExample");return S(),f("div",null,[e("section",null,[w,e("div",y,[e("div",C,[o(i,{modelValue:t.inputValue,"onUpdate:modelValue":n[0]||(n[0]=s=>t.inputValue=s),label:"Search things",placeholder:"Placeholder"},null,8,["modelValue"]),o(i,{modelValue:t.inputValue2,"onUpdate:modelValue":n[1]||(n[1]=s=>t.inputValue2=s)},null,8,["modelValue"]),o(i,{"model-value":"disabled: no search possible here",disabled:""}),l(' The clear-all button emits a "clear" event that can be listend to: '),o(i,{modelValue:t.inputValue3,"onUpdate:modelValue":n[2]||(n[2]=s=>t.inputValue3=s),placeholder:"Placeholder",onClear:n[3]||(n[3]=s=>r.alert("Search cleared"))},null,8,["modelValue"])]),e("div",x," input value: "+c(t.inputValue),1)])]),e("section",null,[e("div",F,[e("div",k,[o(u,{summary:"Show usage example"},{default:d(()=>[l(c(t.codeExample),1)]),_:1}),o(u,{summary:"Show SearchInput.vue source code"},{default:d(()=>[l(c(r.code),1)]),_:1})])])])])}const N=m(b,[["render",E],["__scopeId","data-v-ace9b8a7"]]);export{N as default};
