import{C as se}from"./CodeExample-DZclaiiM.js";import{i as d,u as x,aU as oe,R as D,X as M,al as _,aV as ae,aW as le,aX as re,h as ce,aF as ue,o as de,c as pe,b as l,e as y,a as me,d as fe,w as He,t as he,_ as ve}from"./index-D0ikwWgO.js";const k=d(!1),u=d(!1),f=d(null),ge=({storageKey:s,uniqueUserId:c,getRemoteHintState:o,setRemoteHintState:a})=>{const r=`${s}.${x(c)}`,i=oe(r,{completedHints:[],skipAll:!1},{deep:!0,listenToStorageChanges:!0}),n=D(()=>i.value.skipAll),w=async t=>{try{await a(s,t)}catch{consola.error("Updating remote hint state failed")}},S=async()=>{try{const t=await o(s);i.value={skipAll:t.skipAll??i.value.skipAll,completedHints:[...i.value.completedHints,...t.completedHints??[]]}}catch(t){consola.error("Getting hints from remote failed",t)}};M(i,t=>{!u.value||k.value||w(t)},{deep:!0});const A=t=>{f.value=t},p=t=>i.value.completedHints.includes(t)||!1,m=t=>{u.value&&(p(t)||n.value||f.value===t&&(i.value.completedHints.unshift(t),f.value=null))},h=t=>{u.value&&(p(t)||i.value.completedHints.unshift(t))},V=()=>{i.value.skipAll=!0,f.value=null};return{initialize:async()=>{n.value||u.value||k.value||(k.value=!0,await S(),u.value=!0,k.value=!1)},isInitialized:_(u),completeHint:m,completeHintWithoutVisibility:h,isCompleted:p,isAllSkipped:n,setSkipAll:V,currentlyVisibleHint:f,setCurrentlyVisibleHint:A}},H=()=>{},N={},Ce=({hints:s={},uniqueUserId:c="user",storageKey:o="onboarding.hints",skipHints:a=!1,getRemoteHintState:r=()=>Promise.resolve({}),setRemoteHintState:i=()=>Promise.resolve(!1)},n="default")=>{N[n]={hints:s,uniqueUserId:c,storageKey:o,skipHints:a,getRemoteHintState:r,setRemoteHintState:i}},be=({hintSetupId:s="default"}={})=>{const{hints:c,uniqueUserId:o,storageKey:a,skipHints:r,getRemoteHintState:i,setRemoteHintState:n}=N[s];if(x(r))return{isCompleted:()=>!0,isAllSkipped:_(d(!0)),createHint:H,getCompleteHintComponentCallback:()=>H,completeHintWithoutComponent:()=>H};const{initialize:w,isInitialized:S,completeHint:A,completeHintWithoutVisibility:p,isCompleted:m,isAllSkipped:h,setSkipAll:V,currentlyVisibleHint:E,setCurrentlyVisibleHint:t}=ge({uniqueUserId:o,getRemoteHintState:i,setRemoteHintState:n,storageKey:a}),{createHintData:W}=ae();le(()=>{w()});const z=e=>c[e]||null,O=e=>{if(h.value||!S.value||m(e))return!1;if(E.value)return E.value===e;const v=z(e),{dependsOn:T=[]}=v;return!!T.every(g=>m(g))},B={},R=e=>()=>{(B[e]||H)()},L=[],P=[];re(()=>{L.forEach(e=>e()),P.forEach(e=>e()),t(null)});const $=({hintId:e,referenceSelector:v,referenceElement:T,isVisibleCondition:U=d(!0)})=>{const g=z(e);if(!g)return;const{title:X,description:q,linkText:F=void 0,linkHref:G=void 0,video:J=[],image:K=void 0,referenceSelector:Q=void 0,hideButtons:Y=!1,align:Z="center",side:I="bottom"}=g;let C=H;const j=()=>A(e),ee=x(T)??v??Q??`#${e}`,{showHint:te,closeHint:b}=W(e,{element:ee,title:X,description:q,linkText:F,linkHref:G,video:J,image:K,hideButtons:Y,onCompleteHint:()=>{C(),j(),b(e)},onSkipAllHints:()=>{V(),b(e)},align:Z,side:I});B[e]=()=>{C(),j(),b(e)};const ne=D(()=>O(e)&&U.value);C=M(ne,ie=>{ie&&(t(e),te(e),P.unshift(()=>b(e)))},{immediate:!0}),L.unshift(C)};return{isCompleted:m,isAllSkipped:_(h),createHint:$,getCompleteHintComponentCallback:R,completeHintWithoutComponent:p}},ye={class:"grid-container"},ke={class:"grid-item-12"},we={class:"reference"},Se=`
