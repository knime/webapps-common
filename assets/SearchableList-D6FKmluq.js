...
/>
`,G={components:{SearchableList:R,CodeExample:I},data(){return{codeExample:Z,selected:[],disabledSelected:[],selected2:[],disabledSelected2:[],withMissing:["foo","I am missing","bar"],bottomValueSymbol:Symbol("bottom value")}},computed:{code(){return X}}},J=F('<div class="grid-container"><div class="grid-item-12"><p> A list box for selecting multiple items which is searchable. It acts as a form element, so it emits an <code>input</code> event when something is (de-)selected, and it has a <code>value</code>. It has keyboard navigation with <code>Up</code>, <code>Down</code>, <code>Home</code>, <code>End</code>. It is possible to multi select via keyboard with <code>Shift+Up</code> and <code>Shift+Down</code>. Selective multi select is possible by <code>Ctrl+Click</code> or <code>Shift+Click</code>. Also multi select by dragging is supported. </p></div></div>',1),K={class:"grid-container"},Q={class:"grid-item-6"},W={class:"grid-item-6"},Y=l("br",null,null,-1),$=l("div",{class:"grid-container"},[l("div",{class:"grid-item-12"},[l("p",null," The SearchableList can display a bottom element (visually different but funcionally equivalent to an element lying below all other elements). The total size of the box does not depend on the bottom element (i.e. less elements are shown instead). ")])],-1),ee=l("br",null,null,-1),te={class:"grid-container"},ae={class:"grid-item-6"},le={class:"grid-item-6"},se=l("br",null,null,-1),ie={class:"grid-container"},oe={class:"grid-item-6"},de=l("br",null,null,-1),ne={class:"grid-container"},re={class:"grid-item-6"},ce=l("br",null,null,-1),ue={class:"grid-container"},me={class:"grid-item-6"},he={class:"grid-item-6"},be={class:"grid-container"},ve={class:"grid-item-12"};function fe(e,a,t,d,s,u){const r=f("SearchableList",!0),h=f("CodeExample");return z(),_("div",null,[l("section",null,[J,l("div",K,[l("div",Q,[m(r,{modelValue:s.selected,"onUpdate:modelValue":a[0]||(a[0]=i=>s.selected=i),size:4,"aria-label":"Select stuff here!","show-search":!0,"search-label":"Search items","search-placeholder":"Placeholder","with-search-label":!0,"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},...Array.from({length:100},(i,b)=>({id:`baz${b}`,text:`Baz ${b}`}))]},null,8,["modelValue","possible-values"])]),l("div",W,"selected ids: "+v(s.selected),1)]),Y,$,ee,l("div",te,[l("div",ae,[m(r,{modelValue:s.selected2,"onUpdate:modelValue":a[1]||(a[1]=i=>s.selected2=i),size:4,"aria-label":"Select stuff here!","with-bottom-value":!0,"show-search":!0,"bottom-value":{id:s.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}]},null,8,["modelValue","bottom-value"])]),l("div",le,"selected ids: "+v(s.selected2),1)]),se,p(" Disabled "),l("div",ie,[l("div",oe,[m(r,{modelValue:s.disabledSelected2,"onUpdate:modelValue":a[2]||(a[2]=i=>s.disabledSelected2=i),size:4,"aria-label":"Disabled...","with-bottom-value":"","show-search":!0,"bottom-value":{id:s.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}],disabled:""},null,8,["modelValue","bottom-value"])])]),de,p(" Compact "),l("div",ne,[l("div",re,[m(r,{modelValue:s.disabledSelected2,"onUpdate:modelValue":a[3]||(a[3]=i=>s.disabledSelected2=i),size:4,"aria-label":"Compact...","with-bottom-value":"","show-search":!0,"bottom-value":{id:s.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}],compact:""},null,8,["modelValue","bottom-value"])])]),ce,l("div",ue,[l("div",me,[m(r,{modelValue:s.withMissing,"onUpdate:modelValue":a[4]||(a[4]=i=>s.withMissing=i),size:4,"aria-label":"Disabled...","show-search":!0,"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}]},null,8,["modelValue"])]),l("div",he,"selected ids: "+v(s.withMissing),1)])]),l("section",null,[l("div",be,[l("div",ve,[m(h,{summary:"Show usage example"},{default:g(()=>[p(v(s.codeExample),1)]),_:1}),m(h,{summary:"Show SearchableList.vue source code"},{default:g(()=>[p(v(u.code),1)]),_:1})])])])])}const Be=w(G,[["render",fe]]);export{Be as default};
