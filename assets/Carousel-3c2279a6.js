import{C as p}from"./CodeExample-a53af527.js";import{_ as u,C as h,r as l,o as g,c as m,b as e,d as s,w as a,e as i,t as d,p as f,f as w}from"./index-eeaa987d.js";const v=`<script lang="ts">
...
</style>`,_={components:{Carousel:h,CodeExample:p},data(){return{carouselCode:v,codeExample:b}}},o=n=>(f("data-v-8b979860"),n=n(),w(),n),x={class:"grid-container"},M={class:"grid-item-12"},C=o(()=>e("p",null," The carousel can fit items of any size and creates shadows on each side of the viewport to indicate that scrolling is possible. When one side of the items inside of the carousel is reached the shadow should disappear. ",-1)),D=o(()=>e("p",null," The color of the shadow can be adjusted to the background by setting the .shadow-color's before and after elements background-image (example below) ",-1)),k=o(()=>e("p",null,"See usage example for more CSS adjustments.",-1)),y=o(()=>e("div",{class:"wrapper"},[e("div",{class:"card card1"}),e("div",{class:"card card2"}),e("div",{class:"card card3"}),e("div",{class:"card card1"}),e("div",{class:"card card2"}),e("div",{class:"card card3"})],-1));function E(n,S,L,T,t,X){const c=l("Carousel",!0),r=l("CodeExample");return g(),m("section",null,[e("div",x,[e("div",M,[C,D,k,e("section",null,[s(c,null,{default:a(()=>[y]),_:1})]),s(r,{summary:"Show usage example"},{default:a(()=>[i(d(t.codeExample),1)]),_:1}),s(r,{summary:"Show Carousel.vue source code"},{default:a(()=>[i(d(t.carouselCode),1)]),_:1})])])])}const j=u(_,[["render",E],["__scopeId","data-v-8b979860"]]);export{j as default};
