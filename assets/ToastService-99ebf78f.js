import{C as l}from"./CodeExample-d18dad30.js";import{B as i}from"./Button-2c523da0.js";import{q as _,U as j,o as I,c as A,b as t,t as p,V as n,d as o,w as s,e as a,a as u,W as N,p as R,f as $,_ as q}from"./index-435efefc.js";const E=`import { ref, provide, inject, computed, getCurrentInstance } from "vue";
...
`,d=m=>(R("data-v-a2e1497d"),m=m(),$(),m),B=u('<section data-v-a2e1497d><div class="grid-container" data-v-a2e1497d><div class="grid-item-12" data-v-a2e1497d><p data-v-a2e1497d> This framework provides a simple and versatile API that enables the use of toast-style notifications. It&#39;s Vuex/Pinia-agnostic, Nuxt 3-ready, and supports both Composition API and Options API approaches. Multiple toast services can be used in the same project. A toast service is a combination of a reactive array of toast objects and methods for mutating the array. </p><p data-v-a2e1497d> You are able to import all of the public-facing components of the framework, including types, from <code data-v-a2e1497d>webapps-common/ui/services/toast</code>. </p><p data-v-a2e1497d> To use the toast service in your project, follow these steps (see the example section below for detailed coverage of various use-cases): </p><ol data-v-a2e1497d><li data-v-a2e1497d> Import and instantiate the <code data-v-a2e1497d>ToastServiceProvider</code> class in the <code data-v-a2e1497d>setup</code> section of the root component of your project (e.g. <code data-v-a2e1497d>App.vue</code>). The class instance will create a new toast service. </li><li data-v-a2e1497d> In the same <code data-v-a2e1497d>setup</code> section, provide the toast service to the downstream components of the application by calling the <code data-v-a2e1497d>toastServiceProvider.useToastService()</code> method. </li><li data-v-a2e1497d> Either in the root component, or in a downstream component, import the <code data-v-a2e1497d>ToastStack</code> component and place it in the <code data-v-a2e1497d>template</code> section. Currently, the stack is bound to the bottom left corner of its parent and the position is not adjustable. </li><li data-v-a2e1497d> Whenever a component needs to e.g. display a toast notification, import the <code data-v-a2e1497d>useToasts</code> composable, which returns the toast service object containing the <code data-v-a2e1497d>show</code> function. Make sure to call the composable in the <code data-v-a2e1497d>setup</code> section of the component. </li><li data-v-a2e1497d> Use the retrieved service properties, e.g. <code data-v-a2e1497d>show</code>, anywhere in the component to modify the toast stack. </li></ol></div></div></section>',1),V={class:"grid-container"},F={class:"grid-item-12"},U=d(()=>t("h4",null,"Interactive demo",-1)),G=d(()=>t("p",null," This application has a toast service integrated. You can see it in action by spawning toast notifications using the buttons below. ",-1)),W=d(()=>t("h5",null,"Basic examples",-1)),D={class:"grid-container"},M={class:"wrapper"},Y=d(()=>t("h5",null,"Additional features",-1)),L={class:"grid-container"},H={class:"wrapper"},X=d(()=>t("h5",null,"Stack control",-1)),z={class:"grid-container"},J={class:"wrapper"},K=u('<section data-v-a2e1497d><div class="grid-container" data-v-a2e1497d><div class="grid-item-12" data-v-a2e1497d><h4 data-v-a2e1497d>Usage guidelines</h4><p data-v-a2e1497d> To make the UX consistent, please try to adhere to the following usage guidelines: </p><ul data-v-a2e1497d><li data-v-a2e1497d> Omit periods from <code data-v-a2e1497d>headlines</code>, e.g. &quot;Action performed.&quot; -&gt; &quot;Action performed&quot;. </li><li data-v-a2e1497d>Ensure <code data-v-a2e1497d>messages</code> end with a period.</li><li data-v-a2e1497d> Use the <code data-v-a2e1497d>type</code> of the toast to convey success/error information, instead of explicitly stating it in the <code data-v-a2e1497d>headline</code>, e.g. &quot;Successfully created space&quot; -&gt; &quot;Space created&quot;. </li><li data-v-a2e1497d> Refrain from using &quot;was&quot; when referring to completed actions, e.g. &quot;Space was created&quot; -&gt; &quot;Space created&quot;. </li><li data-v-a2e1497d> Toasts with important information should be persistent, i.e. <code data-v-a2e1497d>autoRemove</code> set to <code data-v-a2e1497d>false</code>. </li></ul></div></div></section>',1),Q={class:"grid-container"},Z={class:"grid-item-12"},ee=d(()=>t("h4",null,"Usage examples",-1)),te=`
