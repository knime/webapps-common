import{C as V}from"./CodeExample-L7K3ky9_.js";import{_ as g,o as u,c as h,b as s,F as y,g as I,h as x,n as m,t as p,r as f,d as c,w as v,e as b,a as w}from"./index-G11fb1C6.js";let B=0;const S=40,_=38,C=36,k=35,E={props:{id:{type:String,default(){return`ListBox-${B++}`}},modelValue:{type:String,default:""},size:{type:Number,default:0,validator(e){return e>=0}},isValid:{default:!0,type:Boolean},ariaLabel:{type:String,required:!0},possibleValues:{type:Array,default:()=>[],validator(e){return Array.isArray(e)?e.every(t=>t.hasOwnProperty("id")&&t.hasOwnProperty("text")):!1}}},emits:["update:modelValue"],data(){return{selectedIndex:-1,invalidPossibleValueIds:[],optionLineHeight:22}},computed:{ulSizeStyle(){const e=t=>`${t*this.optionLineHeight+2}px`;return this.size>0?{height:e(this.size)}:{minHeight:e(2)}},selectableValues(){return[...this.invalidPossibleValueIds.map(e=>this.generateInvalidItem(e)),...this.possibleValues]}},watch:{modelValue(e){this.updateSelectedIndexAndInvalidValue(e)}},mounted(){this.updateSelectedIndexAndInvalidValue(this.modelValue)},methods:{updateSelectedIndexAndInvalidValue(e){const t=this.selectableValues.findIndex(i=>i.id===e);t===-1&&e?(this.invalidPossibleValueIds.includes(e)||this.invalidPossibleValueIds.push(e),this.selectedIndex=this.selectableValues.findIndex(i=>i.id===e)):this.selectedIndex=t},isCurrentValue(e){return this.modelValue===e},setSelected(e,t){consola.trace("ListBox setSelected on",e),this.selectedIndex=t,this.$emit("update:modelValue",e)},scrollToCurrent(){let e=this.$refs.ul;if(e.scrollHeight>e.clientHeight){let t=this.$refs.options[this.selectedIndex],i=e.clientHeight+e.scrollTop,r=t.offsetTop+t.offsetHeight;r>i?e.scrollTop=r-e.clientHeight:t.offsetTop<e.scrollTop&&(e.scrollTop=t.offsetTop)}},onArrowDown(){let e=this.selectedIndex+1;e>=this.selectableValues.length||(this.setSelected(this.selectableValues[e].id,e),this.scrollToCurrent())},onArrowUp(){let e=this.selectedIndex-1;e<0||(this.setSelected(this.selectableValues[e].id,e),this.scrollToCurrent())},onEndKey(){let e=this.selectableValues.length-1;this.setSelected(this.selectableValues[e].id,e),this.$refs.ul.scrollTop=this.$refs.ul.scrollHeight},onHomeKey(){let e=0;this.setSelected(this.selectableValues[e].id,e),this.$refs.ul.scrollTop=0},handleKeyDown(e){e.keyCode===S&&(this.onArrowDown(),e.preventDefault()),e.keyCode===_&&(this.onArrowUp(),e.preventDefault()),e.keyCode===k&&(this.onEndKey(),e.preventDefault()),e.keyCode===C&&(this.onHomeKey(),e.preventDefault())},hasSelection(){return this.selectedIndex>=0},validate(){return{isValid:!this.getCurrentItem().invalid,errorMessage:null}},getCurrentItem(){return this.selectableValues[this.selectedIndex]||{id:"",text:""}},generateInvalidItem(e){return{id:e,text:`(MISSING) ${e}`,invalid:!0}},generateOptionId(e){if(!e||!e.id)return"";let t=e.id.replace(/[^\w]/gi,"");return`option-${this.id}-${t}`}}},T=["id","aria-label","aria-activedescendant"],H=["id","title","aria-selected","onClick","onFocus"];function D(e,t,i,r,o,l){return u(),h("div",{class:m(["list-box",{invalid:!i.isValid}])},[s("ul",{id:i.id,ref:"ul",role:"listbox",tabindex:"0","aria-label":i.ariaLabel,style:x(l.ulSizeStyle),"aria-activedescendant":l.generateOptionId(l.getCurrentItem()),onKeydown:t[0]||(t[0]=(...n)=>l.handleKeyDown&&l.handleKeyDown(...n))},[(u(!0),h(y,null,I(l.selectableValues,(n,a)=>(u(),h("li",{id:l.generateOptionId(n),key:`listbox-${n.id}`,ref_for:!0,ref:"options",role:"option",style:x({"line-height":`${o.optionLineHeight}px`}),title:n.text,class:m({focused:l.isCurrentValue(n.id),noselect:!0,invalid:n.invalid,empty:n.text.trim()===""}),"aria-selected":l.isCurrentValue(n.id),onClick:d=>l.setSelected(n.id,a),onFocus:d=>l.setSelected(n.id,a)},p(n.text),47,H))),128))],44,T)],2)}const K=g(E,[["render",D],["__scopeId","data-v-d9420f82"]]),L=`<script>
let count = 0;
const KEY_DOWN = 40;
const KEY_UP = 38;
const KEY_HOME = 36;
...
/>`,z={components:{ListBox:K,CodeExample:V},data(){return{codeExample:N,selected:"bar"}},computed:{code(){return L}}},A=w('<div class="grid-container"><div class="grid-item-12"><p> A list of choices the user must choose one of them, so it emits an <code>input</code> event when something is selected, and it has a <code>value</code>. It can have a <code>size</code> which defines the visible items. Keyboard navigation works (<code>Up</code>/<code>Down</code> and <code>Home</code>/<code>End</code>). Second ListBox demonstrates invalid state (<code>isValid=false</code>) and has a scrollbar because it has a size of 3 elements. </p></div></div>',1),P={class:"grid-container"},$={class:"grid-item-5"},O={class:"grid-item-5"},Y={class:"grid-item-2"},U={class:"grid-container"},F={class:"grid-item-12"};function M(e,t,i,r,o,l){const n=f("ListBox",!0),a=f("CodeExample");return u(),h("div",null,[s("section",null,[A,s("div",P,[s("div",$,[c(n,{modelValue:o.selected,"onUpdate:modelValue":t[0]||(t[0]=d=>o.selected=d),"aria-label":"A List","possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"}]},null,8,["modelValue"])]),s("div",O,[c(n,{modelValue:o.selected,"onUpdate:modelValue":t[1]||(t[1]=d=>o.selected=d),"aria-label":"A limited list","is-valid":!1,size:3,"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"bar2",text:"Bar 2"},{id:"bar3",text:"Bar 3"},{id:"bar4",text:"Bar 4"},{id:"bar5",text:"Bar 5"},{id:"bar6",text:"Bar 6"},{id:"bar7",text:"Bar 7"},{id:"bar8",text:"Bar 8"},{id:"bar9",text:"Bar 9"},{id:"bar10",text:"Bar 10"},{id:"bar11",text:"Bar 11"},{id:"bar12",text:"Bar 12"},{id:"baz",text:"Baz"}]},null,8,["modelValue"])]),s("div",Y,"selected id: "+p(o.selected),1)])]),s("section",null,[s("div",U,[s("div",F,[c(a,{summary:"Show usage example"},{default:v(()=>[b(p(o.codeExample),1)]),_:1}),c(a,{summary:"Show ListBox.vue source code"},{default:v(()=>[b(p(l.code),1)]),_:1})])])])])}const G=g(z,[["render",M]]);export{G as default};
