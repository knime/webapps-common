import{C as I}from"./CodeExample-499690ec.js";import{o as a,c as _,b as n,_ as m,r as c,j as h,d as s,w as p,e as r,t as l,p as v,f as x}from"./index-235c8c6d.js";import{s as L}from"./svgWithTitle-ab0f263d.js";const w={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},y=n("path",{d:"m11.9 22.3 2.7 4.4-4.5 2.8m4.5-2.8C9 26 4.7 21.7 4.7 16c0-5.1 3.4-9.4 8.1-10.8M20 9.7l-2.6-4.4 4.5-2.8m-4.5 2.8c5.6.7 9.9 5 9.9 10.7 0 5.1-3.4 9.4-8.1 10.8"},null,-1),$=[y];function k(o,i){return a(),_("svg",w,$)}const b={render:k};const R={components:{ReloadIcon:L(b,"Loading…")}};function C(o,i,g,u,e,f){const t=c("ReloadIcon");return a(),h(t)}const E=m(R,[["render",C],["__scopeId","data-v-a882068f"]]),S=`<script>
