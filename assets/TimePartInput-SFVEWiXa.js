import{C as c}from"./CodeExample-Py2TKdaF.js";import{T as v}from"./TimePartInput-VJ6J0jyC.js";import{L as g}from"./Label-Exjz1Y0V.js";import{_ as f,r as h,o as b,c as w,b as n,d as t,w as a,t as u,e as o,p as V,f as x}from"./index-RyhvXRhb.js";import"./arrow-dropdown-qSe9iu7R.js";const y=`<script>
...
`,k=`<Label text="Hours">
  <TimePartInput
    ...
    @bounds="hoursBound"
  />
</Label>`,I={components:{TimePartInput:v,CodeExample:c,Label:g},data(){return{codeExample:k,hours:18,minutes:53,seconds:22,milliseconds:320}},computed:{code(){return y}},methods:{hoursBound(){this.hours=0},minutesBound(){this.minutes=0},secondsBound(){this.seconds=0},millisecondsBound(){this.milliseconds=0}}},_=m=>(V("data-v-96279786"),m=m(),x(),m),N=_(()=>n("div",{class:"grid-container"},[n("div",{class:"grid-item-12"},[n("p",null,[o(" A number input field similar to the NumberInput component but for time units like hours, minutes, seconds and milliseconds. It acts as a form element, so it emits "),n("code",null,"input"),o(" events and it has a "),n("code",null,"value"),o(". It also has "),n("code",null,"min"),o(" & "),n("code",null,"max"),o(" property to set bounds and a "),n("code",null,"bounds"),o(" event to determine what should happen if a bound is reached. ")])])],-1)),E={class:"grid-container"},T={class:"grid-item-6 inputs"},B={class:"grid-item-4"},S={class:"grid-container"},A={class:"grid-item-12"};function D(m,i,L,C,e,d){const l=h("TimePartInput",!0),r=h("Label"),p=h("CodeExample");return b(),w("div",null,[n("section",null,[N,n("div",E,[n("div",T,[t(r,{text:"Hours",large:""},{default:a(()=>[t(l,{modelValue:e.hours,"onUpdate:modelValue":i[0]||(i[0]=s=>e.hours=s),type:"integer",min:0,max:23,"min-digits":2,onBounds:d.hoursBound},null,8,["modelValue","onBounds"])]),_:1}),t(r,{text:"Minutes",large:""},{default:a(()=>[t(l,{modelValue:e.minutes,"onUpdate:modelValue":i[1]||(i[1]=s=>e.minutes=s),type:"integer",min:0,max:59,"min-digits":2,onBounds:d.minutesBound},null,8,["modelValue","onBounds"])]),_:1}),t(r,{text:"Seconds",large:""},{default:a(()=>[t(l,{modelValue:e.seconds,"onUpdate:modelValue":i[2]||(i[2]=s=>e.seconds=s),type:"integer",min:0,max:59,"min-digits":2,onBounds:d.secondsBound},null,8,["modelValue","onBounds"])]),_:1}),t(r,{text:"Milliseconds",large:""},{default:a(()=>[t(l,{modelValue:e.milliseconds,"onUpdate:modelValue":i[3]||(i[3]=s=>e.milliseconds=s),type:"integer",min:0,max:999,"min-digits":3,onBounds:d.millisecondsBound},null,8,["modelValue","onBounds"])]),_:1}),t(r,{text:"Disabled",large:""},{default:a(()=>[t(l,{modelValue:e.milliseconds,"onUpdate:modelValue":i[4]||(i[4]=s=>e.milliseconds=s),disabled:"",type:"integer","min-digits":3},null,8,["modelValue"])]),_:1}),t(r,{text:"Compact"},{default:a(()=>[t(l,{modelValue:e.milliseconds,"onUpdate:modelValue":i[5]||(i[5]=s=>e.milliseconds=s),compact:"",type:"integer","min-digits":3},null,8,["modelValue"])]),_:1})]),n("div",B," Time: "+u(e.hours)+"h : "+u(e.minutes)+"m : "+u(e.seconds)+"s : "+u(e.milliseconds)+"ms ",1)])]),n("section",null,[n("div",S,[n("div",A,[t(p,{summary:"Show usage example"},{default:a(()=>[o(u(e.codeExample),1)]),_:1}),t(p,{summary:"Show TimeInputPart.vue source code"},{default:a(()=>[o(u(d.code),1)]),_:1})])])])])}const R=f(I,[["render",D],["__scopeId","data-v-96279786"]]);export{R as default};
