import{C as b}from"./CodeExample-efad5ad4.js";import{_ as y,a1 as C,r,o as s,c as g,u as k,j as h,l as f,n as A,F as x,g as I,w as d,e as i,t as p,y as T,b as e,d as m}from"./index-cffca2e2.js";const w={components:{CheckIcon:C},props:{clickable:{type:Boolean,default:!1},active:{type:Boolean,default:!1}}};function M(a,o,n,_,u,t){const l=r("CheckIcon");return s(),g("span",{class:A(["tag",{clickable:n.clickable,active:n.active}])},[k(a.$slots,"default",{},void 0,!0),n.clickable&&n.active?(s(),h(l,{key:0,class:"checkmark"})):f("",!0)],2)}const B=y(w,[["render",M],["__scopeId","data-v-abae0a5e"]]);const O=5,S={components:{Tag:B},props:{numberOfInitialTags:{type:Number,default:O},tags:{type:Array,default:()=>[]},activeTags:{type:Array,default:()=>[]},clickable:{type:Boolean,default:!1}},emits:["click"],data(){return{displayAll:!1}},computed:{tagsToDisplay(){let a=this.tags;return this.displayAll||(a=this.tags.slice(0,this.numberOfInitialTags)),a.map(o=>({isActive:this.activeTags.includes(o),name:o}))},hasMoreTags(){return!this.displayAll&&this.tags.length>this.numberOfInitialTags}},hasMoreTags(){return!this.displayAll&&this.tags.length>this.numberOfInitialTags},methods:{onClick(a){this.clickable&&this.$emit("click",a)},onShowMore(){this.displayAll=!0}}},L={key:0,class:"wrapper"};function $(a,o,n,_,u,t){const l=r("Tag");return n.tags.length?(s(),g("div",L,[(s(!0),g(x,null,I(t.tagsToDisplay,(c,v)=>(s(),h(l,{key:v,active:c.isActive,clickable:n.clickable,onClick:T(H=>t.onClick(c.name),["prevent"])},{default:d(()=>[i(p(c.name)+" ",1),k(a.$slots,"icon",{},void 0,!0)]),_:2},1032,["active","clickable","onClick"]))),128)),t.hasMoreTags?(s(),h(l,{key:0,class:"more-tags",onClick:T(t.onShowMore,["prevent"])},{default:d(()=>[i(" +"+p(n.tags.length-n.numberOfInitialTags),1)]),_:1},8,["onClick"])):f("",!0)])):f("",!0)}const D=y(S,[["render",$],["__scopeId","data-v-b5e63502"]]),E=`<script>
