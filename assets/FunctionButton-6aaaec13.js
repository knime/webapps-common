import{C as b}from"./CodeExample-1542de26.js";import{o as h,c as m,b as t,_,s as B,L as x,r as s,d as n,w as e,e as l,t as d,p as k,f as w}from"./index-aff85381.js";import{b as y}from"./BaseButton-41c4bf68.js";import{M as F}from"./menu-options-c7e85693.js";const I=`<script>
...
`,T={components:{FunctionButton:B,MenuOptionsIcon:F,LensIcon:x,SorterIcon:E,CodeExample:b},data(){return{functionButtonCode:I,baseButtonCode:y,codeExample:L,active1:!1,active2:!1,active3:!1,subMenuItems:[{href:"https://apple.com",text:"Apples"},{href:"https://en.wikipedia.org/wiki/Orange_(colour)",text:"Oranges"},{to:"/testing-nuxt-link",text:"Ananas"}]}}},a=i=>(k("data-v-ecea09bf"),i=i(),w(),i),V={class:"grid-container"},$={class:"grid-item-12"},A=a(()=>t("p",null," The function button is a button with an optional active state, e.g. when a dropdown menu is expanded and can also be disabled. ",-1)),D=a(()=>t("p",null," Its primary use is together with the SubMenu component where it is included, but can also be used standalone. Works with an icon & text combination or a single icon. ",-1)),N={class:"align-horizontal"},z=a(()=>t("span",null,"Function",-1)),W=a(()=>t("span",null,"Function",-1)),j=a(()=>t("span",null,"Disabled Function",-1));function q(i,r,G,H,o,J){const g=s("LensIcon"),c=s("FunctionButton",!0),f=s("MenuOptionsIcon"),p=s("SorterIcon"),u=s("CodeExample");return h(),m("section",null,[t("div",V,[t("div",$,[A,D,t("div",N,[n(c,{active:o.active1,onClick:r[0]||(r[0]=v=>o.active1=!o.active1)},{default:e(()=>[n(g),z]),_:1},8,["active"]),n(c,{active:o.active2,onClick:r[1]||(r[1]=v=>o.active2=!o.active2)},{default:e(()=>[n(f)]),_:1},8,["active"]),n(c,{active:o.active3,onClick:r[2]||(r[2]=v=>o.active3=!o.active3)},{default:e(()=>[W,n(p)]),_:1},8,["active"]),n(c,{primary:""},{default:e(()=>[n(f)]),_:1}),n(c,{disabled:""},{default:e(()=>[j,n(p)]),_:1})]),n(u,{summary:"Show usage example"},{default:e(()=>[l(d(o.codeExample),1)]),_:1}),n(u,{summary:"Show FunctionButton.vue source code"},{default:e(()=>[l(d(o.functionButtonCode),1)]),_:1}),n(u,{summary:"Show BaseButton.vue source code"},{default:e(()=>[l(d(o.baseButtonCode),1)]),_:1})])])])}const U=_(T,[["render",q],["__scopeId","data-v-ecea09bf"]]);export{U as default};
