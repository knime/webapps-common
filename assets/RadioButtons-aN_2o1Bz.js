import{C as f}from"./CodeExample-rABFehML.js";import{B as g}from"./BaseRadioButtons-rif9tJFE.js";import{_ as b,r as u,o as v,j as B,n as _,c as y,b as e,d,t as c,w as m,e as i,p as V,f as w}from"./index-3TViJsqC.js";const z={components:{BaseRadioButtons:g},props:{id:{type:String,default:null},modelValue:{type:String,default:""},disabled:{default:!1,type:Boolean},possibleValues:{type:Array,default:()=>[]},alignment:{type:String,default:"horizontal",validator(n){return["horizontal","vertical"].includes(n)}}},emits:["update:modelValue"],methods:{hasSelection(){return this.$refs.radioButton.$refs.input.some(n=>n.checked)}}};function k(n,t,a,x,o,p){const l=u("BaseRadioButtons");return v(),B(l,{id:a.id,ref:"radioButton","possible-values":a.possibleValues,"model-value":a.modelValue,disabled:a.disabled,class:_(["radio-buttons",a.alignment,{disabled:a.disabled}]),"onUpdate:modelValue":t[0]||(t[0]=r=>n.$emit("update:modelValue",r))},null,8,["id","possible-values","model-value","disabled","class"])}const S=b(z,[["render",k],["__scopeId","data-v-f71b4063"]]),R=`<script>
