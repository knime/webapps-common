import{C as l}from"./CodeExample-Ny8umjhX.js";import{B as i}from"./Button-bCMGuklS.js";import{u as j,ap as _,o as I,c as A,b as t,t as p,Z as n,d as o,w as s,e as a,a as u,aq as N,p as R,f as $,_ as B}from"./index-Plvkd8dc.js";const q=`import type { App, Plugin } from "vue";
...
`,E=`import type { ComputedRef, FunctionalComponent, SVGAttributes } from "vue";
...
`,m=d=>(R("data-v-14cf7ebe"),d=d(),$(),d),O=u('<section data-v-14cf7ebe><div class="grid-container" data-v-14cf7ebe><div class="grid-item-12" data-v-14cf7ebe><p data-v-14cf7ebe> This framework provides a simple and versatile API that enables the use of toast-style notifications. It&#39;s Vuex/Pinia-agnostic, Nuxt 3-ready, and supports both Composition API and Options API approaches. Multiple toast services can be used in the same project. A toast service is a combination of a reactive array of toast objects and methods for mutating the array. </p><p data-v-14cf7ebe> You are able to import all of the public-facing components of the framework, including types, from <code data-v-14cf7ebe>webapps-common/ui/services/toast</code>. </p><p data-v-14cf7ebe> To use the toast service in your project, follow these steps (see the example section below for detailed coverage of various use-cases): </p><ol data-v-14cf7ebe><li data-v-14cf7ebe> Import and instantiate the <code data-v-14cf7ebe>ToastServiceProvider</code> class in the <code data-v-14cf7ebe>setup</code> section of the root component of your project (e.g. <code data-v-14cf7ebe>App.vue</code>). The class instance will create a new toast service. </li><li data-v-14cf7ebe> In the same <code data-v-14cf7ebe>setup</code> section, provide the toast service to the downstream components of the application by calling the <code data-v-14cf7ebe>toastServiceProvider.useToastService()</code> method. </li><li data-v-14cf7ebe> Either in the root component, or in a downstream component, import the <code data-v-14cf7ebe>ToastStack</code> component and place it in the <code data-v-14cf7ebe>template</code> section. Currently, the stack is bound to the bottom left corner of its parent and the position is not adjustable. </li><li data-v-14cf7ebe> Whenever a component needs to e.g. display a toast notification, import the <code data-v-14cf7ebe>useToasts</code> composable, which returns the toast service object containing the <code data-v-14cf7ebe>show</code> function. Make sure to call the composable in the <code data-v-14cf7ebe>setup</code> section of the component. </li><li data-v-14cf7ebe> Use the retrieved service properties, e.g. <code data-v-14cf7ebe>show</code>, anywhere in the component to modify the toast stack. </li></ol></div></div></section>',1),F={class:"grid-container"},V={class:"grid-item-12"},U=m(()=>t("h4",null,"Interactive demo",-1)),G=m(()=>t("p",null," This application has a toast service integrated. You can see it in action by spawning toast notifications using the buttons below. ",-1)),W=m(()=>t("h5",null,"Basic examples",-1)),D={class:"grid-container"},M={class:"wrapper"},Y=m(()=>t("h5",null,"Additional features",-1)),L={class:"grid-container"},H={class:"wrapper"},X=m(()=>t("h5",null,"Stack control",-1)),Z={class:"grid-container"},z={class:"wrapper"},J=u('<section data-v-14cf7ebe><div class="grid-container" data-v-14cf7ebe><div class="grid-item-12" data-v-14cf7ebe><h4 data-v-14cf7ebe>Usage guidelines</h4><p data-v-14cf7ebe> To make the UX consistent, please try to adhere to the following usage guidelines: </p><ul data-v-14cf7ebe><li data-v-14cf7ebe> Omit periods from <code data-v-14cf7ebe>headlines</code>, e.g. &quot;Action performed.&quot; -&gt; &quot;Action performed&quot;. </li><li data-v-14cf7ebe>Ensure <code data-v-14cf7ebe>messages</code> end with a period.</li><li data-v-14cf7ebe> Use the <code data-v-14cf7ebe>type</code> of the toast to convey success/error information, instead of explicitly stating it in the <code data-v-14cf7ebe>headline</code>, e.g. &quot;Successfully created space&quot; -&gt; &quot;Space created&quot;. </li><li data-v-14cf7ebe> Refrain from using &quot;was&quot; when referring to completed actions, e.g. &quot;Space was created&quot; -&gt; &quot;Space created&quot;. </li><li data-v-14cf7ebe> Toasts with important information should be persistent, i.e. <code data-v-14cf7ebe>autoRemove</code> set to <code data-v-14cf7ebe>false</code>. </li></ul></div></div></section>',1),K={class:"grid-container"},Q={class:"grid-item-12"},ee=m(()=>t("h4",null,"Usage examples",-1)),te=`
...
`,ne=`
  ...
  <\/script>
`,ie=j({__name:"ToastService",setup(d){const{toasts:v,show:r,autoRemove:h,removeAll:b}=_(),f={type:"info",message:"This is an info toast."},y={type:"error",message:"This is an error toast."},g={type:"warning",message:"This is a warning toast."},T={type:"success",message:"This is a success toast."},S={type:"success",message:"This is a super massive toast with lots of text. ".repeat(10)},w={type:"success",message:"This is a persistent toast that needs to be manually dismissed.",autoRemove:!1},k={type:"success",headline:"This toast has no message"},P={type:"info",message:"This toast has a link as a button.",buttons:[{text:"Click me",href:"https://www.example.com"}]},C={type:"success",headline:"Secret toast",message:"Congratulations, you found me!"},x={type:"warning",message:"This toast has a callback as a button.",buttons:[{text:"Click me",callback:()=>r(C),icon:N}]};return(re,e)=>(I(),A("div",null,[O,t("section",null,[t("div",F,[t("div",V,[U,G,t("p",null,[t("b",null,"Current number of toasts in the stack: "+p(n(v).length),1)]),W,t("div",D,[t("div",M,[o(i,{"with-border":"",compact:"",onClick:e[0]||(e[0]=c=>n(r)(f))},{default:s(()=>[a("Info toast")]),_:1}),o(i,{"with-border":"",compact:"",onClick:e[1]||(e[1]=c=>n(r)(y))},{default:s(()=>[a("Error toast")]),_:1}),o(i,{"with-border":"",compact:"",onClick:e[2]||(e[2]=c=>n(r)(g))},{default:s(()=>[a("Warning toast")]),_:1}),o(i,{"with-border":"",compact:"",onClick:e[3]||(e[3]=c=>n(r)(T))},{default:s(()=>[a("Success toast")]),_:1})])]),Y,t("div",L,[t("div",H,[o(i,{"with-border":"",compact:"",onClick:e[4]||(e[4]=c=>n(r)(S))},{default:s(()=>[a("Toast with a truncated message")]),_:1}),o(i,{"with-border":"",compact:"",onClick:e[5]||(e[5]=c=>n(r)(w))},{default:s(()=>[a("Persistent toast")]),_:1}),o(i,{"with-border":"",compact:"",onClick:e[6]||(e[6]=c=>n(r)(k))},{default:s(()=>[a("Toast with only a headline")]),_:1}),o(i,{"with-border":"",compact:"",onClick:e[7]||(e[7]=c=>n(r)(P))},{default:s(()=>[a("Toast with a hyperlink")]),_:1}),o(i,{"with-border":"",compact:"",onClick:e[8]||(e[8]=c=>n(r)(x))},{default:s(()=>[a("Toast with a callback")]),_:1})])]),X,t("div",Z,[t("div",z,[o(i,{"with-border":"",compact:"",onClick:e[9]||(e[9]=c=>n(h)())},{default:s(()=>[a("Remove toasts with timer")]),_:1}),o(i,{"with-border":"",compact:"",onClick:e[10]||(e[10]=c=>n(b)())},{default:s(()=>[a("Remove all toasts")]),_:1})])])])])]),J,t("section",null,[t("div",K,[t("div",Q,[ee,o(l,{summary:"Show example of using via composables"},{default:s(()=>[a(p(te))]),_:1}),o(l,{summary:"Show example of using as plugin"},{default:s(()=>[a(p(oe))]),_:1}),o(l,{summary:"Show example of using from a store"},{default:s(()=>[a(p(se))]),_:1}),o(l,{summary:"Show example of using multiple services via composables"},{default:s(()=>[a(p(ae))]),_:1}),o(l,{summary:"Show example of using multiple services as plugin"},{default:s(()=>[a(p(ne))]),_:1}),o(l,{summary:"Show toast-service.ts source code"},{default:s(()=>[a(p(n(q)),1)]),_:1}),o(l,{summary:"Show types.ts source code"},{default:s(()=>[a(p(n(E)),1)]),_:1})])])])]))}}),me=B(ie,[["__scopeId","data-v-14cf7ebe"]]);export{me as default};
