import{C as b}from"./CodeExample-ClSnFocq.js";import{x as B,T as f,_ as c,r as u,o as d,j as y,w as n,d as t,z as h,k,c as v,b as s,e as l,t as i}from"./index-0_Yj47UV.js";import{P as x}from"./plus-small-BUf-C0dR.js";import{B as C}from"./Button-9OvuA-HZ.js";const $=B({name:"PlusButton",components:{Button:C,Tooltip:f,PlusIcon:x},inheritAttrs:!1,props:{title:{type:String,default:null}}});function g(a,p,m,_,r,P){const o=u("PlusIcon"),e=u("Button");return d(),y(k(a.title?"Tooltip":"div"),{text:a.title},{default:n(()=>[t(e,h({class:"plus-button"},a.$attrs),{default:n(()=>[t(o)]),_:1},16)]),_:1},8,["text"])}const w=c($,[["render",g],["__scopeId","data-v-23fb968f"]]),E="",S="",I=`
