import{C as f}from"./CodeExample-83ed4e50.js";import{B as x}from"./BaseRadioButtons-7289ddd6.js";import{_ as b,r as u,o as h,j as g,n as B,c as _,b as e,d as s,t as c,w as m,e as i}from"./index-ae19d8f6.js";const y={components:{BaseRadioButtons:x},props:{id:{type:String,default:null},modelValue:{type:String,default:""},disabled:{default:!1,type:Boolean},possibleValues:{type:Array,default:()=>[]},alignment:{type:String,default:"horizontal",validator(a){return["horizontal","vertical"].includes(a)}}},emits:["update:modelValue"],methods:{hasSelection(){return this.$refs.radioButton.$refs.input.some(a=>a.checked)}}};function V(a,n,t,v,o,p){const d=u("BaseRadioButtons");return h(),g(d,{id:t.id,ref:"radioButton","possible-values":t.possibleValues,"model-value":t.modelValue,disabled:t.disabled,class:B(["radio-buttons",t.alignment,{disabled:t.disabled}]),"onUpdate:modelValue":n[0]||(n[0]=r=>a.$emit("update:modelValue",r))},null,8,["id","possible-values","model-value","disabled","class"])}const w=b(y,[["render",V],["__scopeId","data-v-c2bc4aba"]]),k=`<script>
