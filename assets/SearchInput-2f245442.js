import{C as m}from"./CodeExample-97c88502.js";import{F as v}from"./filter-65011bc1.js";import{_ as S,a6 as f,o as I,c as g,b as t,d as o,e as l,w as r,t as c,r as u,p as V,f as w}from"./index-72804bcd.js";const b=`<script>
...
<SearchInput
  ...
  @focus="onFocus"
/>
`,F={components:{SearchInput:f,FilterIcon:v,CodeExample:m},data(){return{codeExample:B,inputValue:"",inputValue2:"",inputValue3:"Demo",inputValue4:"",inputValue5:"Demo"}},computed:{code(){return b}},methods:{alert(a){window.alert(a)}}},_=a=>(V("data-v-6c8d7767"),a=a(),w(),a),y=_(()=>t("div",{class:"grid-container"},[t("div",{class:"grid-item-12"},[t("p",null,[l(" Single line string search input with search icon and clear button. It acts as a form element, so it emits "),t("code",null,"input"),l(" events and it has a "),t("code",null,"value"),l(". Optionally, buttons for case-sensitive search and inverse searchc an be shown. ")])])],-1)),C={class:"grid-container"},x={class:"grid-item-6 inputs"},k={class:"grid-item-6"},U={class:"grid-container"},E={class:"grid-item-12"};function L(a,e,P,T,n,d){const i=u("SearchInput",!0),h=u("FilterIcon"),p=u("CodeExample");return I(),g("div",null,[t("section",null,[y,t("div",C,[t("div",x,[o(i,{modelValue:n.inputValue,"onUpdate:modelValue":e[0]||(e[0]=s=>n.inputValue=s),label:"Search things",placeholder:"Placeholder"},null,8,["modelValue"]),o(i,{modelValue:n.inputValue2,"onUpdate:modelValue":e[1]||(e[1]=s=>n.inputValue2=s)},null,8,["modelValue"]),o(i,{"model-value":"disabled: no search possible here",disabled:""}),l(' The clear-all button emits a "clear" event that can be listend to: '),o(i,{modelValue:n.inputValue3,"onUpdate:modelValue":e[2]||(e[2]=s=>n.inputValue3=s),placeholder:"Placeholder",onClear:e[3]||(e[3]=s=>d.alert("Search cleared"))},null,8,["modelValue"]),l(" It's possible to use a different icon: "),o(i,{modelValue:n.inputValue4,"onUpdate:modelValue":e[4]||(e[4]=s=>n.inputValue4=s),placeholder:"A different icon",onFocus:a.onFocus},{icon:r(()=>[o(h)]),_:1},8,["modelValue","onFocus"]),l(" Buttons for the search options case-sensitivity and inverse-search can be displayed. "),o(i,{modelValue:n.inputValue5,"onUpdate:modelValue":e[5]||(e[5]=s=>n.inputValue5=s),"show-case-sensitive-search-button":!0,"show-inverse-search-button":!0,"initial-inverse-search":!0,placeholder:"Search",onFocus:a.onFocus},null,8,["modelValue","onFocus"])]),t("div",k,"input value: "+c(n.inputValue),1)])]),t("section",null,[t("div",U,[t("div",E,[o(p,{summary:"Show usage example"},{default:r(()=>[l(c(n.codeExample),1)]),_:1}),o(p,{summary:"Show SearchInput.vue source code"},{default:r(()=>[l(c(d.code),1)]),_:1})])])])])}const O=S(F,[["render",L],["__scopeId","data-v-6c8d7767"]]);export{O as default};
