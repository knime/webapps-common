import{B as C,M as L,a as $}from"./Message-2e3bca97.js";import{_ as w,r as m,o as s,j as t,w as a,c as f,F as M,g as D,k as h,n as v,e as y,t as k,l as E,Z as I,m as d,d as g,b as n}from"./index-2c1c3ffa.js";import{B as u}from"./bulb-dfa4f421.js";import{C as S}from"./CodeExample-cb06e525.js";import"./Button-67c08039.js";import"./Collapser-9a1e2de3.js";import"./arrow-dropdown-11bcb03f.js";import"./ExpandTransition-8792b9f0.js";const T={components:{BaseMessage:C,Message:L,MessageLink:$},props:{messages:{type:Array,default:()=>[]}},emits:["copied","dismiss"]};function V(o,i,c,b,r,_){const p=m("BaseMessage"),l=m("MessageLink"),x=m("Message");return s(),t(I,{class:v([{active:c.messages.length>0},"messages"]),tag:"div",name:"messages"},{default:a(()=>[(s(!0),f(M,null,D(c.messages,e=>(s(),f(M,{key:e.id},[e.content?(s(),t(p,{key:0,type:e.type.toLowerCase()},{default:a(()=>[(s(),t(h(e.content)))]),_:2},1032,["type"])):(s(),t(x,{key:1,type:e.type.toLowerCase(),count:e.count,button:e.button,details:e.details,"show-close-button":e.showCloseButton,"show-collapser":e.showCollapser,class:v({"offset-details":e.icon}),onCopied:i[0]||(i[0]=B=>o.$emit("copied")),onDismiss:B=>o.$emit("dismiss",e.id)},{icon:a(()=>[(s(),t(h(e.icon)))]),default:a(()=>[y(" "+k(e.message)+" ",1),e.link?(s(),t(l,{key:0,link:e.link},null,8,["link"])):E("",!0)]),_:2},1032,["type","count","button","details","show-close-button","show-collapser","class","onDismiss"]))],64))),128))]),_:1},8,["class"])}const N=w(T,[["render",V],["__scopeId","data-v-ad8de576"]]),W=`<script>
