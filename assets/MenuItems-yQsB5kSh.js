import{C as y}from"./CodeExample-uqlLlHR2.js";import{_}from"./MenuItems.vue_vue_type_style_index_0_lang-KsN9ejOj.js";import{S as u,H as v}from"./star-gbOviI1p.js";import{o as w,c as x,b as e,m as i,_ as C,r as g,d as r,t as l,w as f,e as c,p as M,f as S}from"./index-AXHW_TGA.js";import{L as h,H as E}from"./heart-rc_VS3pb.js";import"./Checkbox-22qrndbn.js";import"./arrow-next--yHnwvrx.js";const T={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},A=e("path",{d:"M23.3 22.7c3.6-.4 6.4-3.5 6.4-7.2 0-4-3.3-7.3-7.3-7.3h-.5c-1.1-3.2-4.1-5.5-7.7-5.5C9.7 2.8 6 6.4 6 10.9c0 .4 0 .8.1 1.2-2.2.7-3.7 2.8-3.7 5.2 0 3 2.4 5.5 5.5 5.5h.9m7.2-6v12.4m4-4-4 4-4-4"},null,-1),H=[A];function W(n,o){return w(),x("svg",T,[...H])}const B={render:W},N=`<script setup lang="ts">
/**
