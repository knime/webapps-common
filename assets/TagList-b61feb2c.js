import{C as v}from"./CodeExample-ce65ae3a.js";import{_ as m,o as l,c,u as b,n as C,r as u,F as x,g as w,j as h,w as r,e as s,t as d,y,l as T,b as a,d as p}from"./index-aa2cfa53.js";const I={props:{clickable:{type:Boolean,default:!1}}};function A(e,f,t,_,g,n){return l(),c("span",{class:C(["tag",{clickable:t.clickable}])},[b(e.$slots,"default",{},void 0,!0)],2)}const M=m(I,[["render",A],["__scopeId","data-v-4a32b85c"]]);const $=5,L={components:{Tag:M},props:{numberOfInitialTags:{type:Number,default:$},tags:{type:Array,default:()=>[]},clickable:{type:Boolean,default:!1}},emits:["click"],data(){return{displayAll:!1}},computed:{tagsToDisplay(){return this.displayAll?this.tags:this.tags.slice(0,this.numberOfInitialTags)},hasMoreTags(){return!this.displayAll&&this.tags.length>this.numberOfInitialTags}},methods:{onClick(e){this.clickable&&this.$emit("click",e)},onShowMore(){this.displayAll=!0}}},S={key:0,class:"wrapper"};function B(e,f,t,_,g,n){const o=u("Tag");return t.tags.length?(l(),c("div",S,[(l(!0),c(x,null,w(n.tagsToDisplay,(i,k)=>(l(),h(o,{key:k,clickable:t.clickable,onClick:y(q=>n.onClick(i),["prevent"])},{default:r(()=>[s(d(i)+" ",1),b(e.$slots,"icon",{},void 0,!0)]),_:2},1032,["clickable","onClick"]))),128)),n.hasMoreTags?(l(),h(o,{key:0,class:"more-tags",onClick:y(n.onShowMore,["prevent"])},{default:r(()=>[s(" +"+d(t.tags.length-t.numberOfInitialTags),1)]),_:1},8,["onClick"])):T("",!0)])):T("",!0)}const O=m(L,[["render",B],["__scopeId","data-v-1e8fbcf3"]]),D=`<script>
