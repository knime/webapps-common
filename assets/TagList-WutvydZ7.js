...
`,N=`<TagList
  ...
  @click="onTagClick"
/>`,G={components:{TagList:D,CodeExample:b},data(){return{codeExample:N}},computed:{code(){return E}},methods:{onTagClick(a){alert(`clicked tag: ${a}`)}}},P=e("div",{class:"grid-container"},[e("div",{class:"grid-item-12"},[e("p",null,[i(" Displays a list of tags with support for only showing a maximal number of tags via the "),e("code",null,"numberOfInitialTags"),i(" prop. Optionally it is possible to display active tags. Tags can be clickable by enabling the "),e("code",null,"clickable"),i(" prop. ")])])],-1),V={class:"grid-container"},F={class:"grid-item-12"},j={class:"grid-container"},z={class:"grid-item-12"};function U(a,o,n,T,u,t){const l=r("TagList",!0),c=r("CodeExample");return s(),g("div",null,[e("section",null,[P,e("div",V,[e("div",F,[m(l,{tags:["Apple","Banana","Guanábana","Papaya","Mango","Granadilla"],"number-of-initial-tags":3,clickable:"","active-tags":"['Banana', 'Papaya']",onClick:t.onTagClick},null,8,["onClick"])])])]),e("section",null,[e("div",j,[e("div",z,[m(c,{summary:"Show usage example"},{default:d(()=>[i(p(u.codeExample),1)]),_:1}),m(c,{summary:"Show TagList.vue source code"},{default:d(()=>[i(p(t.code),1)]),_:1})])])])])}const K=y(G,[["render",U]]);export{K as default};
