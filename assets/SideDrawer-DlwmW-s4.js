import{C as f}from"./CodeExample-I3gU61C0.js";import{i as y,o as m,l as S,w as o,c as x,h as g,b as e,H as C,m as E,R as b,_ as w,G as D,r as u,d,e as i,t as n,p as B,f as k}from"./index-CPQ6JZIw.js";const I={class:"content"},M={},O=y({...M,__name:"SideDrawer",props:{isExpanded:{type:Boolean,default:!1},styleOverrides:{default:()=>({position:"fixed",width:"500px"})}},setup(a){return(s,v)=>(m(),S(b,{name:"slide"},{default:o(()=>[s.isExpanded?(m(),x("div",{key:0,class:"side-drawer",style:g({"--position-common-side-drawer":s.styleOverrides.position,"--width-common-side-drawer":s.styleOverrides.width})},[e("div",I,[C(s.$slots,"default",{},void 0,!0)])],4)):E("",!0)]),_:3}))}}),q=w(O,[["__scopeId","data-v-966ea7b5"]]),N="",V=`<script>
