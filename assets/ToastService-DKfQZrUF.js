var N=Object.defineProperty;var B=(n,l,e)=>l in n?N(n,l,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[l]=e;var q=(n,l,e)=>B(n,typeof l!="symbol"?l+"":l,e);import{o as u,c as v,b as o,h as V,aU as O,i as M,R as A,t as c,l as k,F as C,e as a,f as H,d as r,w as d,u as s,a8 as L,C as m,_ as F,a9 as W,aV as z,a as D,aW as Y}from"./index-hNAqSa_B.js";import{C as g}from"./CodeExample-DCuxD_FD.js";const X={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"};function G(n,l){return u(),v("svg",X,l[0]||(l[0]=[o("path",{d:"M11.672 7.407h17.312V29.5H11.672zm8.656 0V2.5H3.016v22.093h8.656V7.407z"},null,-1)]))}const J={render:G},K={class:"wrapper"},Q={class:"title"},Z={key:1,class:"additional-info"},_={key:0,class:"details"},tt={key:1,class:"details-list"},et={key:1},ot={class:"copy-button-wrapper"},st=V({__name:"RFCErrorToastTemplate",props:{headline:{},title:{},details:{},status:{},date:{},requestId:{},errorId:{}},emits:["showMore"],setup(n,{emit:l}){const e=n,w=l,{copy:P,copied:$}=O({copiedDuring:3e3}),y=M(!1),I={year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"numeric",second:"numeric",hour12:!0},T=A(()=>new Intl.DateTimeFormat(void 0,I).format(e.date)),x=A(()=>{var f;let p="";(f=e.details)!=null&&f.length&&(e.details.length>1?p=`
...
`:"",i}),j=()=>{P(x.value)},E=()=>{y.value=!0,w("showMore")};return(p,i)=>{var f;return u(),v("div",K,[o("div",Q,c(e.title),1),y.value?k("",!0):(u(),v("button",{key:0,class:"show-more",onClick:E}," Show details ")),y.value?(u(),v("div",Z,[(f=e.details)!=null&&f.length?(u(),v("div",_,[i[0]||(i[0]=o("strong",null,"Details: ",-1)),e.details.length==1?(u(),v(C,{key:0},[a(c(e.details[0]),1)],64)):(u(),v("ul",tt,[(u(!0),v(C,null,H(p.details,(S,b)=>(u(),v("li",{key:b},c(S),1))),128))]))])):k("",!0),o("div",null,[i[1]||(i[1]=o("strong",null,"Status: ",-1)),a(c(p.status),1)]),o("div",null,[i[2]||(i[2]=o("strong",null,"Date: ",-1)),a(c(T.value),1)]),o("div",null,[i[3]||(i[3]=o("strong",null,"Request id: ",-1)),a(c(p.requestId),1)]),p.errorId?(u(),v("div",et,[i[4]||(i[4]=o("strong",null,"Error id: ",-1)),a(c(p.errorId),1)])):k("",!0),o("div",ot,[r(s(m),{onClick:j},{default:d(()=>[s($)?(u(),v(C,{key:0},[r(s(L),{class:"copy-icon"}),i[5]||(i[5]=a("Error was copied"))],64)):(u(),v(C,{key:1},[r(s(J),{class:"copy-icon"}),i[6]||(i[6]=a("Copy error to clipboard "))],64))]),_:1})])])):k("",!0)])}}}),at=F(st,[["__scopeId","data-v-9db428a3"]]);class U extends Error{constructor(e){super(e.title);q(this,"data");this.data=e}}const it=({headline:n,rfcError:l})=>{const{data:e}=l,w=W(at,{headline:n,...e});return{type:"error",headline:n,component:w,autoRemove:!1}},nt=n=>{if(!n.response)return n;const l=n.response.headers.get("date")?new Date(n.response.headers.get("date")):new Date,e={title:n.data.title,details:n.data.details,status:n.statusCode,date:l,requestId:n.response.headers.get("x-request-id")??"",errorId:n.response.headers.get("x-error-id")??void 0};return new U(e)},R={toToast:it,tryParse:nt,RFCError:U},rt={class:"grid-container"},dt={class:"grid-item-12"},lt={class:"grid-container"},ct={class:"wrapper"},pt={class:"grid-container"},mt={class:"wrapper"},ut={class:"grid-container"},vt={class:"wrapper"},ht={class:"grid-container"},ft={class:"grid-item-12"},gt="",wt="",yt=`
