import{C as g}from"./CodeExample-Do-NHLJM.js";import{_ as p,r as c,k as B,o as v,g as f,c as _,b as e,e as a,d,t as r,w as b}from"./index-CRVevUd2.js";import{B as V}from"./BaseRadioButtons-BGW0UUqc.js";import"./v4-BKrj-4V8.js";const z={name:"RadioButtons",components:{BaseRadioButtons:V},props:{id:{type:String,default:null},modelValue:{type:String,default:""},disabled:{default:!1,type:Boolean},possibleValues:{type:Array,default:()=>[]},alignment:{type:String,default:"horizontal",validator(n){return["horizontal","vertical"].includes(n)}}},emits:["update:modelValue"],methods:{hasSelection(){return this.$refs.radioButton.$refs.input.some(n=>n.checked)}}};function h(n,t,i,x,o,m){const l=c("BaseRadioButtons");return v(),B(l,{id:i.id,ref:"radioButton","possible-values":i.possibleValues,"model-value":i.modelValue,disabled:i.disabled,class:f(["radio-buttons",i.alignment,{disabled:i.disabled}]),"onUpdate:modelValue":t[0]||(t[0]=u=>n.$emit("update:modelValue",u))},null,8,["id","possible-values","model-value","disabled","class"])}const y=p(z,[["render",h],["__scopeId","data-v-c3c07b80"]]),R="",S=`<RadioButtons
  v-model="selected"
  :possible-values="[{
    id: 'foo',
    text: 'Foo'
