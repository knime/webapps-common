import{C as b}from"./CodeExample-Cuh2W_ci.js";import{o as p,c as m,b as t,x as A,aG as B,$ as N,y as j,t as r,l as _,F as C,e as o,g as U,d as a,w as i,M as e,ac as O,p as q,f as E,_ as D,aH as H,ae as M,a as R,aI as L}from"./index-CIvBs75e.js";import{B as d}from"./Button-CBo8HdK1.js";const z={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},W=t("path",{d:"M11.672 7.407h17.312V29.5H11.672zm8.656 0V2.5H3.016v22.093h8.656V7.407z"},null,-1),Y=[W];function G(h,n){return p(),m("svg",z,[...Y])}const X={render:G},T=h=>(q("data-v-e73dcb8f"),h=h(),E(),h),J={class:"wrapper"},K={class:"title"},Q={key:1,class:"additional-info"},Z={key:0,class:"details"},tt=T(()=>t("strong",null,"Details:",-1)),et={key:1,class:"details-list"},ot=T(()=>t("strong",null,"Status: ",-1)),st=T(()=>t("strong",null,"Date: ",-1)),at=T(()=>t("strong",null,"Request id: ",-1)),it={key:1},nt=T(()=>t("strong",null,"Error id: ",-1)),rt={class:"copy-button-wrapper"},ct=A({__name:"ApiErrorTemplate",props:{headline:{},title:{},details:{},status:{},date:{},requestId:{},errorId:{}},setup(h){const n=h,{copy:c,copied:$}=B({copiedDuring:3e3}),w=N(!1),I={year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"numeric",second:"numeric",hour12:!0},k=j(()=>new Intl.DateTimeFormat(void 0,I).format(n.date)),P=j(()=>{var f;let l="";(f=n.details)!=null&&f.length&&(n.details.length>1?l=`
