...
<NumberInput
  ...
  @input="validate3"
/>`,R={components:{NumberInput:F,CodeExample:I,Label:k},data(){return{codeExample:O,min:-1e7,max:1e7,inputValue1:0,inputValue2:"4.5324526E6",inputValue3:-15,isValid1:!0,isValid2:!0,isValid3:!0}},computed:{code(){return z},input3Text(){return this.isValid3?"Valid":"Invalid"}},mounted(){this.validate1(),this.validate2(),this.validate3()},methods:{validate1(){this.isValid1=this.$refs.input1.validate().isValid},validate2(){this.isValid2=this.$refs.input2.validate().isValid},validate3(){this.isValid3=this.$refs.input3.validate().isValid}}},v=n=>(T("data-v-a3c2fbb3"),n=n(),N(),n),H=v(()=>s("div",{class:"grid-container"},[s("div",{class:"grid-item-12"},[s("p",null,[u(" Numeric input field with either type double or integer to set the step size. Spinner controls allow the user to increment the value with the mouse or keyboard. It acts as a form element, so it emits "),s("code",null,"input"),u(" events and it has a "),s("code",null,"value"),u(". It also has a valid and invalid state for styling purposes. ")])])],-1)),G={class:"grid-container"},P={class:"grid-item-6 inputs"},Z={class:"grid-item-2"},W=v(()=>s("br",null,null,-1)),Y=v(()=>s("br",null,null,-1)),X=v(()=>s("div",{class:"grid-item-2"},[s("u",null,"All"),s("br"),u(" min: -10 "),s("br"),u(" max = 10 ")],-1)),j=v(()=>s("div",{class:"grid-item-2"},null,-1)),K={class:"grid-container"},q={class:"grid-item-12"};function J(n,e,i,y,t,a){const o=g("NumberInput",!0),l=g("Label"),w=g("CodeExample");return b(),V("div",null,[s("section",null,[H,s("div",G,[s("div",P,[r(l,{text:"Integer (step-size = 1)",large:""},{default:m(({labelForId:d})=>[r(o,{id:d,ref:"input1",modelValue:t.inputValue1,"onUpdate:modelValue":[e[0]||(e[0]=p=>t.inputValue1=p),a.validate1],min:t.min,max:t.max,"is-valid":t.isValid1,type:"integer",title:"I am the integer"},null,8,["id","modelValue","min","max","is-valid","onUpdate:modelValue"])]),_:1}),r(l,{text:"Double (step-size = .1)",large:""},{default:m(({labelForId:d})=>[r(o,{id:d,ref:"input2",modelValue:t.inputValue2,"onUpdate:modelValue":[e[1]||(e[1]=p=>t.inputValue2=p),a.validate2],min:t.min,max:t.max,"is-valid":t.isValid2,type:"double",title:"I am the double"},null,8,["id","modelValue","min","max","is-valid","onUpdate:modelValue"])]),_:1}),r(l,{text:a.input3Text,large:""},{default:m(({labelForId:d})=>[r(o,{id:d,ref:"input3",modelValue:t.inputValue3,"onUpdate:modelValue":[e[2]||(e[2]=p=>t.inputValue3=p),a.validate3],min:t.min,max:t.max,"is-valid":t.isValid3,type:"integer",title:"My starting value is invalid"},null,8,["id","modelValue","min","max","is-valid","onUpdate:modelValue"])]),_:1},8,["text"]),r(l,{text:"Disabled",large:""},{default:m(({labelForId:d})=>[r(o,{id:d,modelValue:t.inputValue1,"onUpdate:modelValue":[e[3]||(e[3]=p=>t.inputValue1=p),a.validate1],min:t.min,max:t.max,"is-valid":t.isValid1,type:"integer",title:"Disabled",disabled:""},null,8,["id","modelValue","min","max","is-valid","onUpdate:modelValue"])]),_:1})]),s("div",Z,[u(" Integer: "+h(t.inputValue1)+" ",1),W,u(" Double: "+h(t.inputValue2)+" ",1),Y,u(" "+h(a.input3Text)+": "+h(t.inputValue3),1)]),X,j])]),s("section",null,[s("div",K,[s("div",q,[r(w,{summary:"Show usage example"},{default:m(()=>[u(h(t.codeExample),1)]),_:1}),r(w,{summary:"Show NumberInput.vue source code"},{default:m(()=>[u(h(a.code),1)]),_:1})])])])])}const te=_(R,[["render",J],["__scopeId","data-v-a3c2fbb3"]]);export{te as default};
