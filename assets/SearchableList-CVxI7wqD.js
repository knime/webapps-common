import{C}from"./CodeExample-0hsQSmQx.js";import{M}from"./MultiselectListBox-nutolzGb.js";import{L as P}from"./Label-3m7G66OO.js";import{at as T,E as g,G as u,_,r as v,o as V,c as y,j as O,w as x,d as m,l as w,b as n,t as p,F as j,e as S,a as E}from"./index-zKANDt-b.js";import{u as k,a as N}from"./useSearch-hi_KnL5T.js";import{c as F}from"./createMissingItem-l6qmOyuX.js";import"./StyledListItem-pYrDRvKr.js";const U=`<script lang="ts">
...
/>
`,J={components:{SearchableList:G,CodeExample:C},data(){return{codeExample:H,selected:[],disabledSelected:[],selected2:[],disabledSelected2:[],withMissing:["foo","I am missing","bar"],bottomValueSymbol:Symbol("bottom value")}},computed:{code(){return U}}},K=E('<div class="grid-container"><div class="grid-item-12"><p> A list box for selecting multiple items which is searchable. It acts as a form element, so it emits an <code>input</code> event when something is (de-)selected, and it has a <code>value</code>. It has keyboard navigation with <code>Up</code>, <code>Down</code>, <code>Home</code>, <code>End</code>. It is possible to multi select via keyboard with <code>Shift+Up</code> and <code>Shift+Down</code>. Selective multi select is possible by <code>Ctrl+Click</code> or <code>Shift+Click</code>. Also multi select by dragging is supported. </p></div></div>',1),Q={class:"grid-container"},W={class:"grid-item-6"},X={class:"grid-item-6"},Y=n("br",null,null,-1),$=n("div",{class:"grid-container"},[n("div",{class:"grid-item-12"},[n("p",null," The SearchableList can display a bottom element (visually different but funcionally equivalent to an element lying below all other elements). The total size of the box does not depend on the bottom element (i.e. less elements are shown instead). ")])],-1),ee=n("br",null,null,-1),te={class:"grid-container"},ae={class:"grid-item-6"},ne={class:"grid-item-6"},le=n("br",null,null,-1),se={class:"grid-container"},ie={class:"grid-item-6"},oe=n("br",null,null,-1),re={class:"grid-container"},de={class:"grid-item-6"},ue=n("br",null,null,-1),ce={class:"grid-container"},me={class:"grid-item-6"},he={class:"grid-item-6"},be={class:"grid-container"},pe={class:"grid-item-12"};function ve(e,a,t,o,l,c){const d=v("SearchableList",!0),h=v("CodeExample");return V(),y("div",null,[n("section",null,[K,n("div",Q,[n("div",W,[m(d,{modelValue:l.selected,"onUpdate:modelValue":a[0]||(a[0]=s=>l.selected=s),size:4,"aria-label":"Select stuff here!","show-search":!0,"search-label":"Search items","search-placeholder":"Placeholder","with-search-label":!0,"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},...Array.from({length:100},(s,b)=>({id:`baz${b}`,text:`Baz ${b}`}))]},null,8,["modelValue","possible-values"])]),n("div",X,"selected ids: "+p(l.selected),1)]),Y,$,ee,n("div",te,[n("div",ae,[m(d,{modelValue:l.selected2,"onUpdate:modelValue":a[1]||(a[1]=s=>l.selected2=s),size:4,"aria-label":"Select stuff here!","with-bottom-value":!0,"show-search":!0,"bottom-value":{id:l.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}]},null,8,["modelValue","bottom-value"])]),n("div",ne,"selected ids: "+p(l.selected2),1)]),le,S(" Disabled "),n("div",se,[n("div",ie,[m(d,{modelValue:l.disabledSelected2,"onUpdate:modelValue":a[2]||(a[2]=s=>l.disabledSelected2=s),size:4,"aria-label":"Disabled...","with-bottom-value":"","show-search":!0,"bottom-value":{id:l.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}],disabled:""},null,8,["modelValue","bottom-value"])])]),oe,S(" Compact "),n("div",re,[n("div",de,[m(d,{modelValue:l.disabledSelected2,"onUpdate:modelValue":a[3]||(a[3]=s=>l.disabledSelected2=s),size:4,"aria-label":"Compact...","with-bottom-value":"","show-search":!0,"bottom-value":{id:l.bottomValueSymbol,text:"Custom text"},"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}],compact:""},null,8,["modelValue","bottom-value"])])]),ue,n("div",ce,[n("div",me,[m(d,{modelValue:l.withMissing,"onUpdate:modelValue":a[4]||(a[4]=s=>l.withMissing=s),size:4,"aria-label":"Disabled...","show-search":!0,"possible-values":[{id:"foo",text:"Foo"},{id:"bar",text:"Bar"},{id:"baz",text:"Baz"},{id:"baz2",text:"Baz 2"},{id:"baz3",text:"Baz 3"},{id:"baz4",text:"Baz 4"},{id:"baz5",text:"Baz 5"},{id:"baz6",text:"Baz 6"}]},null,8,["modelValue"])]),n("div",he,"selected ids: "+p(l.withMissing),1)])]),n("section",null,[n("div",be,[n("div",pe,[m(h,{summary:"Show usage example"},{default:x(()=>[S(p(l.codeExample),1)]),_:1}),m(h,{summary:"Show SearchableList.vue source code"},{default:x(()=>[S(p(c.code),1)]),_:1})])])])])}const we=_(J,[["render",ve]]);export{we as default};
