import{C as u}from"./CodeExample-97c88502.js";import{_ as h,D as m,o as v,c as f,b as e,d as l,w as i,e as t,t as s,r as d,p as g,f as x}from"./index-72804bcd.js";const _=`<script>
export default {
  props: {
    /**
...
return (new XMLSerializer()).serializeToString(svgElement);`,-1)),A=n(()=>e("p",null,[t("or "),e("code",null,"inline code")],-1)),H=n(()=>e("h5",null,"Definition list",-1)),L=n(()=>e("dl",null,[e("dt",null,"knimeNode:"),e("dd",null,"The knimeNode must have the correct namespace."),e("dt",null,"views:"),e("dd",null,"Explains what is displayed in the view.")],-1)),R={class:"grid-container"},B={class:"grid-item-12"};function $(o,P,V,K,a,c){const p=d("Description",!0),r=d("CodeExample");return v(),f("div",null,[k,e("section",w,[e("div",y,[l(p,{class:"description grid-item-12"},{default:i(()=>[S,D,E,C,N,I,M,T,z,A,H,L]),_:1})])]),e("section",null,[e("div",R,[e("div",B,[l(r,{summary:"Show usage example"},{default:i(()=>[t(s(a.codeExample),1)]),_:1}),l(r,{summary:"Show Description.vue source code"},{default:i(()=>[t(s(c.code),1)]),_:1})])])])])}const X=h(b,[["render",$],["__scopeId","data-v-bbfad9c8"]]);export{X as default};
