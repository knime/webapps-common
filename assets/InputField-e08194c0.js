import{C as y}from"./CodeExample-58ee106e.js";import{o as v,c as f,b as n,_ as I,I as _,s as w,N as k,d as e,w as a,t as p,e as u,r as d,p as b,f as V}from"./index-2e4a1f3e.js";import{C as F}from"./circle-check-5cdf4a53.js";const C={xmlns:"http://www.w3.org/2000/svg",fill:"none",stroke:"#000","stroke-linejoin":"round",viewBox:"0 0 32 32"},S=n("path",{d:"M2.5 7h27v18h-27zm22.96 3.224L16 17.771 2.5 7"},null,-1),$=[S];function B(l,t){return v(),f("svg",C,$)}const R={render:B},z=`<script>
export default {
    props: {
        modelValue: {
            default: '',
