import{C as b}from"./CodeExample-mgDbb37J.js";import{_ as p,o as m,c as f,b as e,x as w,n as x,r as h,d as i,w as c,e as l,t as g}from"./index-UkmZgG0S.js";const k={props:{id:{type:String,default:null},name:{type:String,default:null},modelValue:{type:Boolean,default:!1},labelSize:{type:String,default:"regular"}},emits:["update:modelValue"],methods:{onChange(r){let{checked:n}=r.target;consola.trace("ToggleSwitch value changed to",n),this.$emit("update:modelValue",n)},isChecked(){return this.$refs.input.checked}}},_=["id","name","checked"];function y(r,n,o,v,t,d){return m(),f("label",{class:x(["toggle",o.labelSize])},[e("input",{id:o.id,ref:"input",name:o.name,type:"checkbox",checked:o.modelValue,onChange:n[0]||(n[0]=(...a)=>d.onChange&&d.onChange(...a))},null,40,_),e("span",null,[w(r.$slots,"default",{},void 0,!0)])],2)}const S=p(k,[["render",y],["__scopeId","data-v-f388e344"]]),V=`<script>
export default {
  props: {
    id: {
      type: String,
