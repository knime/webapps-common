 ...
 */
class TableViewViewSettingsTest extends DefaultNodeSettingsSnapshotTest {

    protected TableViewViewSettingsTest() {
        super(Map.of(SettingsType.VIEW, TableViewViewSettings.class),
