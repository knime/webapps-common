...
class JsonNodeSettingsMapperUtilTest {
    ...
    private static void writeRead(final Consumer<ObjectNode> nodeCons, final Consumer<ObjectNode> schemaNodeCons,
        ...
        var schemaNode = mapper.createObjectNode().put(TAG_TYPE, TYPE_OBJECT);
    ...
    void testWriteReadDouble() throws InvalidSettingsException {
        writeRead((name, node) -> node.put(name, 42d), TYPE_NUMBER, FORMAT_DOUBLE);
    }
    ...
    void testWriteReadDoubleNull() throws InvalidSettingsException {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> writeRead(NOOP_NODE_BICONS, NOOP_NODE_CONS, expectedNodeCons, TYPE_NUMBER, FORMAT_DOUBLE));
        assertThrows(IllegalArgumentException.class, () -> writeRead((name, node) -> node.set(name, node.nullNode()),
            NOOP_NODE_CONS, expectedNodeCons, TYPE_NUMBER, FORMAT_DOUBLE));
    }

    @Test
    void testWriteReadFloat() throws InvalidSettingsException {
        writeRead((name, node) -> node.put(name, 42f), TYPE_NUMBER, FORMAT_FLOAT);
    }
    ...
    void testWriteReadFloatNull() throws InvalidSettingsException {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> writeRead(NOOP_NODE_BICONS, NOOP_NODE_CONS, expectedNodeCons, TYPE_NUMBER, FORMAT_FLOAT));
        assertThrows(IllegalArgumentException.class, () -> writeRead((name, node) -> node.set(name, node.nullNode()),
            NOOP_NODE_CONS, expectedNodeCons, TYPE_NUMBER, FORMAT_FLOAT));
    }

    @Test
    void testWriteReadInt() throws InvalidSettingsException {
        writeRead((name, node) -> node.put(name, 42), TYPE_INTEGER, FORMAT_INT);
    }
    ...
    void testWriteReadIntNull() throws InvalidSettingsException {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> writeRead(NOOP_NODE_BICONS, NOOP_NODE_CONS, expectedNodeCons, TYPE_INTEGER, FORMAT_INT));
        assertThrows(IllegalArgumentException.class, () -> writeRead((name, node) -> node.set(name, node.nullNode()),
            NOOP_NODE_CONS, expectedNodeCons, TYPE_INTEGER, FORMAT_INT));
    }

    @Test
    void testWriteReadLong() throws InvalidSettingsException {
        writeRead((name, node) -> node.put(name, 42L), TYPE_INTEGER, FORMAT_LONG);
    }
    ...
    void testWriteReadLongNull() throws InvalidSettingsException {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> writeRead(NOOP_NODE_BICONS, NOOP_NODE_CONS, expectedNodeCons, TYPE_INTEGER, FORMAT_LONG));
        assertThrows(IllegalArgumentException.class, () -> writeRead((name, node) -> node.set(name, node.nullNode()),
            NOOP_NODE_CONS, expectedNodeCons, TYPE_INTEGER, FORMAT_LONG));
    }

    @Test
    void testWriteReadBoolean() throws InvalidSettingsException {
        writeRead((name, node) -> node.put(name, true), TYPE_BOOLEAN);
    }
    ...
    void testWriteReadBooleanNull() throws InvalidSettingsException {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> writeRead(NOOP_NODE_BICONS, NOOP_NODE_CONS, expectedNodeCons, TYPE_BOOLEAN));
        assertThrows(IllegalArgumentException.class, () -> writeRead((name, node) -> node.set(name, node.nullNode()),
            NOOP_NODE_CONS, expectedNodeCons, TYPE_BOOLEAN));
    }

    @Test
    void testWriteReadArrayOfBooleans() throws InvalidSettingsException {
        writeReadArray(node -> node.add(true).add(false), TYPE_BOOLEAN);
    }

    @Test
    void testWriteReadNull() throws InvalidSettingsException {
        writeRead((name, node) -> node.set(name, node.nullNode()), TYPE_NULL);
    }

    @Test
    void testWriteReadArrayOfNulls() throws InvalidSettingsException {
        writeReadArray(node -> node.add(node.nullNode()), TYPE_NULL);
    }

    @Test
    void testWriteReadString() throws InvalidSettingsException {
        writeRead((name, node) -> node.put(name, "bar"), TYPE_STRING);
    }
    ...
    void testWriteReadStringNull() throws InvalidSettingsException {
        writeRead(NOOP_NODE_BICONS, NOOP_NODE_CONS, (name, node) -> node.set(name, node.nullNode()), TYPE_STRING);
        writeRead((name, node) -> node.set(name, node.nullNode()), TYPE_STRING);
    }

    @Test
    void testWriteReadObject() throws InvalidSettingsException {
        writeRead((name, node) -> node.putObject(name), TYPE_OBJECT);
    }

    @Test
    void testWriteReadObjectNull() throws InvalidSettingsException {
        writeRead(NOOP_NODE_BICONS, NOOP_NODE_CONS, (name, node) -> node.putObject(name), TYPE_OBJECT);
        writeRead((name, node) -> node.set(name, node.nullNode()), node -> {
            node.putObject(TAG_PROPERTIES).putObject("bar").put(TAG_TYPE, TYPE_OBJECT);
        }, (name, node) -> node.putObject(name).putObject("bar"), TYPE_OBJECT);
    }

    @Test
    void testWriteReadArrayOfObjects() throws InvalidSettingsException {
        writeReadArray(node -> node.addObject(), TYPE_OBJECT);
    }

    @Test
    void testWriteReadArrayOfObjectsNull() throws InvalidSettingsException {
        Consumer<ObjectNode> schemaNodeCons = node -> node.putObject(TAG_ITEMS).put(TAG_TYPE, TYPE_OBJECT);
    ...
    void testWriteReadArrayOfArraysOfObjects() throws InvalidSettingsException {
        writeReadArrayOfArrays(node -> node.addObject(), TYPE_OBJECT);
    }

    @Test
    void testWriteReadDoubleArray() throws InvalidSettingsException {
        writeReadArray(node -> node.add(42d), TYPE_NUMBER, FORMAT_DOUBLE);
    }
    ...
    void testWriteReadArrayOfDoubleArrays() throws InvalidSettingsException {
        writeReadArrayOfArrays(node -> node.add(42d), TYPE_NUMBER, FORMAT_DOUBLE);
    }

    @Test
    void testWriteReadFloatArray() throws InvalidSettingsException {
        writeReadArray(node -> node.add(42f), TYPE_NUMBER, FORMAT_FLOAT);
    }
    ...
    void testWriteReadArrayOfFloatArrays() throws InvalidSettingsException {
        writeReadArrayOfArrays(node -> node.add(42f), TYPE_NUMBER, FORMAT_FLOAT);
    }

    @Test
    void testWriteReadIntArray() throws InvalidSettingsException {
        writeReadArray(node -> node.add(42), TYPE_INTEGER, FORMAT_INT);
    }
    ...
    void testWriteReadArrayOfIntArrays() throws InvalidSettingsException {
        writeReadArrayOfArrays(node -> node.add(42), TYPE_INTEGER, FORMAT_INT);
    }

    @Test
    void testWriteReadLongArray() throws InvalidSettingsException {
        writeReadArray(node -> node.add(42L), TYPE_INTEGER, FORMAT_LONG);
    }
    ...
    void testWriteReadArrayOfLongArrays() throws InvalidSettingsException {
        writeReadArrayOfArrays(node -> node.add(42L), TYPE_INTEGER, FORMAT_LONG);
    }

    @Test
    void testWriteReadBooleanArray() throws InvalidSettingsException {
        writeReadArray(node -> node.add(true), TYPE_BOOLEAN);
    }
    ...
    void testWriteReadArrayOfBooleanArrays() throws InvalidSettingsException {
        writeReadArrayOfArrays(node -> node.add(true), TYPE_BOOLEAN);
    }

    @Test
    void testWriteReadStringArray() throws InvalidSettingsException {
        writeReadArray(node -> node.add("bar"), TYPE_STRING);
    }
    ...
    void testWriteReadArrayOfStringArrays() throws InvalidSettingsException {
        writeReadArrayOfArrays(node -> node.add("bar"), TYPE_STRING);
    }
    ...
    void testWriteReadObjectWithReservedFieldNames() throws InvalidSettingsException {
        writeRead(node -> {
            ...
            schemaNode.putObject(JsonNodeSettingsMapperUtil.FIELD_NAME_ARRAY_SIZE).put(TAG_TYPE, TYPE_BOOLEAN);
            schemaNode.putObject(TAG_TYPE).put(TAG_TYPE, TYPE_BOOLEAN);
            schemaNode.putObject(TAG_ONEOF).put(TAG_TYPE, TYPE_BOOLEAN);
            schemaNode.putObject(TAG_PROPERTIES).put(TAG_TYPE, TYPE_BOOLEAN);
            schemaNode.putObject(TAG_ITEMS).put(TAG_TYPE, TYPE_BOOLEAN);
            schemaNode.putObject("0").put(TAG_TYPE, TYPE_BOOLEAN);
        });
    }
    ...
    void testIllegalArgumentExceptionOnMissingItems() throws InvalidSettingsException {
        assertThrows(IllegalArgumentException.class, () -> writeRead(node -> node.putArray("foo"),
            schemaNode -> schemaNode.putObject("foo").put(TAG_TYPE, TYPE_ARRAY)));
    }
    ...
    void testIllegalArgumentExceptionOnWrongItemsType() throws InvalidSettingsException {
        assertThrows(IllegalArgumentException.class, () -> writeRead(node -> node.put("foo", true),
            schemaNode -> schemaNode.putObject("foo").put(TAG_TYPE, TYPE_ARRAY).put(TAG_ITEMS, "bar")));
    }
