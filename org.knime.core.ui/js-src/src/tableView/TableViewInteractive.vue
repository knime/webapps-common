...
export default {
    ...
    methods: {
        ...
        requestFilteredAndSortedTable(startIndex, numRows, displayedColumns, updateDisplayedColumns,
            ...
            return this.performRequest('getFilteredAndSortedTable',
                [
                    ...
                    this.searchTerm,
                    updateDisplayedColumns ? null : this.getColumnFilterValues(displayedColumns),
        ...
        getColumnFilterValues(displayedColumns) {
            return [ROW_ID.id, ...displayedColumns].map(
                colId => this.getArrayOfFilterValues(colId)
            );
        },
        ...
        onColumnSort(newColumnSortIndex, newColumnSortId) {
            ...
            this.columnSortColumnName = newColumnSortId === ROW_ID.id ? ROW_KEYS_SORT_COL_NAME : newColumnSortId;
            this.refreshTable();
        },
        ...
        getDefaultFilterConfigsMap(displayedColumns) {
            ...
            filterConfigs.set(SKIPPED_REMAINING_COLUMNS_COLUMN.id, { is: '', modelValue: '' });
            ...
            displayedColumns.forEach(col => {
                ...
                filterConfigs.set(col, createDefaultFilterConfig(domainValues, domainValuesMapped));
            });
