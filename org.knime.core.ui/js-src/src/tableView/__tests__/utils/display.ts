...
export const mountDisplay = async ({ props }: {props: TableViewDisplayProps}) => {
...
export const shallowMountDisplay = (
    { props }: {props: TableViewDisplayProps}
...
export const getDefaultProps = () : TableViewDisplayProps => {
    ...
    return {
        ...
        knimeService: { extensionConfig: { resourceInfo: { baseUrl: 'baseUrl' } } } as any,
