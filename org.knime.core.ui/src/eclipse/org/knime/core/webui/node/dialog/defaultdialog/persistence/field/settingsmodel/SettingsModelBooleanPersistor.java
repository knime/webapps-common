 ...
 */
public class SettingsModelBooleanPersistor extends NodeSettingsPersistorWithConfigKey<Boolean> {

    @Override
    public Boolean load(final NodeSettingsRO settings) throws InvalidSettingsException {
        final var model = new SettingsModelBoolean(getConfigKey(), false);
    ...
    public void save(final Boolean obj, final NodeSettingsWO settings) {
        new SettingsModelBoolean(getConfigKey(), obj).saveSettingsTo(settings);
    }
