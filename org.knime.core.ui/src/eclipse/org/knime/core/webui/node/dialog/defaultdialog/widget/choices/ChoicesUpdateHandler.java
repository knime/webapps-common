 ...
 * @param <S> the dependency settings (see {@link DialogDataServiceHandler})
 */
public interface ChoicesUpdateHandler<S> extends DialogDataServiceHandler<ChoicesWidgetChoice[], S> {
}
