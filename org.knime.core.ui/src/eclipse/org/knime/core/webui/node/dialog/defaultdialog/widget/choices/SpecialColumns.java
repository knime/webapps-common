...
public enum SpecialColumns {
        ...
        NONE("<none>", null),
        /**
         * Option for treating row keys of a table similar to all other columns
         */
        ROWID("<row-keys>", StringCell.TYPE),
        /**
    ...
    /**
     * @return the special column represented as a {@link ColumnSelection}. The compatible types are determined from its
