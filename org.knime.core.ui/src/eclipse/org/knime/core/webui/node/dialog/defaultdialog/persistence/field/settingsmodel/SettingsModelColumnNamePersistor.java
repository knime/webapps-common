 ...
 */
public class SettingsModelColumnNamePersistor extends NodeSettingsPersistorWithConfigKey<String> {
    private static final String ROW_KEYS_PLACEHOLDER = "<row-keys>";

    @Override
    public String load(final NodeSettingsRO settings) throws InvalidSettingsException {
        final var model = new SettingsModelColumnName(getConfigKey(), "");
    ...
    public void save(final String column, final NodeSettingsWO settings) {
        var sm = new SettingsModelColumnName(getConfigKey(), "");
