 ...
 */
public class SettingsModelStringPersistor extends NodeSettingsPersistorWithConfigKey<String> {
    ...
    public void save(final String obj, final NodeSettingsWO settings) {
        new SettingsModelString(getConfigKey(), obj).saveSettingsTo(settings);
    }
