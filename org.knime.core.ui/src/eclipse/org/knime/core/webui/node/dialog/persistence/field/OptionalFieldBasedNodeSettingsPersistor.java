 ...
 *
 * History
 *   18 Jan 2023 (Paul Bärnreuther): created
 */
...
/**
 * Performs persistence of DefaultNodeSettings on a per-field basis using default persistors which -for certain types-
 * set defaults for fields which are not present in the stored settings.
 *
 * @author Paul Bärnreuther
 * @param <S> The concrete {@link DefaultNodeSettings} class
 */
public final class OptionalFieldBasedNodeSettingsPersistor<S extends DefaultNodeSettings>
    extends FieldBasedNodeSettingsPersistor<S> {

    @SuppressWarnings("javadoc")
    public OptionalFieldBasedNodeSettingsPersistor(final Class<S> settingsClass) {
        super(settingsClass);
