 ...
 */
public class SettingsModelIntegerPersistor extends NodeSettingsPersistorWithConfigKey<Integer> {

    @Override
    public Integer load(final NodeSettingsRO settings) throws InvalidSettingsException {
        final var model = new SettingsModelInteger(getConfigKey(), 0);
    ...
    public void save(final Integer obj, final NodeSettingsWO settings) {
        new SettingsModelInteger(getConfigKey(), obj).saveSettingsTo(settings);
    }
