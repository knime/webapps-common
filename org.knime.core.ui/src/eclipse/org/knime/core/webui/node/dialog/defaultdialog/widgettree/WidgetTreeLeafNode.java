...
/**
 *
 * A node representing a final leaf of the widget tree, i.e. it is part of a {@link WidgetGroup} but its class is
 * neither a {@link WidgetGroup} nor an array of such.
 *
 * @author Paul Bärnreuther
 */
public final class WidgetTreeLeafNode extends WidgetTreeNode {

    WidgetTreeLeafNode(final WidgetTree parent, final Class<?> type, final Class<?> contentType, final String name,
