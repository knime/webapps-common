 ...
 */
public abstract class EnumSettingsModelStringPersistor<E extends Enum<E>>
    extends NodeSettingsPersistorWithConfigKey<E> {
    ...
    public void save(final E obj, final NodeSettingsWO settings) {
        ...
        final var model = new SettingsModelString(getConfigKey(), valueAsString);
        model.saveSettingsTo(settings);
    }

    @Override
    public E load(final NodeSettingsRO settings) throws InvalidSettingsException {
        final var model = new SettingsModelString(getConfigKey(), "");
