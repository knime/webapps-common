...
public interface PredicateProvider {
     ...
     *
     * <h5>Referencing other fields:</h5> Currently, one can create predicates on other fields of the following types:
     *
     * <ul>
     ...
     *
     * Use {@link #isMissing} to check for missing references if those are expected (this only occurrs in the special
    ...
    public interface PredicateInitializer {
         ...
         * {@link DefaultNodeSettingsContext} does not change. This way, e.g. a setting can be disabled, as long as an
         * optional input port is not present.
         *
