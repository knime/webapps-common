...
/**
 * Primitive sink node for testing with one input table input port.
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 */
public final class SinkNodeTestFactory extends NodeFactory<NodeModel> {
    ...
    public NodeModel createNodeModel() {
        ...
        return new NodeModel(1, 0) { // NOSONAR
