    ...
    computed: {
        filteredDemoComponents() {
            ...
            for (let [category, componentByName] of Object.entries(
                ...
                for (let [name, component] of Object.entries(componentByName)) {
                    if (
                        name.toLowerCase().includes(this.searchQuery.trim().toLowerCase())
                    ) {
      ...
      <div class="grid-container header">
        <div class="grid-item-12">
          ...
          <p>
            ...
            Vue-based UI components. To use them, it's recommended to integrate
            them as Git submodule as described in the
            <a
              href="https://bitbucket.org/KNIME/webapps-common/src/master/README.md"
            >README.md</a>. More and more parts are also available as
