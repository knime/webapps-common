...
import code from "@@source/components/components/forms/InputField/InputField.vue?raw";
      ...
      <div class="grid-container">
        <div class="grid-item-12">
          <p>
            ...
            has a <code>value</code>.
          </p>
        </div>
      </div>
      <div class="grid-container">
        <div class="grid-item-6 inputs">
          <InputField v-model="inputValue" type="text" title="Insert text" />
          <InputField
            v-model="inputValue2"
            type="text"
            placeholder="I'm a placeholder"
          ...
          <InputField
            ...
            disabled
          />
          <InputField model-value="invalid" :is-valid="false" type="text" />
          <InputField model-value="demo with left icon" type="text">
            <template #icon>
              <MailIcon />
            </template>
          </InputField>
          <InputField model-value="demo with right icon" type="text">
            <template #iconRight>
              <CircleCheckIcon />
            </template>
          </InputField>
    ...
    <section>
      <div class="grid-container">
        <div class="grid-item-12">
          ...
          <CodeExample summary="Show InputField.vue source code">{{
            code
          }}</CodeExample>
        </div>
      </div>
