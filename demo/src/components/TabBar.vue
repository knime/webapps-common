  ...
  computed: {
    possibleTabValuesStandalone() {
      ...
      result[2] = {
        ...
        title: this.bananasDisabled
          ? "Currently no bananas, sorry!"
          : "Click for bananas",
    ...
    <div class="grid-container">
      <div class="grid-item-12">
        ...
        <p>
          ...
          <button @click="bananasDisabled = !bananasDisabled">
            {{ bananasDisabled ? "enable" : "disable" }}</button
          >, also the whole bar can be disabled:
          <button @click="disabled = !disabled">
            {{ disabled ? "enable" : "disable" }}
          </button>
        </p>
        <CodeExample summary="Show usage example (standalone)">{{
          codeExampleStandalone
        }}</CodeExample>
        ...
        <CodeExample summary="Show TabBar.vue source code">{{
          tabbarCode
        }}</CodeExample>
      </div>
    </div>
