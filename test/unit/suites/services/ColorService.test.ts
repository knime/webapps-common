...
import { ColorService, NominalColorHandler, NumericColorHandler } from 'src/services/ColorService';
...
describe('ColorService', () => {
    ...
    describe('getColorCallback', () => {
        ...
        it('returns a function for nominal color model', () => {
            const colorHandler = colorService.getColorHandler(nominalColumnName) as NominalColorHandler;
        ...
        it('returns a function for numeric color model', () => {
            const colorHandler = colorService.getColorHandler(numericColumnName) as NumericColorHandler;
